import { ElementRef, EventEmitter, IterableDiffers, KeyValueDiffers, Renderer2, TemplateRef } from '@angular/core';
 ...
 */
export declare class TiActionmenuComponent extends TiFormComponent {
     ...
     * 用户点击选中菜单项事件
     */
    readonly select: EventEmitter<TiActionmenuItem>;
    /**
     * 外部容器宽度
     */
    maxWidth: string;
     ...
     * @ignore
     */
    menuCom: TiMenuComponent;
    /**
     * @ignore
     * 下拉菜单绑定的选项数据
     */
    panelItems: Array<TiActionmenuItem>;
    /**
     * @ignore
     * 各item之间间隔的一半距离
     */
    ...
    private itemsDiffer;
    private dataDiffer;
    private needInitItems;
    constructor(hostRef: ElementRef, renderer: Renderer2, iterableDiffers: IterableDiffers, keyValueDiffers: KeyValueDiffers);
    private static isEqualOffsetTop;
    /**
     * @ignore
     *  选中菜单内选项
     * @param item 菜单项数据
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<TiActionmenuComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<TiActionmenuComponent, "ti-actionmenu", never, { "panelMaxWidth": "panelMaxWidth"; "panelMaxHeight": "panelMaxHeight"; "labelKey": "labelKey"; "maxWidth": "maxWidth"; "space": "space"; "showDivider": "showDivider"; "maxShowNum": "maxShowNum"; "moreText": "moreText"; "menuText": "menuText"; "items": "items"; "data": "data"; "dataToItemsFn": "dataToItemsFn"; }, { "select": "select"; }, ["itemTemplate", "firstTemplate", "tipTemplate"], never, false>;
}

//# sourceMappingURL=TiActionmenuComponent.d.ts.map