...
export declare class TiUploadComponent extends TiUploadbaseComponent {
    private uploaderService;
    private tiOverflow;
    constructor(uploaderService: TiUploadService, hostEle: ElementRef, renderer: Renderer2, tiOverflow: TiOverflowService);
    /**
     * 上传样式类型
     */
    type: 'inputField' | 'button';
    /**
     * 按钮的配置
     *
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<TiUploadComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<TiUploadComponent, "ti-upload:not([type]), ti-upload[type=\"inputField\"], ti-upload[type=\"button\"]", never, { "type": "type"; "autofocus": "autofocus"; "placeholder": "placeholder"; "showSubmitButton": "showSubmitButton"; "buttonText": "buttonText"; "inputFieldWidth": "inputFieldWidth"; }, {}, never, never, false>;
}

//# sourceMappingURL=TiUploadComponent.d.ts.map