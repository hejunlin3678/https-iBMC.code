...
export declare class TiSearchboxComponent extends TiAutocompleteComponent {
    /**
     * 10.0.4版本新增
     *
    ...
    private isSearchWithHoverOption;
    /**
     * @ignore
     * 输入框中内容改变事件
     */
     ...
     */
    private trimValue;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<TiSearchboxComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<TiSearchboxComponent, "ti-searchbox", never, { "trimmed": "trimmed"; }, { "search": "search"; }, ["itemTemplate"], never, false>;
}

//# sourceMappingURL=TiSearchboxComponent.d.ts.map