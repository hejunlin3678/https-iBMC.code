...
export declare class TiMessageService {
    private tiModal;
     ...
     */
    open(config?: TiMessageConfig): TiModalRef;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<TiMessageService, never>;
}

//# sourceMappingURL=TiMessageService.d.ts.map