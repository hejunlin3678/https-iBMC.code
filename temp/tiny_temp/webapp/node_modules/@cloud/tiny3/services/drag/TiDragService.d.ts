 ...
 */
export declare class TiDragService {
    private tiRenderer;
    private renderer;
    constructor(rendererFactory: RendererFactory2, tiRenderer: TiRenderer);
    /**
     * 创建拖拽对象
     *
     * 函数返回值为
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<TiDragService, never>;
}

//# sourceMappingURL=TiDragService.d.ts.map