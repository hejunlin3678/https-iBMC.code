...
:root {
  /* ---------------collapsebutton组件----START----------------------------------------------*/
  --tp-collapsebutton-uncollapsed-bg-color: var(--ti-common-color-theme-extra4);
  ...
  /* ---------------subtitle 组件----END-----------------------------------------------------*/
  /* ---------------stepguide 组件----START--------------------------------------------------*/
  --tp-stepguide-number-bg-color: var(--ti-common-color-theme-extra1);
  --tp-stepguide-line-color: var(--tp-stepguide-number-bg-color);
  /* ---------------stepguide 组件----END----------------------------------------------------*/
}
