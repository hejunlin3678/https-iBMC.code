...
/*主题 组件变量定义*/
:root {
  --tp-link-no-decoration-color-hover: var(--ti-common-color-text-link-hover);
  --tp-link-no-decoration-text-decoration: underline;
  /* ---------------collapsebutton组件----START----------------------------------------------*/
  --tp-collapsebutton-text-color-hover: var(--ti-common-color-text-primary);
  --tp-collapsebutton-uncollapsed-bg-color: var(--ti-common-color-theme-extra5);
  --tp-collapsebutton-uncollapsed-border-color: var(--ti-common-color-line-normal);
  /* ---------------collapsebutton组件----START----------------------------------------------*/
  /* ---------------iconaction组件----START--------------------------------------------------*/
  --tp-iconaction-default-text-color: var(--ti-common-color-text-link);
  --tp-iconaction-hover-text-color: var(--ti-common-color-text-link-hover);
  --tp-iconaction-default-icon-color: var(--tp-iconaction-default-text-color);
  --tp-iconaction-hover-icon-color: var(--tp-iconaction-hover-text-color);
  /* ---------------iconaction组件----END----------------------------------------------------*/
  /* ---------------layout组件----START------------------------------------------------------*/
  --tp-layout-header-bg-color: var(--ti-common-color-bg-white-normal);
  --tp-layout-header-box-shadow: var(--ti-common-shadow-1-down);
  --tp-layout-header-border: 1px solid var(--ti-common-color-line-dividing);
  /* ---------------layout组件----END--------------------------------------------------------*/
  /* ---------------resources组件----START---------------------------------------------------*/
  --tp-resources-card-border-color: var(--ti-common-color-line-normal);
  --tp-resources-card-default-bgColor: var(--ti-common-color-bg-white-normal);
  --tp-resources-card-border-color-hover: var(--ti-common-color-line-hover);
  --tp-resources-card-hover-bgColor: var(--ti-common-color-bg-white-normal);
  /* ---------------resources组件----END-----------------------------------------------------*/
  /* ---------------subtitle 组件----START---------------------------------------------------*/
  --tp-subtitle-line-color: #666;
  --tp-subtitle-dark-icon-color: var(--ti-common-color-icon-normal);
  --tp-subtitle-dark-text-color: var(--ti-common-color-text-primary);
  /* ---------------subtitle 组件----END-----------------------------------------------------*/
  /*--------------buylayer---START--------------------*/
  --tp-buylayer-container-min-height: 60px;
  /*--------------buylayer---END--------------------*/
  /* ---------------accordion组件----START---------------------------------------------*/
  --tp-accordion-text-link-active: var(--ti-common-color-theme-extra6);
  /* ---------------accordion组件----END-----------------------------------------------*/
}
:root .tp-buyLayer-price-cal {
  display: block;
}
:root .tp-buyLayer-price-container {
  display: none;
}
