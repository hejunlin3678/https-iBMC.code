...
export declare class TpIdentityauthService {
    private tiModal;
    ...
    successFn: () => void;
    private queryIsOpen;
    private checkCerifyCode;
    private identityAuth;
    /**
     * 开启二次认证
     *
     ...
     */
    open(successFn: () => void, config?: any): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<TpIdentityauthService, never>;
}

//# sourceMappingURL=TpIdentityauthService.d.ts.map