...
export declare class TpFeedbackComponent extends TiBaseComponent {
    /**
     * 组件数据
     */
     ...
     * @ignore
     */
    halfmodalCom: TpHalfmodalComponent;
    private CONST_ANT;
    /**
     * @ignore
     * 是否显示问卷入口
     ...
     */
    onSubmit(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<TpFeedbackComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<TpFeedbackComponent, "tp-feedback", never, { "options": "options"; }, {}, never, ["*"], false>;
}

//# sourceMappingURL=TpFeedbackComponent.d.ts.map