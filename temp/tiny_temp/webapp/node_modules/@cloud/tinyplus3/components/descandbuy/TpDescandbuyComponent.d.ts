...
export declare class TpDescandbuyComponent extends TiBaseComponent {
    /**
     * 组件的配置对象，详情可以参考TpDescandbuyConfig接口
     */
    config: TpDescandbuyConfig;
    /**
     * @ignore
     */
     ...
     * @ignore
     */
    onPricecalcClick(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<TpDescandbuyComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<TpDescandbuyComponent, "tp-descandbuy", never, { "config": "config"; }, {}, never, ["*"], false>;
}

//# sourceMappingURL=TpDescandbuyComponent.d.ts.map