...
/* Added by Satish to check DOPRA seperation -2009-08-25 */
#include "ipsi_misc.h"
...
* @datastruct CID_SHA512WITHRSAENCRYPTION Identifies signature using SHA512
            and RSA.
* @datastruct CID_SM3WITHRSAENCRYPTION Identifies signature using SM3
            and RSA.
...
* @datastruct CID_CHALLENGE_PWD_ATTR Identifies Challenge PWD Attr.
...
* @datastruct CID_PASSWORDBASEDMAC Identifies PWD Based MAC.
...
* @datastruct CID_AT_STREETADDRESS Identifies the streetAddress in EV certs.
* @datastruct CID_AT_BUSINESSCATEGORY Identifies the businessCategory in EV certs.
* @datastruct CID_AT_POSTALCODE  Identifies the postalCode in EV certs.
* @datastruct CID_JD_LOCALITYNAME Identifies the streetAddress in EV certs.
* @datastruct CID_JD_STATEORPROVINCENAME Identifies the jurisdictionLocalityName in EV certs.
* @datastruct CID_JD_COUNTRYNAME Identifies the jurisdictionCountryName in EV certs.

*/
// New algorithm Ids should be added at the end.
...
typedef enum {
    ...
    CID_ECDSA192WITHSHA256, /* identifies signature using SHA256 and ECDSA-192 bit */
    ...
    CID_AT_STREETADDRESS,       /* Identifies the streetAddress in EV certs */
    CID_AT_BUSINESSCATEGORY,    /* Identifies the businessCategory in EV certs */
    CID_AT_POSTALCODE,          /* Identifies the postalCode in EV certs */
    CID_JD_LOCALITYNAME,        /* Identifies the streetAddress in EV certs */
    CID_JD_STATEORPROVINCENAME, /* Identifies the jurisdictionLocalityName in EV certs */
    CID_JD_COUNTRYNAME,         /* Identifies the jurisdictionCountryName in EV certs */
    CID_HMAC_SHA1_DIGEST,

    CID_NIST_PRIME224,  /* NIST Curve P-224 */
    CID_NIST_C2PNB163K, /* NIST Binary Curve 163K */
    CID_NIST_C2PNB163B, /* NIST Binary Curve 163B */
    CID_NIST_C2TNB233K, /* NIST Binary Curve 233K */
    CID_NIST_C2TNB233B, /* NIST Binary Curve 233B */
    CID_NIST_C2PNB283K, /* NIST Binary Curve 283K */
    CID_NIST_C2PNB283B, /* NIST Binary Curve 283B */
    CID_NIST_C2TNB409K, /* NIST Binary Curve 409K */
    CID_NIST_C2TNB409B, /* NIST Binary Curve 409B */
    CID_NIST_C2PNB571K, /* NIST Binary Curve 571K */
    CID_NIST_C2PNB571B, /* NIST Binary Curve 571B */
    CID_PBE_HMACSHA512WITHAES256_CBC,

    CID_CE_SKAE,   /* Identifies SKAE extension */
    CID_ED25519,   /* Identifies ED25519 algorithm */
    CID_X25519,    /* Identifies X25519 algorithm */
    CID_RSASSAPSS, /* Identifies RSASSAPSS algorithm */
    CID_MGF1,      /* Identifies MaskGen algorithm */

    CID_SCRYPT,    /* Identifieds Scrypt KDF algorithm */
    CID_PBES1,     /* Identifieds PBES1 KDF algorithm */
    CID_KDF2,      /* Identifieds KDF2 KDF algorithm */
    CID_DOT16KDF,  /* Identifieds dot16 KDF algorithm */

    CID_SM4,        /* Identifieds SM4 algorithm */
    CID_SM4_ECB,    /* Identifieds SM4 ECB algorithm */
    CID_SM4_CBC,    /* Identifieds SM4 CBC algorithm */
    CID_KWRAP_AES,  /* Identifieds AES KWRAP algorithm */
    CID_KWRAP_SM4,  /* Identifieds SM4 KWRAP algorithm */
    // If new symmetric encryption algo is added then g_AlgTable array and
    // ipsi_algid_to_g_AlgTable_idx() function should be modified accordingly
    CID_CMAC_SM4,   /* identifies CMAC SM4 */
    /* identifies signature using SM3 and RSA */
    CID_SM3WITHRSAENCRYPTION,
} SEC_CID_E;
...
* @par Prototype
* @code
* const SEC_CHAR* SEC_getErrorText(SEC_ERROR_CODE ulErrorNo)
* @endcode
*
* @par Purpose
...
*
* @par Description
* SEC_getErrorText function returns error string using error number.
...
*
* @retval const SEC_CHAR* Pointer to character array [Error message|N/A]
*
* @par Required Header File
* sec_sys.h
*
...
* N/A
*/
CRYPTOLINKDLL const SEC_CHAR *SEC_getErrorText(SEC_ERROR_CODE ulErrorNo);
...
*
* @par Description
* SEC_memCalloc function returns memory allocation through calloc.
*
...
* N/A
*/
CRYPTOLINKDLL void *SEC_memCalloc(SEC_UINT32 ulNumOfElmnts, SEC_UINT32 ulSizeOfElmnt);

#define SEC_DEBUG_OFF 0
#define SEC_DEBUG_ON 1

/* This macro is used for inform error.On the basis of errno it logs
filename,line no,errorno */
#ifndef __IPSI_NO_CRYPTO_LOG__
#define SEC_REPORT_ERROR(ulErrorNo) SEC_reportError(__THIS_FILE__, __LINE__, ulErrorNo, 0, SEC_NULL)
#else
#define SEC_REPORT_ERROR(ulErrorNo)
#endif

/* This macro is used to allocate memory */
#define SEC_MEM_ALLOC(ulSizeOfMemBlock) (((ulSizeOfMemBlock) > 0) ? SEC_memCalloc(1, (ulSizeOfMemBlock)) : SEC_NULL)

/* This macro is used to free memory */
#define SEC_MEM_FREE(pAddr) ((SEC_NULL != (pAddr)) ? (ipsi_free(pAddr), (pAddr) = NULL, SEC_SUCCESS) : SEC_SUCCESS)
...
#define IPSI_CALC_BYTES_NEEDED_TO_STORE_NUM_BITS(_x) (((_x) + 7) / 8)

#define IPSI_CALC_NUM_OF_BITS_FOR_GIVEN_BYTES(_x) ((SEC_UINT32)((_x) << 3))

// This option will be used in the API CRYPT_signDec_sf and CRYPT_signEnc_sf.
// CRYPT_signEnc_sf API will append the buffer with 0 if the IPSI_APPEND_ZERO option is passed
// and the first character of R or S is more than 127
#define IPSI_APPEND_ZERO 0
#define IPSI_NO_APPEND_ZERO 1
...
* @par Prototype
* @code
* SEC_VOID SEC_reportError(const SEC_CHAR* pucFileName,SEC_UINT ulLineNum,
...
* N/A
*/
CRYPTOLINKDLL SEC_VOID SEC_reportError(const SEC_CHAR *pucFileName, SEC_UINT ulLineNum, SEC_UINT32 uiErrorNo,
    SEC_UINT uiParaLen, const SEC_VOID *pPara);
...
* @par Prototype
* @code
* const SEC_CHAR* SEC_getCryptoErrorText(SEC_ERROR_CODE ulErrorNo)
* @endcode
*
* @par Purpose
* This is used to get error string using error number.
*
* @par Description
* SEC_getCryptoErrorText function returns error string using error number.
...
*
* @retval const SEC_CHAR* Pointer to the text [Error message|N/A]
*
* @par Required Header File
* sec_sys.h
*
...
* N/A
*/
CRYPTOLINKDLL const SEC_CHAR *SEC_getCryptoErrorText(SEC_ERROR_CODE ulErrorNo);
