 ...
 * Create: 2007-08-30
 * Function List:SEC_getCryptoErrorText
...
#ifndef _FIPS_IPSI_COMMON_ERROR_H
...
#define SEC_ERR_LIST_FULL DEFINE_COMMON_ERR(89)
#define SEC_ERR_LOCK_FAIL DEFINE_COMMON_ERR(90)

#define SEC_ERR_RSA_PSS_SIGN_INCORRECT_HASH_LEN DEFINE_COMMON_ERR(91)
#define SEC_ERR_RSA_PSS_SIGN_INVALID_SALT DEFINE_COMMON_ERR(92)
#define SEC_ERR_INVALID_ENTROPY_SAMPLE_SIZE DEFINE_COMMON_ERR(93)
#define SEC_ERR_REP_HEALTH_TEST_FAIL DEFINE_COMMON_ERR(94)
#define SEC_ERR_ADAP_HEALTH_TEST_FAIL DEFINE_COMMON_ERR(95)

#define SEC_ERR_CMVP_AVL_FAIL DEFINE_COMMON_ERR(96)
