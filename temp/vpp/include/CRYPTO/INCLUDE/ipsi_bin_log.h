 ...
 * ***********************************************************************
 */
#ifndef IPSI_BIN_LOG_H
#define IPSI_BIN_LOG_H
 ...
 * @dataEnum IPSI_BIN_LOG_LEVEL_DEBUG      Log Level is DBG.
...
typedef enum IPSI_BIN_LOG_LEVEL {
    ...
    IPSI_BIN_LOG_LEVEL_DEBUG,        /* DBG LOG LEVEL */
    IPSI_BIN_LOG_LEVEL_END
} IPSI_BIN_LOG_LEVEL_E;
 ...
 * None
 */
typedef void (*IPSI_BIN_LOG_FIXLEN_CALLBACK_FUNC)(SEC_UINT uiLogCode, SEC_UINT uiLogLevel, SEC_UINT uiLogType,
    void *pFormat, void *ulPara1, void *ulPara2, void *ulPara3, void *ulPara4);
 ...
 * None
 */
typedef void (*IPSI_BIN_LOG_VARLEN_CALLBACK_FUNC)(SEC_UINT uiLogCode, SEC_UINT uiLogLevel, SEC_UINT uiLogType,
    void *pFormat, void *pData);
 ...
 * @par Prototype
 * @code
 * SEC_INT IPSI_BinLog_regLogFunc(const IPSI_REG_BIN_LOG_FUNC_S
 * * pstBinLogFunc)
 *
 * @endcode
 *
 ...
 * None
 */
CRYPTOLINKDLL SEC_INT IPSI_BinLog_regLogFunc(const IPSI_REG_BIN_LOG_FUNC_S *pstBinLogFunc);
 ...
 * None
 */
CRYPTOLINKDLL IPSI_BIN_LOG_LEVEL_E IPSI_BinLog_getLogLevel(void);
 ...
 *
 * @par Note
 * This is a global function and should not be called in multiple threads. There should not be any other operation of
 * security library (CRYPTO, PSE, SSL, EAP, CMPv2, etc) running while calling this API.
 *
 * @par Example
 * None
 *
 ...
 * None
 */
CRYPTOLINKDLL SEC_INT IPSI_BinLog_setLogType(SEC_UINT uiWarningLogEnable, SEC_UINT uiCfgLogEnable,
    SEC_UINT uiRunLogEnable);
 ...
 *
 * @par Description
 * This function Returns the warning, configuration, and runtime log level status.
 *
 ...
 * None
 */
CRYPTOLINKDLL SEC_INT IPSI_BinLog_getLogType(SEC_UINT *puiWarningLogEnable, SEC_UINT *puiCfgLogEnable,
    SEC_UINT *puiRunLogEnable);
