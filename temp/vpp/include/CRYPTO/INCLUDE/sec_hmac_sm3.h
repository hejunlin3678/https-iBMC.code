 ...
 * Description: Contains HMAC SM3 core interface functions
 * ALL RIGHTS RESERVED
 * Project Code: iPSI
 ...
 * --------------------------------------------------------------------
 */
#ifndef SEC_HMAC_SM3_H
#define SEC_HMAC_SM3_H
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_hmac_sm3_init(ipsi_hmac_sm3_ctx_t *ctx, const SEC_UCHAR *pucKey, SEC_UINT32 ulKlen);
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_hmac_sm3_update(ipsi_hmac_sm3_ctx_t *ctx, SEC_UCHAR *pucData, SEC_UINT32 ulDataLen);
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_hmac_sm3_final(ipsi_hmac_sm3_ctx_t *ctx, SEC_UCHAR pucDigest[IPSI_HMAC_SM3_SIZE]);
