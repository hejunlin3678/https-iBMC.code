 ...
 * Description: Contains HMAC interface functions
 * ALL RIGHTS RESERVED
 * Project Code: iPSI
 ...
 * --------------------------------------------------------------------
 */
#ifndef SEC_HMAC_SHA2_H
#define SEC_HMAC_SHA2_H
...
#define IPSI_HMAC_SHA224_CTX_SIZE 224

#define IPSI_HMAC_SHA256_CTX_SIZE 224

#define IPSI_HMAC_SHA384_CTX_SIZE 432

#define IPSI_HMAC_SHA512_CTX_SIZE 432
...
* @retval SEC_UINT32 If key is NULL or the length is zero [SEC_ERR_INVALID_ARG|N/A]
*
...
* N/A
*/
CRYPTOLINKDLL SEC_UINT32 ipsi_hmac_sha224_init(ipsi_hmac_sha224_ctx_t *ctx, const SEC_UCHAR *pucKey, SEC_UINT32 ulKlen);
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_hmac_sha224_update(ipsi_hmac_sha224_ctx_t *ctx, SEC_UCHAR *pucData, SEC_UINT32 ulDataLen);
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_hmac_sha224_final(ipsi_hmac_sha224_ctx_t *ctx,
    SEC_UCHAR pucDigest[IPSI_HMAC_SHA224_SIZE]);
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_hmac_sha256_init(ipsi_hmac_sha256_ctx_t *ctx, const SEC_UCHAR *pucKey, SEC_UINT32 ulKlen);
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_hmac_sha256_update(ipsi_hmac_sha256_ctx_t *ctx, SEC_UCHAR *pucData, SEC_UINT32 ulDataLen);
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_hmac_sha256_final(ipsi_hmac_sha256_ctx_t *ctx,
    SEC_UCHAR pucDigest[IPSI_HMAC_SHA256_SIZE]);
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_hmac_sha384_init(ipsi_hmac_sha384_ctx_t *ctx, const SEC_UCHAR *pucKey, SEC_UINT32 ulKlen);
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_hmac_sha384_update(ipsi_hmac_sha384_ctx_t *ctx, SEC_UCHAR *pucData, SEC_UINT32 ulDataLen);
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_hmac_sha384_final(ipsi_hmac_sha384_ctx_t *ctx,
    SEC_UCHAR pucDigest[IPSI_HMAC_SHA384_SIZE]);
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_hmac_sha512_init(ipsi_hmac_sha512_ctx_t *ctx, const SEC_UCHAR *pucKey, SEC_UINT32 ulKlen);
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_hmac_sha512_update(ipsi_hmac_sha512_ctx_t *ctx, SEC_UCHAR *pucData, SEC_UINT32 ulDataLen);
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_hmac_sha512_final(ipsi_hmac_sha512_ctx_t *ctx,
    SEC_UCHAR pucDigest[IPSI_HMAC_SHA512_SIZE]);
