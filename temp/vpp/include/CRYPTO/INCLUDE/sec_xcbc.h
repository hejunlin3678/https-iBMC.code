 ...
 * Description:: Contains AES XCBC interface functions
 * ALL RIGHTS RESERVED
 * Project Code: iPSI
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_aes_xcbc_init(ipsi_aes_xcbc_ctx_t *pCtx, const SEC_UCHAR *pucKey,
    const SEC_UINT32 ulKlen);
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_aes_xcbc_update(ipsi_aes_xcbc_ctx_t *pCtx, const SEC_UCHAR *data, SEC_UINT32 nbytes);
...
* N/A
*/
CRYPTOLINKDLL SEC_UINT32 ipsi_aes_xcbc_final(ipsi_aes_xcbc_ctx_t *ctx, SEC_UCHAR digest[IPSI_XCBC_DIGEST_SIZE]);
