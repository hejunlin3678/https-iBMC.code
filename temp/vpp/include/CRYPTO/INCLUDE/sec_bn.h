 ...
 * Description: Contains interface functions for Big Num
 * ALL RIGHTS RESERVED
 * Project Code: iPSI
 ...
 * N/A
 */
CRYPTOLINKDLL ipsi_bn_t *ipsi_bn_bin2bn(const SEC_UCHAR *s, SEC_UINT len, ipsi_bn_t *ret);
...
* N/A
*/
CRYPTOLINKDLL SEC_INT32 ipsi_bn_num_bits(const ipsi_bn_t *a, SEC_INT *piNumBits);
