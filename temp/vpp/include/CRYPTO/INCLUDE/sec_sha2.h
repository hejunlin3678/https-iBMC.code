 ...
 * Description: Contains interface functions for SHA2 family
 * ALL RIGHTS RESERVED
 * Project Code: iPSI
...
#define IPSI_SHA224_CTX_SIZE 112
#define IPSI_SHA224_DIGEST_SIZE 28

#define IPSI_SHA256_CTX_SIZE 112
#define IPSI_SHA256_DIGEST_SIZE 32

#define IPSI_SHA384_CTX_SIZE 216
#define IPSI_SHA384_DIGEST_SIZE 48

#define IPSI_SHA512_CTX_SIZE 216
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_sha224_update(ipsi_sha224_ctx_t *ctx, const SEC_UCHAR *data, SEC_UINT32 nbytes);
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_sha224_final(ipsi_sha224_ctx_t *ctx, SEC_UCHAR digest[IPSI_SHA224_DIGEST_SIZE]);
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_sha256_update(ipsi_sha256_ctx_t *ctx, const SEC_UCHAR *data, SEC_UINT32 nbytes);
/**
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_sha256_final(ipsi_sha256_ctx_t *ctx, SEC_UCHAR digest[IPSI_SHA256_DIGEST_SIZE]);
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_sha384_update(ipsi_sha384_ctx_t *ctx, const SEC_UCHAR *data, SEC_UINT32 nbytes);
/**
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_sha384_final(ipsi_sha384_ctx_t *ctx, SEC_UCHAR digest[IPSI_SHA384_DIGEST_SIZE]);
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_sha512_update(ipsi_sha512_ctx_t *ctx, const SEC_UCHAR *data, SEC_UINT32 nbytes);
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_sha512_final(ipsi_sha512_ctx_t *ctx, SEC_UCHAR digest[IPSI_SHA512_DIGEST_SIZE]);
