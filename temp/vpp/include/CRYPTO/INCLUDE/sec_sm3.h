 ...
 * Description:  Contains interface functions for SM3
 * ALL RIGHTS RESERVED
 * Project Code: iPSI
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_sm3_update(ipsi_sm3_ctx_t *ctx, const SEC_UCHAR *data, SEC_UINT32 nbytes);
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_UINT32 ipsi_sm3_final(ipsi_sm3_ctx_t *ctx, SEC_UCHAR digest[IPSI_SM3_DIGEST_SIZE]);
