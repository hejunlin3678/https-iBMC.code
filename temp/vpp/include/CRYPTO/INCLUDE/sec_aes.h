 ...
 * Description:Contains interface functions for AES
 * ALL RIGHTS RESERVED
 * Project Code: iPSI
...
* N/A
*/
CRYPTOLINKDLL SEC_INT32 ipsi_aes_set_enc_key(ipsi_aes_ctx_t *ctx, const SEC_UCHAR *key, const SEC_INT klen);
...
* N/A
*/
CRYPTOLINKDLL SEC_INT32 ipsi_aes_set_dec_key(ipsi_aes_ctx_t *ctx, const SEC_UCHAR *key, const SEC_INT klen);
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_INT32 ipsi_aes_encrypt(const ipsi_aes_ctx_t *ctx, const SEC_UCHAR *in, SEC_UCHAR *out,
 ...
 *
 * @param[in] ctx The AES context [N/A]
 * @param[in] in The pointer to input ciphertext buffer; the buffer should be
 * IPSI_AES_BLOCK_SIZE long [N/A]
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_INT32 ipsi_aes_decrypt(const ipsi_aes_ctx_t *ctx, const SEC_UCHAR *in, SEC_UCHAR *out,
    const SEC_UINT32 inLen, const SEC_UINT32 outLen);
/*
 ...
 * @param[in] inLen The length of the input plaintext data in bytes [N/A]
 * @param[in,out] iv The IV for the CBC operation; should be
 * IPSI_AES_BLOCK_SIZE bytes long. It will be updated by the CBC
 * operation. [N/A]
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_INT32 ipsi_aes_cbc_encrypt(const ipsi_aes_ctx_t *ctx, const SEC_UCHAR *in, SEC_UCHAR *out,
 ...
 * @param[in] inLen The length of the original plaintext data in bytes [N/A]
 * @param[in,out] iv The IV for the CBC operation; should be
 * IPSI_AES_BLOCK_SIZE bytes long. IV will be updated by the CBC
 * operation. [N/A]
 * @param[in] ivLen The length of the input iv data in bytes [N/A]
 ...
 * N/A
 */
CRYPTOLINKDLL SEC_INT32 ipsi_aes_cbc_decrypt(const ipsi_aes_ctx_t *ctx, const SEC_UCHAR *in, SEC_UCHAR *out,
    const SEC_UINT32 inLen, SEC_UCHAR *iv, const SEC_UINT32 ivLen, const SEC_UINT32 outLen);
