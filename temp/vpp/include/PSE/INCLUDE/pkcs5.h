...
/* Max Iteration Count value. If user gives negative or 0 iteration count,
    this default value will be used
 */
#define PKCS5_ITERATION_COUNT_MAX (1024 * 1024 * 128)
...
*
*/
PSELINKDLL SEC_UINT32 PKCS5_setPBES1Param(const SEC_UCHAR *pucSalt, SEC_UINT32 ulSaltLen, SEC_INT32 iIterval,
...
* N/A
*/
PSELINKDLL SEC_AsnOcts_S *PKCS5_getSaltFromPBES1Param(PKCS5_PBES1PARAM_S *pstPBE1Param);
 ...
 * N/A
 */
PSELINKDLL SEC_INT32 PKCS5_getIterFromPBES1Param(const PKCS5_PBES1PARAM_S *pstPBE1Param);
...
* 6) If application does not set seeds and entropy on frequent intervals, it can lead to vulnerable keys or random
*   value. It is recommended to set seeds and entropy on frequent intervals or update the version that migrates the
*   random implementation based on DRBG. \n
...
*
*/
PSELINKDLL PKCS5_PBES2PARAM_S *PKCS5_genPBES2Param(SEC_UINT32 ulKDFAlgId, SEC_UINT32 ulAlgId);
 ...
 * PKCS5_generateMAC and PKCS5_verifyMAC functions.\n
 * 5) Before calling this API, please make sure that DRBG is initialized for random number generation by calling
 * IPSI_CRYPT_rand_init. If application don't want to use DRBG then appplication should call
 * IPSI_CRYPT_enable_drbg(0) to disable the DRBG Random feature.\n
 * 6) DRBG is enabled by default.
 *
 * @par Related Topics
 * N/A
 *
 *
 */
PSELINKDLL SEC_UINT32 PKCS5_setPBES2Param(const SEC_UCHAR *pucSalt, SEC_UINT32 ulSaltLen, SEC_INT32 iIter,
    SEC_UINT32 ulDKLen, SEC_UINT32 ulKDFAlgId, SEC_UINT32 ulAlgId, PKCS5_PBES2PARAM_S *pstPBES2Param);
 ...
 * N/A
 */
PSELINKDLL SEC_AsnOcts_S *PKCS5_getSaltFromPBES2Param(const PKCS5_PBES2PARAM_S *pstPBES2Param);
 ...
 * N/A
 */
PSELINKDLL SEC_INT32 PKCS5_getIterFromPBES2Param(const PKCS5_PBES2PARAM_S *pstPBES2Param);
 ...
 * N/A
 */
PSELINKDLL SEC_INT32 PKCS5_getDKLenFromPBES2Param(const PKCS5_PBES2PARAM_S *pstPBES2Param);
 ...
 * N/A
 */
PSELINKDLL SEC_AsnOid_S *PKCS5_getPRFOidFromPBES2Param(const PKCS5_PBES2PARAM_S *pstPBES2Param);
...
* N/A
*/
PSELINKDLL SEC_AsnOid_S *PKCS5_getAlgSchemeOidFromPBES2Param(const PKCS5_PBES2PARAM_S *pstPBES2Param);
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 PKCS5_generateMAC(SEC_UCHAR *pucPassword, SEC_UINT32 ulPwdLen, SEC_UCHAR *pucPlainTxt,
    SEC_UINT32 ulPlainTxtLen, const PKCS5_PBES2PARAM_S *pstPBES2Param, SEC_UCHAR *pucMAC, SEC_UINT32 *pulMACLen);
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 PKCS5_verifyMAC(SEC_UCHAR *pucPassword, SEC_UINT32 ulPwdLen,
    const PKCS5_PBES2PARAM_S *pstPBES2Param, SEC_UCHAR *pucPlainTxt, SEC_UINT32 ulPlainTxtLen, const SEC_UCHAR *pucMAC,
    SEC_UINT32 ulMACLen);
 ...
 * N/A
 */
PSELINKDLL SEC_AsnOcts_S *PKCS5_getIVFromPBES2Param(const PKCS5_PBES2PARAM_S *pstPBES2Param);
 ...
 * PKCS5_SHA1_DKLEN_LEN_MAX for ALGID_SHA1 or if Key Length is larger than
 * 65535 for PBES2[SEC_ERR_INVALID_KEY_LEN|N/A]
 ...
 *
 */
PSELINKDLL SEC_UINT32 PKCS5_deriveKey(SEC_UINT32 ulKDFAlg, PKCS5_PBE_TYPE_E enFlag, SEC_UCHAR *pucPassword,
    SEC_UINT32 ulPwdLen, SEC_UCHAR *pucSalt, SEC_UINT32 ulSaltLen,
    SEC_INT32 iIter, /* * if equal to or less than 0, uses the default value 2048 */
 ...
 *
 * @param[in] uiHashAlgId Hash algorithm.Presently it could be ALGID_SHA1,ALGID_SHA224,
 * ALGID_SHA256,ALGID_SHA384 and ALGID_SHA512 [N/A]
 * @param[in] pucPassWd Password that is used as the base key in
 * generating the key [N/A]
 * @param[in] uiPassLen Length of the password. Max value is 1048576 [N/A]
 * @param[in] pucSalt Salt which is a set of octets. [N/A]
 * @param[in] uiSaltLen Length of the salt value.Max value is 1048576 [N/A]
 ...
 * count,default value of 2048 is taken as iteration count value. Max Allowed
 * Iteration count is 1024 * 1024 *128 [N/A]
 ...
 * @par Note
 *
 * 1) ALGID_SHA1 is not the only algorithm that is supported in
 ...
 *
 */
PSELINKDLL SEC_UINT32 PKCS5_p12KeyIVGen(SEC_UINT32 uiHashAlgId, SEC_UCHAR *pucPassWd, SEC_UINT32 uiPassLen,
    const SEC_UCHAR *pucSalt, SEC_UINT32 uiSaltLen, SEC_UCHAR cID, SEC_UINT32 uiIter, SEC_UINT32 uiOutputLen,
    SEC_UCHAR *pucOutBuf);
 ...
 * @param[in] ulCphSize The size of pucCphTxt buffer [N/A]
 *
 ...
 *
 */
PSELINKDLL SEC_UINT32 PKCS5_pbeEncrypt(SEC_UINT32 ulPbeAlg, SEC_UCHAR *pucPassword, SEC_UINT32 ulPwdLen,
    SEC_UCHAR *pucPlainTxt, SEC_UINT32 ulPlainTxtLen, SEC_VOID *pstPBEParam, SEC_UCHAR *pucCphTxt,
    SEC_UINT32 *pulCphLen, SEC_UINT32 ulCphSize);
 ...
 * @param[in] ulPlainTxtSize The size of pucPlainTxt buffer [N/A]
 *
 ...
 *
 */
PSELINKDLL SEC_UINT32 PKCS5_pbeDecrypt(SEC_UINT32 ulPbeAlg, SEC_UCHAR *pucPassword, SEC_UINT32 ulPwdLen,
    SEC_UCHAR *pucCphTxt, SEC_UINT32 ulCphLen, SEC_VOID *pstPBEParam, SEC_UCHAR *pucPlainTxt,
    SEC_UINT32 *pulPlainTxtLen, SEC_UINT32 ulPlainTxtSize);
...
#endif // _IPSI_PKCS5_H_   /* End of pkcs5.h */
