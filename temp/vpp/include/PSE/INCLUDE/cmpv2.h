...
*/
PSELINKDLL CMPV2_CERT_CONF_S *CMPv2_createConfContent(X509_CERT_S *pstCert, SEC_INT32 iCertReqID,
    CMP_PKISTATUS_S *pstPKIStatusInfo);
...
*/
PSELINKDLL CMPV2_CERT_CONF_MSG_S *CMPV2_createConfMsg(CMPV2_CERT_CONF_S *pstConf);
/**
...
*/
PSELINKDLL SEC_INT CMPV2_addToConfMsg(CMPV2_CERT_CONF_MSG_S *pstConfMsg, CMPV2_CERT_CONF_S *pstCMPConf);
 ...
 * None
 */
PSELINKDLL CMPV2_CERT_CONF_S *CMPV2_getCertConf(CMPV2_CERT_CONF_MSG_S *pstConfMsg, SEC_INT32 iCertReqId);
 ...
 * None
 */
PSELINKDLL SEC_VOID CMPV2_freeCertConf(CMPV2_CERT_CONF_S *pstCertConf);
 ...
 * None
 */
PSELINKDLL SEC_VOID CMPV2_freeCertConfMsg(CMPV2_CERT_CONF_MSG_S *pstCertConfMsg);
 ...
 * None
 */
PSELINKDLL CMPV2_POLL_REQ_MSG_S *CMPV2_createPollReqMsg(SEC_INT32 iCertReqID);
 ...
 * None
 */
PSELINKDLL SEC_INT CMPV2_addToPollReqMsg(CMPV2_POLL_REQ_MSG_S *pstPollReqMsg, SEC_INT32 iCertReqID);
 ...
 * None
 */
PSELINKDLL CMPV2_POLL_REP_S *CMPV2_createPollRep(SEC_INT32 iCertReqID, SEC_INT32 iCheckAfter, SEC_List_S *pStReason);
 ...
 * None
 */
PSELINKDLL CMPV2_POLL_REP_MSG_S *CMPV2_createPollRepMsg(CMPV2_POLL_REP_S *pstPollRep);
 ...
 * None
 */
PSELINKDLL SEC_INT CMPV2_addToPollRepMsg(CMPV2_POLL_REP_MSG_S *pstPollRepMsg, CMPV2_POLL_REP_S *pstPollRep);
 ...
 * @endcode
 *
 * @param[in] pstPollReqMsg Poll Request Message to be freed [NA]
 * @param[out] NA NA [NA]
 *
 ...
 * @endcode
 * @param[in] pstPollRepMsg Response message to be freed [NA]
 * @param[out] NA NA [NA]
 *
 * @retval SEC_VOID NA [NA|NA]
 *
