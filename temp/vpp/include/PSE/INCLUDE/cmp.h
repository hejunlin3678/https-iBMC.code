...
typedef struct stCMP_KeyPair {
    ...
    GM_ENCRYPTEDKEY_S *pstGmEncryptedKey;
} CMP_KEYPAIR_S;
 ...
 * @datastruct pCRLDetails List of SEC_EXTN_S including extra CRL Details like CRL Number, Reason or Location
 * (Optional).
 */
typedef struct stCMP_RevokeAnn {
 ...
 *
 * @par Description
 * Creates a PKI Message structure using PKI Body and PKI Header structures. The PKI Message can be exchanged between
 * the End-Entity and CA/RA for initializing into the PKI or for sending/receiving Requests/Responses.
 *
 ...
 * @retval CMP_PKIMSG_S* If either of the inputs are NULL. [SEC_NULL|N/A]
 * @retval CMP_PKIMSG_S* If memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CMP_PKIMSG_S *CMP_createPKIMsg(CMP_PKIHDR_S *pstHeader, CMP_PKIBODY_S *pstBody);
 ...
 * N/A
 */
PSELINKDLL CMP_PKIMSG_S *CMP_createPKIMsg_ex(CMP_PKIHDR_S *pstHeader, CMP_PKIBODY_S *pstBody);
 ...
 * @retval SEC_UCHAR* If either of the inputs are NULL. [SEC_NULL|N/A]
 ...
 * N/A
 */
PSELINKDLL SEC_UCHAR *CMP_encodePKIMsg(CMP_PKIMSG_S *pstPKIMessage, SEC_UINT32 *pulLength);
 ...
 * @retval CMP_PKIMSG_S* If either of the inputs are NULL. [SEC_NULL|N/A]
 * @retval CMP_PKIMSG_S* If memory allocation fails. [SEC_NULL|N/A]
 * @retval CMP_PKIMSG_S* If decode fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CMP_PKIMSG_S *CMP_decodePKIMsg(SEC_UCHAR *pucEncodedPKIMsg, SEC_UINT32 ulEncodedLength,
    SEC_UINT32 *pulBytesDecoded);
 ...
 *
 * @par Description
 * Generates protection to PKI Message. This method can be used to generate the Protection Bits to protect the PKI
 * message. This method can be called for concealing the Message only after all the fields are added. This method
 * extracts the Algorithm from the ProtectionAlg field of the PKIMessage to generate the protection.
 *
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_genProtection(CMP_PKIMSG_S *pstPKIMessage, SEC_UCHAR *pucPassword, SEC_UINT32 ulPwdLen,
    SEC_PKEY_S *pPrivKey, SEC_PKEY_S *pPubKey);
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_addExtraCerts(CMP_PKIMSG_S *pstPKIMessage, SEC_List_S *pExtraCerts);
 ...
 * @retval CMP_PKIHDR_S* If either of the inputs are NULL. [SEC_NULL|N/A]
 * @retval CMP_PKIHDR_S* If memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 *
 */
PSELINKDLL CMP_PKIHDR_S *CMP_createPKIHdr(SEC_UINT32 ulVersion, SEC_GEN_NAME_S *pstSender,
    SEC_GEN_NAME_S *pstRecipient);
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_setMsgTime(CMP_PKIHDR_S *pstHeader, const DATETIME_S *pMessageTime);
 ...
 *
 * @par Description
 * Adds the Protection Algorithm to an already created PKI Header structure. This API is used to extract the Algorithm
 * used to protect the PKIMessage in CMP_genProtection().
 *
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_setProtectionAlg(CMP_PKIHDR_S *pstPKIHeader, SEC_UINT32 ulProtAlg);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32 CMP_checkProtection (const CMP_PKIMSG_S* pstPKIMessage,
 * SEC_UCHAR* pucPassword,
 * SEC_UINT32 ulPwdLen,
 * SEC_PKEY_S* pstPrivKey,
 * SEC_PKEY_S* pstPubKey);
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_checkProtection(const CMP_PKIMSG_S *pstPKIMessage, SEC_UCHAR *pucPassword,
    SEC_UINT32 ulPwdLen, SEC_PKEY_S *pPubKey, SEC_PKEY_S *pPrivKey);
...
* const SEC_CHAR* pcSenderKID,
* SEC_UINT32 ulLenSenderKID,
* const SEC_CHAR* pcRecipKID,
...
* @param[in] ulLenSenderKID Length of the SenderKID. Should be greater than zero and less than or equal to
             1048576 bytes [N/A]
* @param[in] pcRecipKID Pointer to RecipientKID. [N/A]
* @param[in] ulLenRecipKID Length of the RecipientKID. Should be greater than zero and less than or equal to
                1048576 bytes [N/A]
...
* N/A
*/
PSELINKDLL SEC_UINT32 CMP_setKIDs(CMP_PKIHDR_S *pstPKIHeader, const SEC_CHAR *pcSenderKID, SEC_UINT32 ulLenSenderKID,
    const SEC_CHAR *pcRecipKID, SEC_UINT32 ulLenRecipKID);
...
* @param[in] ulLenTransID Length of the TID.  Should be greater than zero and less than or equal to
             1024 bytes [N/A]
* @param[out] pstPKIHeader Pointer to PKI Header structure. [N/A]
*
* @retval SEC_UINT32 Upon successful completion. [SEC_SUCCESS|N/A]
...
* N/A
*/
PSELINKDLL SEC_UINT32 CMP_setTID(CMP_PKIHDR_S *pstPKIHeader, const SEC_CHAR *pcTransID, SEC_UINT32 ulLenTransID);
...
* const SEC_CHAR* pcSndrNonce,
* SEC_UINT32 ulLenSndrNonce,
* const SEC_CHAR* pcRecipNonce,
...
* @param[in] ulLenSndrNonce Length of the Sender Nonce. Should be greater than zero and less than or equal to
             1024 bytes [N/A]
* @param[in] pcRecipNonce Pointer to Recipient Nonce. [N/A]
* @param[in] ulLenRecipNonce Length of the Recipient Nonce. Should be greater than zero and less than or equal to
             1024 bytes [N/A]
* @param[out] pstPKIHeader Pointer to PKI Header structure. [N/A]
*
* @retval SEC_UINT32 Upon successful completion. [SEC_SUCCESS|N/A]
...
* N/A
*/
PSELINKDLL SEC_UINT32 CMP_setNonces(CMP_PKIHDR_S *pstPKIHeader, const SEC_CHAR *pcSndrNonce, SEC_UINT32 ulLenSndrNonce,
    const SEC_CHAR *pcRecipNonce, SEC_UINT32 ulLenRecipNonce);
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_addFreeText(CMP_PKIHDR_S *pstPKIHeader, SEC_List_S *pPKIFreeText);
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_addGenInfo(CMP_PKIHDR_S *pstPKIHeader, CMP_INFOTYPEVAL_S *pstInfo);
 ...
 * @param[in] enBodyType Type of Message in the PKIBody (One of the structures from the unBodyMsg of CMP_PKIBODY_S).
 * [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval CMP_PKIBODY_S* Pointer to CMP_PKIBODY_S structure. [pstPKIBody|N/A]
 * @retval CMP_PKIBODY_S* If either of the inputs are invalid. [SEC_NULL|N/A]
 * @retval CMP_PKIBODY_S* If memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CMP_PKIBODY_S *CMP_createPKIBody(CMP_PKIBODYTYPE_E enBodyType, SEC_VOID *pstBodyMessage);
 ...
 * N/A
 */
PSELINKDLL CMP_PKIBODY_S *CMP_createPKIBody_ex(CMP_PKIBODYTYPE_E enBodyType, SEC_VOID *pstBodyMessage);
 ...
 * @par Prototype
 * @code
 * CMP_PKIHDR_S* CMP_getPKIHdr (const CMP_PKIMSG_S* pstPKIMessage);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the PKI Header from the PKI Message structure.
 *
 * @param[in] pstPKIMessage Pointer to PKI Message structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval CMP_PKIHDR_S* Pointer to CMP_PKIHDR_S structure. [pstPKIHeader|N/A]
 * @retval CMP_PKIHDR_S* If the input is NULL. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CMP_PKIHDR_S *CMP_getPKIHdr(const CMP_PKIMSG_S *pstPKIMessage);
 ...
 * @par Prototype
 * @code
 * CMP_PKIBODY_S* CMP_getPKIBody (const CMP_PKIMSG_S* pstPKIMessage);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the PKI Body from PKI Message structure.
 *
 * @param[in] pstPKIMessage Pointer to PKI Message structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval CMP_PKIBODY_S* Pointer to CMP_PKIBODY_S structure. [pstPKIBody|N/A]
 * @retval CMP_PKIBODY_S* If the input is NULL. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CMP_PKIBODY_S *CMP_getPKIBody(const CMP_PKIMSG_S *pstPKIMessage);
 ...
 * @par Prototype
 * @code
 * SEC_List_S* CMP_getExtraCerts (const CMP_PKIMSG_S* pstPKIMessage);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns any extra Certificates from the PKI Message Structure. The extraCerts field can contain certificates that may
 * be useful to the recipient. For example, this can be used by a CA or RA to present an end entity with certificates
 * that it needs to verify its own new certificate.
 *
 * @param[in] pstPKIMessage Pointer to PKI Message structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL SEC_List_S *CMP_getExtraCerts(const CMP_PKIMSG_S *pstPKIMessage);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32 CMP_getVersionFromPKIHdr (const CMP_PKIHDR_S* pstPKIHeader);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the PKI Version No. field from the PKI Header structure.
 *
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_getVersionFromPKIHdr(const CMP_PKIHDR_S *pstPKIHeader);
 ...
 * @par Prototype
 * @code
 * SEC_GEN_NAME_S* CMP_getSender (const CMP_PKIHDR_S* pstPKIHeader);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the SenderName from the PKI Header structure.
 *
 * @param[in] pstPKIHeader Pointer to PKI Header structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL SEC_GEN_NAME_S *CMP_getSender(const CMP_PKIHDR_S *pstPKIHeader);
 ...
 * @par Prototype
 * @code
 * SEC_GEN_NAME_S* CMP_getRecipient (const CMP_PKIHDR_S* pstPKIHeader);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the Recipient Name from the PKI Header structure.
 *
 * @param[in] pstPKIHeader Pointer to PKI Header structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL SEC_GEN_NAME_S *CMP_getRecipient(const CMP_PKIHDR_S *pstPKIHeader);
 ...
 * @par Prototype
 * @code
 * DATETIME_S* CMP_extractMsgTime (const CMP_PKIHDR_S* pstPKIHeader);
 * @endcode
 *
 * @par Purpose
 ...
 * @retval DATETIME_S* If the Input is NULL. [SEC_NULL|N/A]
 * @retval DATETIME_S* If Generalized Time to DateTime Conversion Fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL DATETIME_S *CMP_extractMsgTime(const CMP_PKIHDR_S *pstPKIHeader);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32 CMP_getProtectionAlg (const CMP_PKIHDR_S* pstPKIHeader);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns Protection Algorithm value.
 *
 * @param[in] pstPKIHeader Pointer to PKI Header structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_getProtectionAlg(const CMP_PKIHDR_S *pstPKIHeader);
 ...
 * @retval SEC_AsnOcts_S* If the Input is NULL. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 *
 * @par Description
 * Returns the Sender Nonce from PKI Header.
 *
 * @param[in] pstPKIHeader Pointer to PKI Header structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 *
 * @par Description
 * Returns the Recipient Nonce from PKI Header.
 *
 * @param[in] pstPKIHeader Pointer to PKI Header structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * @par Prototype
 * @code
 * SEC_List_S* CMP_getFreeText (const CMP_PKIHDR_S* pstPKIHeader);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns FreeText from PKI Header structure. It indicates the desired language for replies.
 *
 * @param[in] pstPKIHeader Pointer to PKI Header structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL SEC_List_S *CMP_getFreeText(const CMP_PKIHDR_S *pstPKIHeader);
 ...
 * @par Prototype
 * @code
 * CMP_INFOTYPEVAL_S* CMP_getFirstGenInfo (const CMP_PKIHDR_S* pstPKIHeader);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the First General Information from PKI Header structure.
 *
 * @param[in] pstPKIHeader Pointer to PKI Header structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval CMP_INFOTYPEVAL_S* Pointer to CMP_INFOTYPEVAL_S. [pstInfoTypeAndVal|N/A]
 * @retval CMP_INFOTYPEVAL_S* If the Input is NULL. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CMP_INFOTYPEVAL_S *CMP_getFirstGenInfo(const CMP_PKIHDR_S *pstPKIHeader);
 ...
 * @par Prototype
 * @code
 * CMP_INFOTYPEVAL_S* CMP_getNextGenInfo (const CMP_PKIHDR_S* pstPKIHeader);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns General information from PKI Header structure.
 *
 * @param[in] pstPKIHeader Pointer to PKI Header structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL CMP_INFOTYPEVAL_S *CMP_getNextGenInfo(const CMP_PKIHDR_S *pstPKIHeader);
 ...
 * @par Prototype
 * @code
 * CMP_PKIBODYTYPE_E CMP_getPKIBodyType (const CMP_PKIBODY_S* pstPKIBody);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the Message type from the PKI Body.
 *
 ...
 * N/A
 */
PSELINKDLL CMP_PKIBODYTYPE_E CMP_getPKIBodyType(const CMP_PKIBODY_S *pstPKIBody);
 ...
 * SEC_List_S* pStatusString,
 * const SEC_AsnBits_S* pPKIFailureInfo);
 * @endcode
 *
 * @par Purpose
 ...
 * @param[in] pStatusString Pointer to List which can be added when Status is not GRANTED/GRANTEDWITHMODS (Optional).
 * [N/A]
 ...
 * @retval CMP_PKISTATUS_S* If any of the Inputs are Invalid. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 *
 */
PSELINKDLL CMP_PKISTATUS_S *CMP_createPKIStatus(SEC_UINT32 ulStatus, SEC_List_S *pStatusString,
    const SEC_AsnBits_S *pPKIFailureInfo);
 ...
 *
 * @par Description
 * Creates a CMP_CERTRESPMSG_S structure. This method can be used to form Initialization, Cross-certificate,
 * Certificate, and Key Update Response Message by the CA in response to the Request.
 *
 ...
 * @retval CMP_CERTRESPMSG_S* If any of the Inputs are Invalid. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CMP_CERTRESPMSG_S *CMP_createCertRespMsg(X509_CERT_S *pstCACert, CMP_CERTRESP_S *pstCertResp);
 ...
 * @par Prototype
 * @code
 * CMP_CERTRESP_S* CMP_createCertResp (const SEC_AsnOcts_S* pRegInfo,
 * SEC_INT32 iCertReqID,
 * CMP_PKISTATUS_S* pstPKIStatusInfo);
 * @endcode
 *
 ...
 * @retval CMP_CERTRESP_S* If any of the Inputs are Invalid. [SEC_NULL|N/A]
 * @retval CMP_CERTRESP_S* If memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CMP_CERTRESP_S *CMP_createCertResp(const SEC_AsnOcts_S *pRegInfo, SEC_INT32 iCertReqID,
    CMP_PKISTATUS_S *pPKIStatusInfo);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32 CMP_addCert (const CMP_CERTRESPMSG_S* pstCertRepMsg,
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_addCert(const CMP_CERTRESPMSG_S *pstCertRepMsg, X509_CERT_S *pstCACert);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32 CMP_addCertResp (const CMP_CERTRESPMSG_S* pstCertRepMsg,
 * CMP_CERTRESP_S* pstCertResp);
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_addCertResp(const CMP_CERTRESPMSG_S *pstCertRepMsg, CMP_CERTRESP_S *pstCertResp);
 ...
 * const CMP_CERTRESPMSG_S* pstCertRepMsg,
 * SEC_INT32 iCertReqID);
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_addKeyPairToResponse(CMP_KEYPAIR_S *pstCertKeyPair, const CMP_CERTRESPMSG_S *pCertRepMsg,
    SEC_INT32 iCertReqID);
 ...
 *
 * @par Description
 * Creates a Key Recovery Response structure. Whenever an entity in PKI system loses its PSE, then an End Entity can
 * request for the new Certificate for its new Key Pair. This method can be used to form the Key Recovery Response by
 * the CA for Key Recovery Request from the End Entity.
 *
 ...
 * @retval CMP_KEYRECOVERYRESP_S* If the Input is NULL or memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_addCACert(CMP_KEYRECOVERYRESP_S *pstKeyRecRepCnt, X509_CERT_S *pstCACert);
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_addNewCert(CMP_KEYRECOVERYRESP_S *pKeyRecRepCnt, X509_CERT_S *pNewSignCert);
...
* Private Key in an encrypted manner using the Symmetric Key while sending a Certificate Response or Key Recovery
Response.
...
* @param[in] ulValueHint Length of value hint. if pucValueHint is not NULL ,ulValueHint should be greater than zero
             and less than or equal to 1048576 bytes [N/A]
* @param[out] N/A N/A [N/A]
*
* @retval CMP_KEYPAIR_S* Pointer to CMP_KEYPAIR_S. [pCertKeyPair|N/A]
* @retval CMP_KEYPAIR_S* If any of the Inputs are Invalid or memory allocation fails. [SEC_NULL|N/A]
*
* @par Dependency
* cmp.h
*
* @par Note
* - Support for generation of encrypted certificate and private key is deprecated. If applicaiton pass enChoice
*   as CMP_CERTTYPE_ENCRYPTED , then API will return NULL.
* - API parameter are ignored : nKeyGenAlgId, enPubKeyAlgId, pPubKey, enSymmAlg, enIntndAlg, pPrivKey, bPrivKeyEncrypt,
*	pucValueHint, ulValueHint
...
*
*/
PSELINKDLL CMP_KEYPAIR_S *CMP_createKeyPair(SEC_UINT32 enChoice, X509_CERT_S *pstCert, SEC_BOOL bPrivKeyEncrypt,
    const SEC_PKEY_S *pPrivKey, SEC_UINT32 enIntndAlg, SEC_UINT32 enSymmAlg, SEC_PKEY_S *pPubKey,
    SEC_UINT32 enPubKeyAlgId, SEC_UINT32 enKeyGenAlgId, const SEC_UCHAR *pucValueHint, SEC_UINT32 ulValueHint);
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_addPubInfoToKeyPair(CMP_KEYPAIR_S *pstCertKeyPair, CRMF_PUBLICATION_INFO_S *pPubInfo);
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_addCertKeyPairToKeyRecoveryResp(CMP_KEYRECOVERYRESP_S *pKeyRecRepCnt,
    CMP_KEYPAIR_S *pstCertKeyPair);
 ...
 * @par Prototype
 * @code
 * X509_CERT_S* CMP_getNewCert (const CMP_KEYRECOVERYRESP_S* pstKeyRecRepCnt);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the Newly Signed Certificate from CMP_KEYRECOVERYRESP_S structure.
 *
 ...
 * N/A
 */
PSELINKDLL X509_CERT_S *CMP_getNewCert(const CMP_KEYRECOVERYRESP_S *pstKeyRecRepCnt);
 ...
 * @par Prototype
 * @code
 * X509_CERT_S* CMP_getFirstCACert (const CMP_KEYRECOVERYRESP_S* pstKeyRecRepCnt);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the First CA Certificate from CA Certificate list in CMP_KEYRECOVERYRESP_S structure.
 *
 * @param[in] pstKeyRecRepCnt Pointer to CMP_KEYRECOVERYRESP_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL X509_CERT_S *CMP_getFirstCACert(const CMP_KEYRECOVERYRESP_S *pKeyRecRepCnt);
 ...
 * @par Prototype
 * @code
 * X509_CERT_S* CMP_getNextCACert (const CMP_KEYRECOVERYRESP_S* pstKeyRecRepCnt);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the next CA Certificate from CA Certificate list in CMP_KEYRECOVERYRESP_S structure.
 *
 * @param[in] pstKeyRecRepCnt Pointer to CMP_KEYRECOVERYRESP_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL X509_CERT_S *CMP_getNextCACert(const CMP_KEYRECOVERYRESP_S *pKeyRecRepCnt);
 ...
 * @par Prototype
 * @code
 * CMP_KEYPAIR_S* CMP_getFirstKeyPairFromKeyRecoveryResp (const CMP_KEYRECOVERYRESP_S* pstKeyRecRepCnt);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the First Certified Key Pair from Key Pair History List in CMP_KEYRECOVERYRESP_S structure.
 *
 * @param[in] pstKeyRecRepCnt Pointer to CMP_KEYRECOVERYRESP_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval CMP_KEYPAIR_S* Pointer to CMP_KEYPAIR_S. [pstCertKeyPair|N/A]
 * @retval CMP_KEYPAIR_S* If the Input is NULL. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CMP_KEYPAIR_S *CMP_getFirstKeyPairFromKeyRecoveryResp(const CMP_KEYRECOVERYRESP_S *pKeyRecRepCnt);
 ...
 * @par Prototype
 * @code
 * CMP_KEYPAIR_S* CMP_getNextKeyPairFromKeyRecoveryResp (const CMP_KEYRECOVERYRESP_S* pstKeyRecRepCnt);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the next Certified Key Pair from Key Pair History List in CMP_KEYRECOVERYRESP_S structure.
 *
 * @param[in] pstKeyRecRepCnt Pointer to CMP_KEYRECOVERYRESP_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL CMP_KEYPAIR_S *CMP_getNextKeyPairFromKeyRecoveryResp(const CMP_KEYRECOVERYRESP_S *pKeyRecRepCnt);
 ...
 * @par Prototype
 * @code
 * CRMF_PUBLICATION_INFO_S* CMP_getPubInfo (const CMP_KEYPAIR_S* pstCertKeyPair);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the Publication Information from CMP_KEYPAIR_S structure.
 *
 * @param[in] pstCertKeyPair Pointer to CMP_KEYPAIR_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval CRMF_PUBLICATION_INFO_S* Pointer to CRMF_PUBLICATION_INFO_S structure. [pstPubInfo|N/A]
 * @retval CRMF_PUBLICATION_INFO_S* If the Input is NULL. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CRMF_PUBLICATION_INFO_S *CMP_getPubInfo(const CMP_KEYPAIR_S *pCertKeyPair);
 ...
 * @par Prototype
 * @code
 * SEC_VOID* CMP_getCMPCert (const CMP_KEYPAIR_S* pstCertKeyPair);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns Certificate/Encrypted Certificate from CMP_KEYPAIR_S structure.
 *
 * @param[in] pstCertKeyPair Pointer to CMP_KEYPAIR_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval SEC_VOID* Pointer to Certificate or Encrypted Certificate. [SEC_VOID*|N/A]
 * @retval SEC_VOID* If the Input is NULL. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL SEC_VOID *CMP_getCMPCert(const CMP_KEYPAIR_S *pstCertKeyPair);
 ...
 * @par Prototype
 * @code
 * CRMF_ENCRYPTED_VALUE_S* CMP_getPrivateKey (const CMP_KEYPAIR_S* pstCertKeyPair);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the Encrypted Private Key structure pointer from CMP_KEYPAIR_S structure.
 *
 * @param[in] pstCertKeyPair Pointer to CMP_KEYPAIR_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval CRMF_ENCRYPTED_VALUE_S* Pointer to CRMF_ENCRYPTED_VALUE_S structure. [pstPrivateKey|N/A]
 * @retval CRMF_ENCRYPTED_VALUE_S* If the Input is NULL. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CRMF_ENCRYPTED_VALUE_S *CMP_getPrivateKey(const CMP_KEYPAIR_S *pCertKeyPair);
 ...
 *
 * @par Description
 * Returns the Encrypted Value of the Private Key in CRMF_ENCRYPTED_VALUE_S structure.
 *
 ...
 * @retval SEC_AsnBits_S* If the Input is NULL. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 *
 * @par Description
 * Returns the encrypted Symmetric Key from CRMF_ENCRYPTED_VALUE_S structure.
 *
 ...
 * @par Prototype
 * @code
 * SEC_ALG_IDENTIFIER_S* CMP_getIntendedAlg (const CRMF_ENCRYPTED_VALUE_S* pstEncValue);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the Intended Algorithm Identifier for which the value will be used from CRMF_ENCRYPTED_VALUE_S structure.
 *
 * @param[in] pstEncValue Pointer to CRMF_ENCRYPTED_VALUE_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL SEC_ALG_IDENTIFIER_S *CMP_getIntendedAlg(const CRMF_ENCRYPTED_VALUE_S *pstEncValue);
 ...
 * @par Prototype
 * @code
 * SEC_ALG_IDENTIFIER_S* CMP_getSymmAlg (const CRMF_ENCRYPTED_VALUE_S* pstEncValue);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the Algorithm Identifier for Symmetric Key.
 *
 * @param[in] pstEncValue Pointer to CRMF_ENCRYPTED_VALUE_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL SEC_ALG_IDENTIFIER_S *CMP_getSymmAlg(const CRMF_ENCRYPTED_VALUE_S *pstEncValue);
 ...
 * @par Prototype
 * @code
 * SEC_ALG_IDENTIFIER_S* CMP_getKeyAlgID (const CRMF_ENCRYPTED_VALUE_S* pstEncValue);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the Key Algorithm Identifier used to encrypt the symmetric key.
 *
 * @param[in] pstEncValue Pointer to CRMF_ENCRYPTED_VALUE_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval SEC_ALG_IDENTIFIER_S* Key Algorithm which has been used to encrypt the Symmetric Key.
 ...
 * N/A
 */
PSELINKDLL SEC_ALG_IDENTIFIER_S *CMP_getKeyAlgID(const CRMF_ENCRYPTED_VALUE_S *pstEncValue);
 ...
 *
 * @par Description
 * Returns the hint value in  CRMF_ENCRYPTED_VALUE_S. It gives a brief description or identifier of the encValue
 * content.
 *
 * @param[in] pstEncValue Pointer to CRMF_ENCRYPTED_VALUE_Ss structure. [N/A]
 * @param[out] N/A N/A [N/A]
 ...
 * @retval SEC_List_S* If memory allocation fails to create the List. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * @par Prototype
 * @code
 * CMP_REVDETAILS_S* CMP_createRevocationDetail (const X509_CERT_S* pstCertificate,
 * const SEC_AsnBits_S* pstRevRsn,
 * const DATETIME_S* pstBadSinceDate);
 * @endcode
 *
 * @par Purpose
 ...
 * @retval CMP_REVDETAILS_S* If either of the Inputs are Invalid or memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CMP_REVDETAILS_S *CMP_createRevocationDetail(const X509_CERT_S *pstCertificate,
    const SEC_AsnBits_S *pstRevRsn, const DATETIME_S *pBadSinceDate);
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_addExtns(CMP_REVDETAILS_S *pstRevDetails, Extensions *pCRLEntryDetails);
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_addRevDetail(CMP_REVDETAILS_S *pstRevDetails, SEC_List_S *pRevReqContent);
 ...
 * @par Prototype
 * @code
 * CRMF_CERT_TEMPLATE_S* CMP_getCertDetail (const CMP_REVDETAILS_S* pstRevDetails);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the Certificate Template from a Revocation detail of the Revocation Request.
 *
 ...
 * @retval CRMF_CERT_TEMPLATE_S* If the input is NULL. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CRMF_CERT_TEMPLATE_S *CMP_getCertDetail(const CMP_REVDETAILS_S *pstRevDetails);
 ...
 *
 * @par Description
 * Returns the Revocation Reason from CMP_REVDETAILS_S structure.
 *
 * @param[in] pstRevDetails Pointer to CMP_REVDETAILS_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval ReasonFlags* Pointer to Reason Flags - SEC_AsnBits_S [ReasonFlags*|N/A]
 * @retval ReasonFlags* If the input is NULL. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * @par Prototype
 * @code
 * DATETIME_S* CMP_extractBadTime (const CMP_REVDETAILS_S* pstRevDetails);
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL DATETIME_S *CMP_extractBadTime(const CMP_REVDETAILS_S *pstRevDetails);
 ...
 * @par Prototype
 * @code
 * SEC_INT32* CMP_getVerFromCertTemplate (const CRMF_CERT_TEMPLATE_S* pstCertDetails);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the Version from the Certificate Template. Version can be of type V1, V2 and V3 supported by X509.
 *
 ...
 * @retval SEC_INT32* If the input is NULL. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL SEC_INT32 *CMP_getVerFromCertTemplate(const CRMF_CERT_TEMPLATE_S *pstCertDetails);
 ...
 *
 * @par Description
 * Returns the Serial Number from the Certificate Template.
 *
 * @param[in] pstCertDetails Pointer to CRMF_CERT_TEMPLATE_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval SEC_BIGINT_S* Big Num (Certificate Serial Number). [SEC_BIGINT_S*|N/A]
 * @retval SEC_BIGINT_S* If the input is NULL. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * @par Prototype
 * @code
 * SEC_ALG_IDENTIFIER_S* CMP_getSignAlg (const CRMF_CERT_TEMPLATE_S* pstCertDetails);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the Signing Algorithm from the Certificate Template.
 *
 * @param[in] pstCertDetails Pointer to CRMF_CERT_TEMPLATE_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL SEC_ALG_IDENTIFIER_S *CMP_getSignAlg(const CRMF_CERT_TEMPLATE_S *pstCertDetails);
 ...
 * @par Prototype
 * @code
 * SEC_NAME_S* CMP_getIssuer (const CRMF_CERT_TEMPLATE_S* pstCertDetails);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the Issuer Name from Certificate Template.
 *
 * @param[in] pstCertDetails Pointer to CRMF_CERT_TEMPLATE_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL SEC_NAME_S *CMP_getIssuer(const CRMF_CERT_TEMPLATE_S *pstCertDetails);
 ...
 * @par Prototype
 * @code
 * CRMF_OPT_VALIDITY_S* CMP_getValidity (const CRMF_CERT_TEMPLATE_S* pstCertDetails);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the Validity from the Certificate Template.
 *
 * @param[in] pstCertDetails Pointer to CRMF_CERT_TEMPLATE_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval CRMF_OPT_VALIDITY_S* Pointer to CRMF_OPT_VALIDITY_S. [CRMF_OPT_VALIDITY_S*|N/A]
 * @retval CRMF_OPT_VALIDITY_S* If the input is NULL. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CRMF_OPT_VALIDITY_S *CMP_getValidity(const CRMF_CERT_TEMPLATE_S *pstCertDetails);
 ...
 * @par Prototype
 * @code
 * SEC_NAME_S* CMP_getSubject (const CRMF_CERT_TEMPLATE_S* pstCertDetails);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the Subject Name from the Certificate Template.
 *
 * @param[in] pstCertDetails Pointer to CRMF_CERT_TEMPLATE_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL SEC_NAME_S *CMP_getSubject(const CRMF_CERT_TEMPLATE_S *pstCertDetails);
 ...
 * @par Prototype
 * @code
 * SEC_PUBKEY_INFO_S* CMP_getPubKeyInfo (const CRMF_CERT_TEMPLATE_S* pstCertDetails);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the Encoded Public Key from the Certificate Template.
 *
 * @param[in] pstCertDetails Pointer to CRMF_CERT_TEMPLATE_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL SEC_PUBKEY_INFO_S *CMP_getPubKeyInfo(const CRMF_CERT_TEMPLATE_S *pstCertDetails);
 ...
 *
 * @par Description
 * Returns the Issuer ID from the Certificate Template.
 *
 * @param[in] pstCertDetails Pointer to CRMF_CERT_TEMPLATE_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 *
 * @par Description
 * Returns the Subject ID from the Certificate Template.
 *
 * @param[in] pstCertDetails Pointer to CRMF_CERT_TEMPLATE_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * @par Prototype
 * @code
 * Extensions* CMP_getExtnsFromCertDetail (const CRMF_CERT_TEMPLATE_S* pstCertDetails);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the Extension List from the Certificate Template.
 *
 * @param[in] pstCertDetails Pointer to CRMF_CERT_TEMPLATE_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval Extensions* Pointer to Extension List. [Extensions*|N/A]
 * @retval Extensions* If the input is NULL. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL Extensions *CMP_getExtnsFromCertDetail(const CRMF_CERT_TEMPLATE_S *pstCertDetails);
 ...
 * @retval CMP_REVOKERESP_S* If any of the inputs are Invalid or memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CMP_REVOKERESP_S *CMP_createRevocationResp(CMP_PKISTATUS_S *pstPKIStatus, CRMF_CERT_ID_S *pstRevCerts,
    X509_CRL_S *pstCRLs);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32 CMP_addStatusToRevocationResp (const CMP_REVOKERESP_S* pstRevRepContent,
 * CMP_PKISTATUS_S* pstPKIStatusInfo);
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_addStatusToRevocationResp(const CMP_REVOKERESP_S *pstRevRepContent,
    CMP_PKISTATUS_S *pstPKIStatusInfo);
 ...
 * @par Prototype
 * @code
 * CRMF_CERT_ID_S* CMP_createCertID (const CMP_REVDETAILS_S *pstRevDetails,
 ...
 * @retval CRMF_CERT_ID_S* If either of the inputs are NULL or memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CRMF_CERT_ID_S *CMP_createCertID(const CMP_REVDETAILS_S *pstRevDetails, SEC_GEN_NAME_S *pstIssuer);
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_addCertID(CMP_REVOKERESP_S *pstRevRepContent, CRMF_CERT_ID_S *pstCertID);
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_addCRL(CMP_REVOKERESP_S *pstRevRepContent, X509_CRL_S *pstCRL);
 ...
 * @par Prototype
 * @code
 * CMP_PKISTATUS_S* CMP_getFirstStatus (const CMP_REVOKERESP_S* pstRevRepCnt);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the first PKI Status from the list in CMP_REVOKERESP_S structure.
 *
 ...
 * @retval CMP_PKISTATUS_S* If the input is NULL. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CMP_PKISTATUS_S *CMP_getFirstStatus(const CMP_REVOKERESP_S *pstRevRepCnt);
 ...
 * @par Prototype
 * @code
 * CMP_PKISTATUS_S* CMP_getNextStatus (const CMP_REVOKERESP_S* pstRevRepCnt);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the next PKI Status from the list in CMP_REVOKERESP_S structure.
 *
 * @param[in] pstRevRepCnt Pointer to CMP_REVOKERESP_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL CMP_PKISTATUS_S *CMP_getNextStatus(const CMP_REVOKERESP_S *pstRevRepCnt);
 ...
 * @par Prototype
 * @code
 * CRMF_CERT_ID_S* CMP_getFirstCertID (const CMP_REVOKERESP_S* pstRevRepCnt);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the First Certificate ID structure from the list in CMP_REVOKERESP_S structure.
 *
 * @param[in] pstRevRepCnt Pointer to CMP_REVOKERESP_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval CRMF_CERT_ID_S* Pointer to CRMF_CERT_ID_S structure. [pstCertID|N/A]
 * @retval CRMF_CERT_ID_S* If the input is NULL. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CRMF_CERT_ID_S *CMP_getFirstCertID(const CMP_REVOKERESP_S *pstRevRepCnt);
 ...
 * @par Prototype
 * @code
 * CRMF_CERT_ID_S* CMP_getNextCertID (const CMP_REVOKERESP_S* pstRevRepCnt);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the Next Certificate ID structure from the list in CMP_REVOKERESP_S structure.
 *
 * @param[in] pstRevRepCnt Pointer to CMP_REVOKERESP_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL CRMF_CERT_ID_S *CMP_getNextCertID(const CMP_REVOKERESP_S *pstRevRepCnt);
 ...
 * @par Prototype
 * @code
 * X509_CRL_S* CMP_getFirstCRL (const CMP_REVOKERESP_S* pstRevRepCnt);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the First CRL from the list in CMP_REVOKERESP_S structure.
 *
 * @param[in] pstRevRepCnt Pointer to CMP_REVOKERESP_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval X509_CRL_S* Pointer to X509_CRL_S structure. [pstCRL|N/A]
 * @retval X509_CRL_S* If the input is NULL. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL X509_CRL_S *CMP_getFirstCRL(const CMP_REVOKERESP_S *pstRevRepCnt);
 ...
 * @par Prototype
 * @code
 * X509_CRL_S* CMP_getNextCRL (const CMP_REVOKERESP_S* pstRevRepCnt);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the next CRL from the list in CMP_REVOKERESP_S structure.
 *
 * @param[in] pstRevRepCnt Pointer to CMP_REVOKERESP_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL X509_CRL_S *CMP_getNextCRL(const CMP_REVOKERESP_S *pstRevRepCnt);
 ...
 *
 * @par Description
 * Creates a CA Key Update Announcement structure. Whenever the CA changes its key pair, it publishes the new
 * certificates through this Announcement.
 *
 * @param[in] pstOldwithNew Pointer to Certificate containing the old CA public key signed with the new private key.
 * [N/A]
 * @param[in] pstNewwithOld Pointer to Certificate containing the new CA public key signed with the old private key.
 * [N/A]
 * @param[in] pstNewwithNew Pointer to Certificate containing the new CA public key signed with the new private key.
 * [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval CMP_CAKEYUPDATEANN_S* Pointer to CMP_CAKEYUPDATEANN_S structure. [pstCAKeyUpdAnnCnt|N/A]
 * @retval CMP_CAKEYUPDATEANN_S* If any of the inputs are NULL. [SEC_NULL|N/A]
 * @retval CMP_CAKEYUPDATEANN_S* If memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CMP_CAKEYUPDATEANN_S *CMP_createCAKeyUpdateAnn(X509_CERT_S *pstOldwithNew, X509_CERT_S *pstNewwithOld,
    X509_CERT_S *pstNewwithNew);
 ...
 * @par Prototype
 * @code
 * X509_CERT_S* CMP_getOldWithNewCert (const CMP_CAKEYUPDATEANN_S* pstCAKeyUpdAnnCnt);
 * @endcode
 *
 * @par Purpose
 * To get the Certificate containing the old CA public key signed with the new private key from CA Key Update
 * Announcement structure.
 *
 * @par Description
 * Returns the Certificate containing the old CA public key signed with the new private key from CA Key Update
 * Announcement structure.
 *
 ...
 * N/A
 */
PSELINKDLL X509_CERT_S *CMP_getOldWithNewCert(const CMP_CAKEYUPDATEANN_S *pstCAKeyUpdAnnCnt);
 ...
 * @par Prototype
 * @code
 * X509_CERT_S* CMP_getNewWithOldCert (const CMP_CAKEYUPDATEANN_S* pstCAKeyUpdAnnCnt);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the Certificate containing the new CA public key signed with the old private key from CA Key Update
 * Announcement structure.
 *
 * @param[in] pstCAKeyUpdAnnCnt Pointer to CMP_CAKEYUPDATEANN_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 ...
 * N/A
 */
PSELINKDLL X509_CERT_S *CMP_getNewWithOldCert(const CMP_CAKEYUPDATEANN_S *pstCAKeyUpdAnnCnt);
 ...
 * @par Prototype
 * @code
 * X509_CERT_S* CMP_getNewWithNewCert (const CMP_CAKEYUPDATEANN_S* pstCAKeyUpdAnnCnt);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the Certificate containing the new CA public key signed with the new private key from CA Key Update
 * Announcement structure.
 *
 * @param[in] pstCAKeyUpdAnnCnt Pointer to CMP_CAKEYUPDATEANN_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 ...
 * N/A
 */
PSELINKDLL X509_CERT_S *CMP_getNewWithNewCert(const CMP_CAKEYUPDATEANN_S *pstCAKeyUpdAnnCnt);
 ...
 * CRMF_CERT_ID_S* pstCertID,
 * const DATETIME_S* pstWillBeRevokedAt,
 * const DATETIME_S* pstBadSinceDate,
 * Extensions* pCRLDetails);
 * @endcode
 *
 ...
 * @retval CMP_REVOKEANN_S* If any of the inputs are Invalid. [SEC_NULL|N/A]
 * @retval CMP_REVOKEANN_S* If memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CMP_REVOKEANN_S *CMP_createRevocationAnnounce(SEC_UINT32 ulPKIstatus, CRMF_CERT_ID_S *pCertID,
    const DATETIME_S *pWillBeRevokedAt, const DATETIME_S *pBadSinceDate, Extensions *pCRLDetails);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32 CMP_getStatus (const CMP_REVOKEANN_S* pstRann);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the PKI Status (CERT_RESP_STATUS_E) from Revocation Announcement.
 *
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_getStatus(const CMP_REVOKEANN_S *pstRann);
 ...
 * @par Prototype
 * @code
 * CRMF_CERT_ID_S* CMP_getCertID (const CMP_REVOKEANN_S* pstRann);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the Certificate ID from Revocation Announcements.
 *
 * @param[in] pstRann Pointer to CMP_REVOKEANN_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval CRMF_CERT_ID_S* Pointer to CRMF_CERT_ID_S. [CRMF_CERT_ID_S*|N/A]
 * @retval CRMF_CERT_ID_S* If input is NULL. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CRMF_CERT_ID_S *CMP_getCertID(const CMP_REVOKEANN_S *pstRann);
 ...
 * @par Prototype
 * @code
 * DATETIME_S* CMP_extractRevocationTime (const CMP_REVOKEANN_S* pstRann);
 * @endcode
 *
 * @par Purpose
 ...
 * @retval DATETIME_S* If input is NULL. [SEC_NULL|N/A]
 * @retval DATETIME_S* If Generalized Time to DateTime Conversion Fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 ...
 * N/A
 */
PSELINKDLL DATETIME_S *CMP_extractRevocationTime(const CMP_REVOKEANN_S *pstRann);
 ...
 * @par Prototype
 * @code
 * DATETIME_S* CMP_extractBadDate (const CMP_REVOKEANN_S* pstRann);
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL DATETIME_S *CMP_extractBadDate(const CMP_REVOKEANN_S *pstRann);
 ...
 * @par Prototype
 * @code
 * Extensions* CMP_getExtnsFromRevocationAnnounce (const CMP_REVOKEANN_S* pstRann);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the Extensions from Revocation Announcement Content.
 *
 * @param[in] pstRann Pointer to CMP_REVOKEANN_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval Extensions* Pointer to SEC_EXTN_S List. [Extensions*|N/A]
 * @retval Extensions* If input is NULL. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL Extensions *CMP_getExtnsFromRevocationAnnounce(const CMP_REVOKEANN_S *pstRann);
 ...
 * @retval SEC_List_S* If input is NULL. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL SEC_List_S *CMP_createCRLAnnounce(X509_CRL_S *pstCertList);
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_addCertList(SEC_List_S *pstCRLAnnCnt, X509_CRL_S *pstCertList);
 ...
 *
 * @par Description
 * Returns a CRL from CRL Announcement List.
 *
 * @param[in] pstCRLAnnCnt Pointer to SEC_List_S. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * @par Prototype
 * @code
 * CMP_CHALLENGE_S* CMP_createChallenge (const CMP_PKIHDR_S* pstPKIHdr,
 * SEC_UINT32 ulAlgID,
 ...
 * @retval CMP_CHALLENGE_S* If any of the inputs are Invalid or memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 *
 */
PSELINKDLL CMP_CHALLENGE_S *CMP_createChallenge(const CMP_PKIHDR_S *pstPKIHdr, SEC_UINT32 ulAlgID,
    SEC_UINT32 ulOWFAlgID, SEC_UINT32 ulChallLen, SEC_BOOL bFirstChall, const SEC_UCHAR *pucSymmKey,
    SEC_UINT32 ulSymmKeyLen, const SEC_UCHAR *pucInitVect, SEC_UINT32 ulInitVectLen);
 ...
 *
 * @par Description
 * Adds a Challenge to POP DecryptKeyChallengeCnt List. Challenge can be added in order to prove the possession of
 * Private Key with one Challenge per encryption key certification request.
 *
 * @param[in] pstChall Pointer to CMP_CHALLENGE_S structure. [N/A]
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_addChallenge(SEC_List_S *pPOPODecKeyChallCnt, CMP_CHALLENGE_S *pstChall);
 ...
 *
 * @par Description
 * This method can be used to verify the Challenge. This can be used for verifying the Challenge in case the EE and
 * CA/RA share the Secret Key (Symmetric Key).
 *
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_verifyChallenge(SEC_UINT32 ulChallengeIndex, SEC_List_S *pPOPODecKeyChallCnt,
    SEC_GEN_NAME_S *pSenderName, SEC_UINT32 ulAlgID, const SEC_UCHAR *pucSymmKey, SEC_UINT32 ulSymmKeyLen,
    const SEC_UCHAR *pucInitVect, SEC_UINT32 ulInitVectLen);
 ...
 *
 * @par Description
 * Returns the first Challenge from POPODecKeyChallContent List.
 *
 * @param[in] pPOPDecKeyChallCnt Pointer to POPODecKeyChallContent List. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval CMP_CHALLENGE_S* Pointer to CMP_CHALLENGE_S structure. [pstChallenge|N/A]
 * @retval CMP_CHALLENGE_S* If input is NULL. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CMP_CHALLENGE_S *CMP_getFirstChallenge(SEC_List_S *pPOPDecKeyChallCnt);
 ...
 *
 * @par Description
 * Returns the next Challenge from POPODecKeyChallContent List.
 *
 * @param[in] pPOPDecKeyChallCnt Pointer to POPODecKeyChallContent List. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL CMP_CHALLENGE_S *CMP_getNextChallenge(SEC_List_S *pPOPDecKeyChallCnt);
 ...
 * @par Prototype
 * @code
 * CMP_RAND_S* CMP_getChallengeVal (const CMP_CHALLENGE_S* pstChall,
 * SEC_UINT32 ulAlgID,
 * const SEC_UCHAR * pucSymmKey,
 * SEC_UINT32 ulSymmKeyLen,
 * const SEC_UCHAR * pucInitVect,
 ...
 *
 * @par Description
 * Returns the randomly generated Challenge Value from CMP_CHALLENGE_S structure.
 *
 * @param[in] pstChall Pointer to CMP_CHALLENGE_S structure. [N/A]
 * @param[in] ulAlgID Algorithm for decryption. [N/A]
 * @param[in] pucSymmKey Symmetric Key for decryption. [N/A]
 ...
 * @retval CMP_RAND_S* If input is NULL or memory allocation fails. [SEC_NULL|N/A]
 * @retval CMP_RAND_S* If decryption fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CMP_RAND_S *CMP_getChallengeVal(const CMP_CHALLENGE_S *pstChall, SEC_UINT32 ulAlgID,
    const SEC_UCHAR *pucSymmKey, SEC_UINT32 ulSymmKeyLen, const SEC_UCHAR *pucInitVect, SEC_UINT32 ulInitVectLen);
 ...
 * @retval SEC_AsnOcts_S* If input is NULL. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * @par Prototype
 * @code
 * SEC_UINT32 CMP_getOWF (const CMP_CHALLENGE_S* pstChall);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns the OWF(One Way Function) from CMP_CHALLENGE_S structure.
 *
 * @param[in] pstChall Pointer to CMP_CHALLENGE_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_getOWF(const CMP_CHALLENGE_S *pstChall);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32 CMP_getRand (const CMP_RAND_S* pstRand);
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_getRand(const CMP_RAND_S *pstRand);
 ...
 * @retval SEC_List_S* If inputs are NULL. [SEC_NULL|N/A]
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_addRandom(SEC_List_S *pPOPODecKeyRespCnt, SEC_UINT32 ulRandInt);
 ...
 * @retval CMP_INFOTYPEVAL_S* If input parameters are NULL or memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 *
 */
PSELINKDLL CMP_INFOTYPEVAL_S *CMP_createInfoTypeAndValue(SEC_UINT32 ulInfoID, SEC_VOID *pstInfoValue);
 ...
 * @retval SEC_List_S* If input parameter is NULL or memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 CMP_addInfoTypeAndValue(SEC_List_S *pList, CMP_INFOTYPEVAL_S *pstInfoTypeAndVal);
 ...
 *
 * @par Description
 * Returns the First CMP_INFOTYPEVAL_S structure from GenMsgCnt List or GenRepCnt List.
 *
 ...
 *
 * @par Description
 * Returns the next CMP_INFOTYPEVAL_S structure from GenMsgCnt List or GenRepCnt List.
 *
 * @param[in] pList Pointer to List. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 *
 * @par Description
 * Returns the Information Type from CMP_INFOTYPEVAL_S structure.
 *
 * @param[in] pstInfoTypeAndVal Pointer to CMP_INFOTYPEVAL_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * @par Prototype
 * @code
 * SEC_VOID* CMP_getInfoVal (const CMP_INFOTYPEVAL_S* pstInfoTypeAndVal);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns Information Value from CMP_INFOTYPEVAL_S structure.
 *
 * @param[in] pstInfoTypeAndVal Pointer to CMP_INFOTYPEVAL_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL SEC_VOID *CMP_getInfoVal(const CMP_INFOTYPEVAL_S *pstInfoTypeAndVal);
 ...
 * @retval CMP_ERRMSG_S* If any of the inputs are NULL. [SEC_NULL|N/A]
 * @retval CMP_ERRMSG_S* If memory allocation fails. [SEC_NULL|N/A]
 * @retval CMP_ERRMSG_S* If ulStatus in PKIStatus is not "REJECTION". [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CMP_ERRMSG_S *CMP_createErrMsg(CMP_PKISTATUS_S *pstPKIStatus, SEC_List_S *pErrDetails,
    const SEC_UINT32 *pulErrCode);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32* CMP_getErrCode (const CMP_ERRMSG_S* pstErrMsgCnt);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns Error Code from CMP_ERRMSG_S.
 *
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 *CMP_getErrCode(const CMP_ERRMSG_S *pstErrMsgCnt);
 ...
 * @par Prototype
 * @code
 * SEC_List_S* CMP_getErrDetails (const CMP_ERRMSG_S* pstErrMsgCnt);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns Error details from Error Message.
 *
 * @param[in] pstErrMsgCnt Pointer to CMP_ERRMSG_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL SEC_List_S *CMP_getErrDetails(const CMP_ERRMSG_S *pstErrMsgCnt);
 ...
 * @par Prototype
 * @code
 * CMP_PKISTATUS_S* CMP_getPKIStatusInfo (const CMP_ERRMSG_S* pstErrMsgCnt);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns PKI Status from Error Message.
 *
 * @param[in] pstErrMsgCnt Pointer to CMP_ERRMSG_S structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval CMP_PKISTATUS_S* Pointer to CMP_PKISTATUS_S structure. [pPKIStatusinfo|N/A]
 * @retval CMP_PKISTATUS_S* If input is NULL. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CMP_PKISTATUS_S *CMP_getPKIStatusInfo(const CMP_ERRMSG_S *pstErrMsgCnt);
 ...
 * @par Prototype
 * @code
 * SEC_VOID CMP_freeCertRepMsg (CMP_CERTRESPMSG_S* pstCertRepMsg);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @param[in] pstCertRepMsg Pointer to CMP_CERTRESPMSG_S structure to be freed. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval SEC_VOID This function does not return any value. [N/A|N/A]
 *
 ...
 * N/A
 */
PSELINKDLL SEC_VOID CMP_freeCertRepMsg(CMP_CERTRESPMSG_S *pstCertRepMsg);
 ...
 * N/A
 */
PSELINKDLL SEC_UCHAR *CMP_encodeRand(CMP_RAND_S *pstRand, SEC_UINT32 *pulLength);
 ...
 * @retval CMP_RAND_S* If either of the inputs are NULL. [SEC_NULL|N/A]
 * @retval CMP_RAND_S* If memory allocation fails. [SEC_NULL|N/A]
 * @retval CMP_RAND_S* If decode fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CMP_RAND_S *CMP_decodeRand(SEC_UCHAR *pucEncodedRand, SEC_UINT32 ulEncodedRandLength,
    SEC_UINT32 *pulBytesDecoded);
 ...
 * @retval CRMF_PBM_PARAM_S* If the input is NULL. [SEC_NULL|N/A]
 * @retval CRMF_PBM_PARAM_S* If memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * @retval CMP_DHBMPARAM_S* If the input is NULL. [SEC_NULL|N/A]
 * @retval CMP_DHBMPARAM_S* If memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * @retval CMP_CHALLENGE_S* If the input is NULL. [SEC_NULL|N/A]
 * @retval CMP_CHALLENGE_S* If memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * @retval CMP_CERTTYPE_S* If the input is NULL. [SEC_NULL|N/A]
 * @retval CMP_CERTTYPE_S* If memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * @retval CMP_REVDETAILS_S* If the input is NULL. [SEC_NULL|N/A]
 * @retval CMP_REVDETAILS_S* If memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * @retval CMP_CAKEYUPDATEANN_S* If the input is NULL. [SEC_NULL|N/A]
 * @retval CMP_CAKEYUPDATEANN_S* If memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 ...
 * @retval CMP_PKISTATUS_S* If the input is NULL. [SEC_NULL|N/A]
 * @retval CMP_PKISTATUS_S* If memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * @retval CMP_KEYPAIR_S* If the input is NULL. [SEC_NULL|N/A]
 * @retval CMP_KEYPAIR_S* If memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * @retval CMP_REVOKEANN_S* If the input is NULL. [SEC_NULL|N/A]
 * @retval CMP_REVOKEANN_S* If memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 ...
 * @retval CMP_ERRMSG_S* If the input is NULL. [SEC_NULL|N/A]
 * @retval CMP_ERRMSG_S* If memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 ...
 * @retval CMP_CERTRESP_S* If the input is NULL. [SEC_NULL|N/A]
 * @retval CMP_CERTRESP_S* If memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 ...
 * @retval CMP_KEYRECOVERYRESP_S* If the input is NULL. [SEC_NULL|N/A]
 * @retval CMP_KEYRECOVERYRESP_S* If memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * @retval CMP_REVOKERESP_S* If the input is NULL. [SEC_NULL|N/A]
 * @retval CMP_REVOKERESP_S* If memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * @retval CMP_CERTRESPMSG_S* If the input is NULL. [SEC_NULL|N/A]
 * @retval CMP_CERTRESPMSG_S* If memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * @retval CMP_PKIMSG_S* If the input is NULL. [SEC_NULL|N/A]
 * @retval CMP_PKIMSG_S* If memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 ...
 * @retval CMPV2_CERT_CONF_MSG_S* If the input is NULL. [SEC_NULL|N/A]
 * @retval CMPV2_CERT_CONF_MSG_S* If memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CMPV2_CERT_CONF_MSG_S *SEC_dupCertConfMessage(CMPV2_CERT_CONF_MSG_S *pstConfMsg);
 ...
 * @retval CMPV2_POLL_REQ_MSG_S* If the input is NULL. [SEC_NULL|N/A]
 * @retval CMPV2_POLL_REQ_MSG_S* If memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CMPV2_POLL_REQ_MSG_S *SEC_dupPollReqMessage(CMPV2_POLL_REQ_MSG_S *pstPollReqMsg);
 ...
 * @retval CMPV2_POLL_REP_MSG_S* If the input is NULL. [SEC_NULL|N/A]
 * @retval CMPV2_POLL_REP_MSG_S* If memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
 *
 ...
 * N/A
 */
PSELINKDLL CMPV2_POLL_REP_MSG_S *SEC_dupPollRepMessage(CMPV2_POLL_REP_MSG_S *pstPollRepMsg);
#endif
 ...
 * @retval CMP_RAND_S* If the input is NULL. [SEC_NULL|N/A]
 * @retval CMP_RAND_S* If memory allocation fails. [SEC_NULL|N/A]
 *
 * @par Dependency
 * cmp.h
...
/**
* @defgroup CMP_setMaxCMPMsgSize
* @ingroup cmpFunctions
* @par Prototype
* @code
* SEC_INT CMP_setMaxCMPMsgSize(SEC_UINT32 uiCmpMaxMsgSize)
* @endcode
*
* @par Purpose
*  This API set maximum limit CMP message used in CMP_decodePKIMsg . Default value is 100 MB
*
* @par Description
* This API set max limit CMP message used in CMP_decodePKIMsg . Default value is 100 MB
*
* @param[in] uiCmpMaxMsgSize maximum size of CMP message[N/A]
* @param[out] N/A N/A [N/A]
*
* @retval SEC_INT If the uiCmpMaxMsgSize set is successful. [IPSI_SUCCESS|NA]
* @retval SEC_INT If it fails to set.uiCmpMaxMsgSize [IPSI_FAILURE|NA]
...
*
* @par Note
* This is not a thread safe API. It should be called once during the init process.
* Should be called before any CMP or PSE operation is performed.
*
* @par Related Topics
* N/A
*/
PSELINKDLL SEC_INT CMP_setMaxCMPMsgSize(SEC_UINT32 uiCmpMaxMsgSize);

PSELINKDLL CMP_PKIMSG_S *CMP_decodeGMPKIMsg(SEC_UCHAR *pucEncodedPKIMsg, SEC_UINT32 ulEncodedLength,
    SEC_UINT32 *pulBytesDecoded);
