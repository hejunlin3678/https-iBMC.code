...
******************************************** */
#ifndef IPSI_SCEP_ERRORDEF_H
#define IPSI_SCEP_ERRORDEF_H
...
#define IPSI_SCEP_ERR_SYSTEM_LIMIT (IPSI_SCEP_ERR_SYSTEM_INIT + IPSI_SCEP_ERR_RANGE - 1)

#define IPSI_SCEP_ERR_COMMON_INIT (IPSI_SCEP_ERR_SYSTEM_LIMIT + 1)

// MAX Total Common error limit
#define IPSI_SCEP_ERR_COMMON_LIMIT (IPSI_SCEP_ERR_COMMON_INIT + IPSI_SCEP_ERR_RANGE - 1)
...
enum {
    ...
    IPSI_SCEP_ERR_MORE_THAN_TWO_RA_CERTIFICATE,

    IPSI_SCEP_ERR_NOT_SAME_ISSUER_TWO_RA_CERTIFICATE,

    IPSI_SCEP_ERR_NO_RA_CERTIFICATE,

    IPSI_SCEP_ERR_COMMON_MAX
};

// Gives the error code
#define IPSI_SCEP_ERR_REASON_CODE(err) ((err)&0x0000FFFF)

// Gives the function code where error is occured
#define IPSI_SCEP_FUNC_REASON_CODE(err) ((err) >> 16)
