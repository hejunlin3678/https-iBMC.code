 ...
 *
 */
PSELINKDLL PKCS10_REQ_S *PKCS10_createCertReq(SEC_UINT32 ulVer, SEC_NAME_S *pstName, const SEC_PKEY_S *pstPubKey);
 ...
 * 3. Refer PKCS10_signCertReq_ex to specify the signing algorithm explictly.\n
 * 4. If application does not set seeds and entropy on frequent intervals, it can lead to vulnerable keys or random
 ...
 *
 */
PSELINKDLL SEC_UINT32 PKCS10_signCertReq(PKCS10_REQ_S *pstCertReq, SEC_PKEY_S *pstPrivKey, SEC_UINT32 ulHashAlgId);
 ...
 *
 */
PSELINKDLL SEC_UINT32 PKCS10_addExtn(PKCS10_REQ_S *pstCertReq, SEC_EXTN_S *pstExtn);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32  PKCS10_addChallengePwd(const PKCS10_REQ_S* pstCertReq,
 ...
 *
 */
PSELINKDLL SEC_UINT32 PKCS10_addChallengePwd(const PKCS10_REQ_S *pstCertReq, SEC_UCHAR *pucChallPwd,
    SEC_UINT32 ulChallPwdLen);
 ...
 *
 */
PSELINKDLL SEC_UCHAR *PKCS10_getChallengePwd(const PKCS10_REQ_S *pstCertReq, SEC_UINT32 *pulChallPwdLen);
 ...
 * N/A
 */
PSELINKDLL SEC_UCHAR *PKCS10_encodeCertReq(PKCS10_REQ_S *pstCertReq, SEC_UINT32 *pulCertReqLen);
 ...
 * N/A
 */
PSELINKDLL PKCS10_REQ_S *PKCS10_decodeCertReq(SEC_UCHAR *pucEncCertReq, SEC_UINT32 ulLen, SEC_UINT32 *pulLenDecoded);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32  PKCS10_verify(const PKCS10_REQ_S* pstCertReq)
 * @endcode
 *
 * @par Purpose
 ...
 *
 */
PSELINKDLL SEC_UINT32 PKCS10_verify(const PKCS10_REQ_S *pstCertReq);
 ...
 * N/A
 */
PSELINKDLL PKCS10_REQ_S *PKCS10_dupCertReq(PKCS10_REQ_S *pSrc);

/**
 * @defgroup PKCS10_signCertReq_ex
 * @ingroup pkcs10Functions
 * @par Prototype
 * @code
 * PSELINKDLL SEC_UINT32  PKCS10_signCertReq_ex(PKCS10_REQ_S* pstCertReq,
 * SEC_PKEY_S*   pstPrivKey,
 * SEC_UINT uiAsymAlg,
 * SEC_UINT32    ulHashAlgId)
 * @endcode
 *
 * @par Purpose
 * To sign a PKCS10 certificate request message using the given key & asym algorithm.
 * @par Description
 * This function generates signature on PKCS10_REQINFO_S structure and
 * sets the signature and signature algorithm field in the Certificate
 * Request. For signing, the private key corresponding to the public key
 ...
 * @param[in] pstCertReq Certifcate Request structure [N/A]
 * @param[in] pstPrivKey Private key used for signing [N/A]
 * @param[in] uiAsymAlg Asymetric algo used for signing [N/A]
 * @param[in] ulHashAlgId Hash Algorithm ID [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval SEC_UINT32 If certificate Request is signed successfully
 ...
 * @par Note
 * 1. If the request is already signed, the signature will be overwritten,\n
 * 2. For signing,the certitificate request using ALGID_SM2DSA(uiAsymAlg),
 * pstPrivKey parm should contain a key-pair value. \n
 ...
 *
 */
PSELINKDLL SEC_UINT32 PKCS10_signCertReq_ex(PKCS10_REQ_S *pstCertReq, SEC_PKEY_S *pstPrivKey, SEC_UINT uiAsymAlg,
    SEC_UINT32 ulHashAlgId);
