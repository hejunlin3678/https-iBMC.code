...
----------------------------------------------------------------------------
*************************************************************************** */
#ifndef SEC_PKI_CERT_BUNDLE_H
#define SEC_PKI_CERT_BUNDLE_H
 ...
 */
PSELINKDLL SEC_PKI_CERT_BUNDLE_S *SEC_PKI_createCertBundle(X509_CERT_S *pstCert, X509_CRL_S *pstCRL);
 ...
 *
 */
PSELINKDLL SEC_VOID SEC_PKI_freeCertBundle(SEC_PKI_CERT_BUNDLE_S *pstCertBundle);
 ...
 *
 */
PSELINKDLL SEC_INT SEC_PKI_addCertToCertBundle(SEC_PKI_CERT_BUNDLE_S *pstCertBundle, X509_CERT_S *pstCert);
 ...
 *
 */
PSELINKDLL SEC_INT SEC_PKI_addCrlToCertBundle(SEC_PKI_CERT_BUNDLE_S *pstCertBundle, X509_CRL_S *pstCrl);
 ...
 */
PSELINKDLL SEC_UCHAR *SEC_PKI_encodeCertBundle(SEC_PKI_CERT_BUNDLE_S *pstCertBundle, SEC_UINT32 *puiEncodedLen);
 ...
 */
PSELINKDLL SEC_PKI_CERT_BUNDLE_S *SEC_PKI_decodeCertBundle(SEC_CHAR *pcEncodedCertBundle, SEC_UINT32 uiEncodedLength,
    SEC_UINT32 *puiDecodedLength);
 ...
 */
PSELINKDLL SEC_List_S *SEC_PKI_GetCertsFromCertBundle(SEC_PKI_CERT_BUNDLE_S *pstBundle);
 ...
 */
PSELINKDLL SEC_List_S *SEC_PKI_GetCrlsFromCertBundle(SEC_PKI_CERT_BUNDLE_S *pstBundle);

/**
 * @defgroup SEC_PKI_GenAndUpdateCrlHash
 * @ingroup CertBundle_Functions
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_GenAndUpdateCrlHash(X509_CRL_S *pstCRL, SEC_UCHAR *pucCrlHashValue)
 * @endcode
 *
 * @par Purpose
 * compute the hash of CRL
 *
 * @par Description
 * compute the hash of CRL
 *
 * @param[in] pstCRL CRL. [NA/NA]
 * @param[out] pucCrlHashValue hash of CRL [NA/NA]
 *
 * @retval SEC_INT In case of success [SEC_PKI_SUCCESS|NA]
 * @retval SEC_INT In case of failure.[SEC_PKI_ERROR|NA]
 * @par Note
 * \n
 */
PSELINKDLL SEC_INT SEC_PKI_GenAndUpdateCrlHash(X509_CRL_S *pstCRL, SEC_UCHAR *pucCrlHashValue);
