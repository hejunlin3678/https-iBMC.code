 ...
 * Description: Structure declarations for ASN types
 * Author: VPP
 * Create: 2012/10/20
 */
#ifndef ASN_TYPES_H
 ...
 * @datastruct iFlag Extended flag for octets.
 */
typedef struct stSEC_ASNOCTS {
    SEC_UINT32 octetLen;
    SEC_CHAR *octs;
...
/**
 * @defgroup SEC_CRL_AsnOcts_S
 * @ingroup asn_typesStructures
 * @code
 * typedef struct stSEC_CRL_ASNOCTS
 * {
 * SEC_UINT32 octetLen
 * SEC_CHAR octs[20]
 * } SEC_CRL_AsnOcts_S
...
typedef SEC_CRL_AsnOcts_S SEC_CRL_UTCTime_S;
typedef SEC_CRL_AsnOcts_S SEC_CRL_GeneralizedTime_S;
