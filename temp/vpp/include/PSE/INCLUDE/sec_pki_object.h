...
************************************************************************** */
#ifndef SEC_PKI_OBJECT_H
#define SEC_PKI_OBJECT_H
...
*/
PSELINKDLL SEC_PKI_OBJ_S *SEC_PKI_objNew(SEC_PKI_CTX_S *pstContext);
...
*
*/
PSELINKDLL SEC_INT SEC_PKI_objSyncWithContext(SEC_PKI_OBJ_S *pstObject, SEC_UINT uiSyncType);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objSetName(const SEC_PKI_OBJ_S *pstObject,
 ...
 *
 */
PSELINKDLL SEC_INT SEC_PKI_objSetName(SEC_PKI_OBJ_S *pstObject, const SEC_CHAR *pcName, SEC_UINT iLen);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objGetName(const SEC_PKI_OBJ_S *pstObject,
 * SEC_CHAR *pcName,SEC_UINT ilen,
 * SEC_UINT* pinamelen)
 * @endcode
 * @par Purpose
 ...
 *
 */
PSELINKDLL SEC_INT SEC_PKI_objGetName(const SEC_PKI_OBJ_S *pstObject, SEC_CHAR *pcName, SEC_UINT iLen,
    SEC_UINT *piNamelen);
...
*/
PSELINKDLL SEC_INT SEC_PKI_objLoadDfltLocalCertAndKeyFile(SEC_PKI_OBJ_S *pstObject, const SEC_CHAR *pcCertFile,
...
*   - DRBG is enabled by default.
*/
PSELINKDLL SEC_INT SEC_PKI_objLoadDfltLocalCertAndKeyBuffer(SEC_PKI_OBJ_S *pstObject, const SEC_CHAR *pcCertBuffer,
...
/**
 * @defgroup SEC_PKI_objGetDfltLocalCertType
 * @ingroup Object_Functions
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objGetDfltLocalCertType(const SEC_PKI_OBJ_S *pstObject, SEC_INT32 *piCertType,
 * SEC_UINT32 *puiCurveType);
 * @endcode
 *
 * @par Purpose
 * This function is used to get the default certificate type from the object. If default certificate type is ECDSA,
 * it will update the group id of curve.
 *
 * @par Description
 * is used to get the default certificate type from the object. If default certificate type is ECDSA,
 * it will update the groud id of curve.
 *
 *
 * @param[in] pstObject Pointer to SEC_PKI_OBJ_S.[NA/NA]
 * @param[out] piCertType Cettificate type [/NA]
 * @param[out] puiCurveType GroupId of EC curve when certificate is of ECDSA type[NA/NA]
 *
 *
 * @retval SEC_INT On successful execution. [SEC_PKI_SUCCESS|NA]
 * @retval SEC_INT On all failure conditions. If the input is invalid (NULL
 ...
 *
 */
PSELINKDLL SEC_INT SEC_PKI_objGetDfltLocalCertType(const SEC_PKI_OBJ_S *pstObject, SEC_INT32 *piCertType,
    SEC_UINT32 *puiCurveType);
...
*   - DRBG is enabled by default.
*/
PSELINKDLL SEC_INT SEC_PKI_objLoadLocalCertAndKeyFile(SEC_PKI_OBJ_S *pstObject, const SEC_CHAR *pcCertFile,
    SEC_INT iCertFileType, const SEC_CHAR *pcCertPasswd, SEC_UINT uCertPwdLen, const SEC_CHAR *pcKeyFile,
    SEC_INT iKeyFileType, const SEC_CHAR *pcKeyPasswd, SEC_UINT uKeyPwdLen, const SEC_CHAR *pcURL, SEC_UINT uUrlLen,
    PEM_WARNING_CODE_E *peWarningCode);
...
*   - DRBG is enabled by default.
*/
PSELINKDLL SEC_INT SEC_PKI_objLoadLocalCertAndKeyBuffer(SEC_PKI_OBJ_S *pstObject, const SEC_CHAR *pcCertBuffer,
    SEC_UINT uCertBufLen, SEC_INT iCertType, const SEC_CHAR *pcCertPasswd, SEC_UINT uCertPwdLen,
    const SEC_CHAR *pcKeyBuffer, SEC_UINT uKeyBufLen, SEC_INT iKeyType, const SEC_CHAR *pcKeyPasswd,
    SEC_UINT uKeyPwdLen, const SEC_CHAR *pcURL, SEC_UINT uUrlLen, PEM_WARNING_CODE_E *peWarningCode);
 ...
 */
PSELINKDLL SEC_INT SEC_PKI_objSetVerifyDepth(SEC_PKI_OBJ_S *pstObject, SEC_INT iDepth);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objGetVerifyDepth (const SEC_PKI_OBJ_S *pstObject,
 * SEC_INT *piDepth);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * SEC_PKI_objGetVerifyDepth function returns verification depth of the pstObject,
 * and the certificate validation has to be performed until this depth.
 ...
 *
 */
PSELINKDLL SEC_INT SEC_PKI_objGetVerifyDepth(const SEC_PKI_OBJ_S *pstObject, SEC_INT *piDepth);
 ...
 */
PSELINKDLL SEC_INT SEC_PKI_objSetVerifyParam(SEC_PKI_OBJ_S *pstObject, SEC_UINT verifyFlags);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objGetVerifyParam(const SEC_PKI_OBJ_S *pstObject,
 ...
 *
 * @par Description
 * SEC_PKI_objGetVerifyParam function returns Verify Parameter set in the object.
 *
 * @param[in] pstObject Pointer to SEC_PKI_OBJ_S.[NA/NA]
 ...
 *
 */
PSELINKDLL SEC_INT SEC_PKI_objGetVerifyParam(const SEC_PKI_OBJ_S *pstObject, SEC_UINT *pVerifyFlags);
 ...
 *
 */
PSELINKDLL SEC_INT SEC_PKI_objClearVerifyParam(SEC_PKI_OBJ_S *pstObject, SEC_UINT verifyFlags);
 ...
 *
 */
PSELINKDLL SEC_INT SEC_PKI_objSetTime(SEC_PKI_OBJ_S *pstObject, const DATETIME_S *pstTime);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objGetTime(const SEC_PKI_OBJ_S *pstObject,
 * DATETIME_S **dpstTime)
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * SEC_PKI_objGetTime function returns the time set in the object,
 ...
 *
 */
PSELINKDLL SEC_INT SEC_PKI_objGetTime(const SEC_PKI_OBJ_S *pstObject, DATETIME_S **dpstTime);
...
*
*/
PSELINKDLL SEC_INT SEC_PKI_objGetVerifyResult(const SEC_PKI_OBJ_S *pstObject);
 ...
 *
 * @par Description
 * SEC_PKI_objGetCtxCACertReq function returns the CA Certificate(s) or CA
 ...
 *
 */
PSELINKDLL SEC_INT SEC_PKI_objGetCtxCACertReq(SEC_PKI_OBJ_S *pstObject, SEC_PKI_PARAMETER_E enId,
    SEC_List_S **dpOutList);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objGetDfltLocalCert(const SEC_PKI_OBJ_S *pstObject,
 * X509_CERT_S  **pstCert)
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * SEC_PKI_objGetDfltLocalCert function returns the default local cert associated
 ...
 *
 */
PSELINKDLL SEC_INT SEC_PKI_objGetDfltLocalCert(const SEC_PKI_OBJ_S *pstObject, X509_CERT_S **pstCert);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objGetAllLocalCert(const SEC_PKI_OBJ_S *pstObject,
 ...
 *
 * @par Description
 * SEC_PKI_objGetAllLocalCert function returns all Certificates from local store,
 ...
 */
PSELINKDLL SEC_INT SEC_PKI_objGetAllLocalCert(const SEC_PKI_OBJ_S *pstObject, SEC_List_S **dpOutCertList);
...
* @par Prototype
* @code
* SEC_INT SEC_PKI_objGetAllLocalCertChain(const SEC_PKI_OBJ_S *pstObject,
...
*
* @par Description
* SEC_PKI_objGetAllLocalCertChain function returns the certificate chain for all
...
*
*/
PSELINKDLL SEC_INT SEC_PKI_objGetAllLocalCertChain(const SEC_PKI_OBJ_S *pstObject, SEC_List_S **dpOutCertChainList);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objGetLocalCertChainByCert (const SEC_PKI_OBJ_S *pstObject,
 * const X509_CERT_S *pstCert,
 ...
 * 	- Only basic validation is done to construct the certificate chain.
 */
PSELINKDLL SEC_INT SEC_PKI_objGetLocalCertChainByCert(const SEC_PKI_OBJ_S *pstObject, X509_CERT_S *pstCert,
    SEC_List_S **dpOutCertChain);
 ...
 * in the trust store.
 */
PSELINKDLL SEC_INT SEC_PKI_objGetAllCertChainByCAPubKeyHash(const SEC_PKI_OBJ_S *pstObject, SEC_UINT uAlgType,
    const SEC_CHAR *pcHash, SEC_UINT ulen, SEC_List_S **pOutCertList);
 ...
 * in the trust store.
 */
PSELINKDLL SEC_INT SEC_PKI_objGetAllCertChainByCASubName(const SEC_PKI_OBJ_S *pstObject, SEC_CHAR *pcSubName,
    SEC_UINT len, SEC_List_S **pOutCertList);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objGetPvtKeyByCert(const SEC_PKI_OBJ_S *pstObject,
 * X509_CERT_S *pstCert,
 ...
 *
 * @par Description
 * SEC_PKI_objGetPvtKeyByCert function returns private key corresponding to the
 ...
 *
 */
PSELINKDLL SEC_INT SEC_PKI_objGetPvtKeyByCert(const SEC_PKI_OBJ_S *pstObject, X509_CERT_S *pstCert,
 ...
 * - SEC_PKI_X509_CHECK_CERT_KEYUSAGE 作为校验证书keyUsage的总开关
 * 国密双证书中，校验签名证书的keyUsage，verifyType仅传入SEC_PKI_X509_CHECK_CERT_KEYUSAGE
 * 国密双证书中，校验加密证书的keyUsage，verifyType需同时传入SEC_PKI_X509_CHECK_CERT_KEYUSAGE和
 * SEC_PKI_X509_CHECK_CERT_KEY_ENCIPHER_KEYUSAGE
 * 国密双证书中，签名证书和加密证书是同一本证书的场景暂不支持
 ...
 */
PSELINKDLL SEC_INT SEC_PKI_objValidateCertChain(SEC_PKI_OBJ_S *pstObject, SEC_List_S *pCertList, SEC_UINT verifyType);

#ifndef __SEC_PKI_NO_OCSP__
/**
 * @defgroup SEC_PKI_objValidateCertChainInCrlAndOcsp
 * @ingroup Object_Functions
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objValidateCertChainInCrlAndOcsp(SEC_PKI_OBJ_S *pstObject, SEC_List_S *pCertList,
 *  SEC_UINT verifyType, SEC_List_S *pstBasicRespList);
 * @endcode
 *
 * @par Purpose
 * This function is used to validate the input cert chain based on the verify
 ...
 * pCertList is a list which holds elements of type X509_CERT_S[NA/NA]
 * @param[in] verifyType Type of validation[NA/NA]
 * @param[in] pstBasicRespList ocsp response list[NA/NA]
 * @param[out] NA NA [NA/NA]
 *
 * @retval SEC_INT On successful execution. [SEC_PKI_SUCCESS|NA]
 * @retval SEC_INT On all failure conditions. [SEC_PKI_ERROR|NA]
 ...
 * - If SEC_PKI_OBJ_CRL_SUPPORT type is set, then the object inband CRLs
 * will be given first priority for all CRL processing.
 * - SEC_PKI_CHECK_OCSP 作为 OCSP校验的总开关
 * - 设置 SEC_PKI_CHECK_OCSP 则开启OCSP校验，且只校验证书链末端的证书
 * - 设置 (SEC_PKI_CHECK_OCSP 和 SEC_PKI_CHECK_OCSP_ALL), 校验整个证书链，整个证书链指的是pCertList组链后的证书链，
 *   证书链除了pCertList携带的证书，还有添加在其后的各级证书，该功能开启需确保整个证书链都有对应ocsp response
 * - 设置 (SEC_PKI_CHECK_OCSP 和 SEC_PKI_CHECK_CRL 和 SEC_PKI_OCSP_RESPONDER_CHECK_CRL) 开启response的签名者证书的CRL校验，
 *   该场景是指response的签名者证书携带了id-kp-OCSPSigning扩展授权，该签名者证书和待校验证书都是同1个CA签发
 * - 设置 (SEC_PKI_CHECK_OCSP | SEC_PKI_CHECK_CRL |SEC_PKI_OCSP_RESPONDER_CHECK_CRL | SEC_PKI_CHECK_DELTA_CRL
 *   SEC_PKI_OCSP_RESPONDER_CHECK_DELTA_CRL) 进行增量CRL校验response签名者证书
 * - 进行OCSP校验，若是不通过 SEC_PKI_objSetVerifyForCrlAndOcsp 注册回调，则代表使用者不干预PSE组件的错误处理，
 *   否则需要通过 SEC_PKI_objSetVerifyForCrlAndOcsp 注册回调函数
 * - RFC6960 4.2.2章节描述的3种response签名者第1种匹配本地配置OCSP响应签名证书功能未实现，协议描述如下
 *   Matches a local configuration of OCSP signing authority for the certificate in question
 * - 若开启 SEC_PKI_OCSP_RESPONDER_CHECK_CRL 或者 SEC_PKI_OCSP_RESPONDER_CHECK_DELTA_CRL校验时，在进行OCSP response签名者
 *   证书的CRL校验，CRL校验过程中的回调的参数pstCrlStoreCtx或者pstOcspStoreCtx是新创建的和原来不同，若是校验失败，
 *   此时需要进行回调通知，因CRL校验结束了，此时回调上报的pstCrlStoreCtx或者pstOcspStoreCtx又是原来的store了。
 * - SEC_PKI_X509_CHECK_CERT_KEYUSAGE 作为校验证书keyUsage的总开关
 *   国密双证书中，校验签名证书的keyUsage，verifyType仅传入SEC_PKI_X509_CHECK_CERT_KEYUSAGE
 *   国密双证书中，校验加密证书的keyUsage，verifyType需同时传入SEC_PKI_X509_CHECK_CERT_KEYUSAGE和
 *   SEC_PKI_X509_CHECK_CERT_KEY_ENCIPHER_KEYUSAGE
 ...
 * 	- SEC_PKI_objSetVerifyDepth should be called for setting depth
 * otherwise the depth value of zero will be considered.
 * 	- Once SEC_PKI_objValidateCertChainInCrlAndOcsp successful,
 * first cert from the list(pCertList) will be stored as
 * peer cert in use.
 * 	- If SEC_PKI_objValidateCertChainInCrlAndOcsp fails,peer cert in use
 * should not be overwritten.
 *
 * @par Related Topics
 * SEC_PKI_ctxResizePeerCache\n
 ...
 *     不耗时
 */
PSELINKDLL SEC_INT SEC_PKI_objValidateCertChainInCrlAndOcsp(SEC_PKI_OBJ_S *pstObject, SEC_List_S *pCertList,
    SEC_UINT verifyType, SEC_List_S *pstBasicRespList);
#endif
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objGetPeerCertInUse (const SEC_PKI_OBJ_S *pstObject,
 * X509_CERT_S **pstCert);
 * @endcode
 * @par Purpose
 ...
 *
 * @par Description
 * SEC_PKI_objGetPeerCertInUse function returns the peer certificate which is
 ...
 */
PSELINKDLL SEC_INT SEC_PKI_objGetPeerCertInUse(const SEC_PKI_OBJ_S *pstObject, X509_CERT_S **pstCert);
 ...
 *
 * @par Description
 * SEC_PKI_verifyResultDescString function returns
 ...
 */
PSELINKDLL const SEC_CHAR *SEC_PKI_verifyResultDescString(SEC_INT32 iValue);
 ...
 * This is not a thread safe API. It should be called during the init of
 * application.
 ...
 *
 */
PSELINKDLL SEC_VOID SEC_PKI_setCAKeyUsageMandatoryCheck(SEC_INT iEnable);

#ifndef __IPSI_PKI_NO_KEYCHECK_FOR_V1CERT__

/**
 * @defgroup SEC_PKI_EnableKeyUsageCheckForV1Cert
 * @ingroup Object_Functions
 * @par Prototype
 * @code
 * SEC_VOID SEC_PKI_EnableKeyUsageCheckForV1Cert(
 * SEC_INT iEnable)
 * @endcode
 *
 * @par Purpose
 * This is used to enable the key usage extension check when v1 certificates are used.
 * This API can be used to reject the V1 certificate by enabling the the key usage extension
 * check (SEC_PKI_EnableKeyUsageCheckForV1Cert) unless application has not disable the
 * key usage extension check using SEC_PKI_setCAKeyUsageMandatoryCheck
 *
 *
 * @par Description
 * SEC_PKI_EnableKeyUsageCheckForV1Cert function sets or resets
 * the key usage extension checking for a V1 certificate. By default the check will be disabled.
 * This is not thread safe API. It should be called at the start as part of init.
 *
 * @param[in] iEnable 1 is passed to enable the check and
 * 0 to disable the check. [0-1/NA]
 * @param[out] NA NA [NA/NA]
 ...
 *
 */
PSELINKDLL SEC_VOID SEC_PKI_EnableKeyUsageCheckForV1Cert(SEC_INT iEnable);

#endif // __IPSI_PKI_NO_KEYCHECK_FOR_V1CERT__
 ...
 * The default is disabled. This is a configuration API.
 * This is not a thread safe API. It should be called at the start as part of init.
 *
 * @par Related Topics
...
*     SEC_INT (*pfCallback)(SEC_INT iVerifyResult, SEC_VOID *pstStoreCtx, SEC_VOID *pAppData), SEC_VOID *pAppData)
* @endcode
*
* @par Purpose
...
#ifndef __SEC_PKI_NO_OCSP__
/**
* @defgroup SEC_PKI_objSetVerifyForCrlAndOcsp
* @ingroup Object_Functions
* @par Prototype
* @code
* SEC_INT SEC_PKI_objSetVerifyForCrlAndOcsp(SEC_PKI_OBJ_S *pstObject,
*    SEC_INT (*pfCallback)(SEC_INT iVerifyResult, SEC_INT iVerifyType,
*    SEC_VOID *pstCrlStoreCtx, SEC_VOID *pstOcspStoreCtx, SEC_VOID *pAppData),
*    SEC_VOID *pAppData);
* @endcode
*
* @par Purpose
...
*
* @par Description
* SEC_PKI_objSetVerifyForCrlAndOcsp 设置错误回调函数

* @param[in,out] pstObject 指向 SEC_PKI_OBJ_S. [NA/NA]
* @param[in] pfCallback 回调函数，在校验COSP或者CRL期间进行上报通知. [NA/NA]
* @param[in] pAppData 应用程序数据. [NA/NA]
* @param[out] NA NA [NA/NA]
*
* @retval [SEC_PKI_SUCCESS|NA]
* @retval [SEC_PKI_ERROR|NA]
* @par Note
* \n
* - pfCallback回调有如下参数：
* iVerifyResult：SEC_PKI_CB_ERROR | SEC_PKI_CB_SUCCESS
* iVerifyType：产品设置的校验类型，只表示校验产品会做哪些校验，和pstCrlStoreCtx以及pstOcspStoreCtx没有强关联关系，
               所以当类型为SEC_PKI_CHECK_OCSP时，pstOcspStoreCtx可能为NULL，但pstOcspStoreCtx不为NULL
*              类型有 SEC_PKI_CHECK_OCSP | SEC_PKI_CHECK_CRL | (SEC_PKI_CHECK_OCSP | SEC_PKI_CHECK_CRL) | 0
* pstCrlStoreCtx: CRL的CTX 或 基础部分校验的CTX
* pstOcspStoreCtx: OCSP的CTX
* 若iVerifyType为0，表示只对证书链本身就行了校验，未进行OCSP和CRL的校验
* 若iVerifyType为SEC_PKI_CHECK_OCSP，表示OCSP校验
* 若iVerifyType为SEC_PKI_CHECK_CRL，表示CRL校验
* 若iVerifyType为(SEC_PKI_CHECK_OCSP | SEC_PKI_CHECK_CRL)，则表示CRL和OCSP都校验，上报通知逻辑逻辑如下
*     1.CRL校验上报
*     2.OCSP校验上报
*     3.若是CRL和OCSP有任一种校验失败，那么会在再次进行回调通知，此时pstCrlStoreCtx和pstOcspStoreCtx都不为NULL，使用者可以通过
*     SEC_PKI_X509_storeCtxGetError获取各自的错误码，若是成功的则错误码为 SEC_PKI_SUCCESS, 否则有对应错误码。
*     注意当iVerifyType类型为(SEC_PKI_CHECK_OCSP | SEC_PKI_CHECK_CRL)时，若是出现OCSP和CRL校验都失败了进行上报时，
*     若是使用者调用SEC_PKI_X509_storeCtxSetAppError设置错误码，需要将错误码设置到 pstCrlStoreCtx 中
* pAppData： 指向程序数据
* - 回调函数中可用如下API:\n
*   - SEC_PKI_X509_storeCtxGetError\n
*   - SEC_PKI_X509_storeCtxGetErrorDepth\n
 ...
 *     不耗时
*/
PSELINKDLL SEC_INT SEC_PKI_objSetVerifyForCrlAndOcsp(SEC_PKI_OBJ_S *pstObject,
    SEC_INT (*pfCallback)(SEC_INT iVerifyResult, SEC_INT iVerifyType,
    SEC_VOID *pstCrlStoreCtx, SEC_VOID *pstOcspStoreCtx, SEC_VOID *pAppData),
    SEC_VOID *pAppData);
#endif
 ...
 * SEC_PKI_X509_storeCtxGetError
 */
PSELINKDLL SEC_INT SEC_PKI_X509_storeCtxGetErrorDepth(SEC_VOID *pstStoreCtx);
 ...
 * SEC_PKI_X509_storeCtxGetErrorDepth
 */
PSELINKDLL SEC_INT SEC_PKI_X509_storeCtxGetCrossCaPos(SEC_VOID *pstStoreCtx);
...
*
* @par Description
* SEC_PKI_X509_storeCtxGetCurrentCert function returns the current
...
*/
PSELINKDLL
SEC_PKI_X509_CERT_EXTENDED_S *SEC_PKI_X509_storeCtxGetCurrentCert(SEC_VOID *pstStoreCtx);
 ...
 *
 * @par Description
 * SEC_PKI_X509_storeCtxGetCurrentBaseCRL function returns the
 ...
 *
 */
PSELINKDLL SEC_INT SEC_PKI_objSetlocalCertInUse(SEC_PKI_OBJ_S *pstObject, X509_CERT_S *pstCert);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objGetlocalCertInUse(const SEC_PKI_OBJ_S *pstObject,
 * X509_CERT_S **pstCert)
 * @endcode
 * @par Purpose
 * This function returns the certificate which is currently in use.
 *
 * @par Description
 * SEC_PKI_objGetlocalCertInUse returns the certificate which is currently in use.
 ...
 *
 */
PSELINKDLL SEC_INT SEC_PKI_objGetlocalCertInUse(const SEC_PKI_OBJ_S *pstObject, X509_CERT_S **pstCert);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objRemoveLocalCert(const SEC_PKI_OBJ_S *pstObject,
 ...
 *
 */
PSELINKDLL SEC_INT SEC_PKI_objRemoveLocalCert(const SEC_PKI_OBJ_S *pstObject, SEC_NAME_S *pstIssuerName,
    SEC_BIGINT_S *pstSerialNum);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objRemovePreSharedPeerCert(const SEC_PKI_OBJ_S *pstObject,
 * SEC_NAME_S *pstIssuerName,
 * SEC_BIGINT_S *pstSerialNum)
 * @endcode
 *
 ...
 *
 */
PSELINKDLL SEC_INT SEC_PKI_objRemovePreSharedPeerCert(const SEC_PKI_OBJ_S *pstObject, SEC_NAME_S *pstIssuerName,
    SEC_BIGINT_S *pstSerialNum);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objRemoveDefaultCert(const SEC_PKI_OBJ_S *pstObject)
 * @endcode
 *
 * @par Purpose
 ...
 *
 */
PSELINKDLL SEC_INT SEC_PKI_objRemoveDefaultCert(const SEC_PKI_OBJ_S *pstObject);
 ...
 *
 */
PSELINKDLL SEC_INT SEC_PKI_objGetCtxPeerCertByHash(const SEC_PKI_OBJ_S *pstObject, SEC_UINT uAlgType,
    const SEC_UCHAR *pucHash, SEC_UINT len, X509_CERT_S **pstCert);
...
*        then need to call API IPSI_setPemMaxSize.
*/
PSELINKDLL SEC_INT SEC_PKI_objLoadPreSharedPeerCertFile(SEC_PKI_OBJ_S *pstObject, const SEC_CHAR *pcCertFile,
 ...
 * then need to call API IPSI_setPemMaxSize.
 */
PSELINKDLL SEC_INT SEC_PKI_objLoadPreSharedPeerCertBuffer(SEC_PKI_OBJ_S *pstObject, const SEC_CHAR *pcCertBuffer,
...
*        then need to call API IPSI_setPemMaxSize.
*/
PSELINKDLL SEC_INT SEC_PKI_objLoadDfltPreSharedPeerCertFile(SEC_PKI_OBJ_S *pstObject, const SEC_CHAR *pcCertFile,
 ...
 * then need to call API IPSI_setPemMaxSize.
 */
PSELINKDLL SEC_INT SEC_PKI_objLoadDfltPreSharedPeerCertBuffer(SEC_PKI_OBJ_S *pstObject, const SEC_CHAR *pcCertBuffer,
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objGetDfltPreSharedPeerCert(const SEC_PKI_OBJ_S *pstObject,
 * X509_CERT_S **pstCert)
 * @endcode
 * @par Purpose
 ...
 * application has to call the X509_freeCert.
 */
PSELINKDLL SEC_INT SEC_PKI_objGetDfltPreSharedPeerCert(const SEC_PKI_OBJ_S *pstObject, X509_CERT_S **pstCert);
...
*
*/
PSELINKDLL SEC_INT SEC_PKI_objGetPreSharedPeerCertByGenName(const SEC_PKI_OBJ_S *pstObject, SEC_GEN_NAME_S *pstGenName,
    X509_CERT_S **pstOutCert);
#endif
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objGetURLByCert(const SEC_PKI_OBJ_S *pstObject,
 * X509_CERT_S *pstCert,
 ...
 *
 * @par Description
 * SEC_PKI_objGetURLByCert function returns URL corresponding to the
 * input certificate from the local store.
 *
 * @param[in] pstObject Pointer to SEC_PKI_OBJ_S.[NA/NA]
 * @param[in] pstCert Input certificate.[NA/NA]
 ...
 *
 */
PSELINKDLL SEC_INT SEC_PKI_objGetURLByCert(const SEC_PKI_OBJ_S *pstObject, X509_CERT_S *pstCert,
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objGetAllCtxPeerCerts(
 * const SEC_PKI_OBJ_S *pstObject,SEC_List_S **dpOutCertList)
 * @endcode
 *
 * @par Purpose
 ...
 *
 */
PSELINKDLL SEC_INT SEC_PKI_objGetAllCtxPeerCerts(const SEC_PKI_OBJ_S *pstObject, SEC_List_S **dpOutCertList);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objGetAllPreSharedPeerCert(const SEC_PKI_OBJ_S *pstObject,
 * SEC_List_S **dpOutCertList)
 * @endcode
 *
 * @par Purpose
 ...
 *
 */
PSELINKDLL SEC_INT SEC_PKI_objGetAllPreSharedPeerCert(const SEC_PKI_OBJ_S *pstObject, SEC_List_S **dpOutCertList);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objRemoveDfltPreSharedPeerCert(const SEC_PKI_OBJ_S *pstObject)
 * @endcode
 *
 * @par Purpose
 ...
 *
 */
PSELINKDLL SEC_INT SEC_PKI_objRemoveDfltPreSharedPeerCert(const SEC_PKI_OBJ_S *pstObject);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objLoadCrlBuffer(const SEC_PKI_OBJ_S *pstObject,
 ...
 * then need to call API IPSI_setPemMaxSize.
 */
PSELINKDLL SEC_INT SEC_PKI_objLoadCrlBuffer(const SEC_PKI_OBJ_S *pstObject, SEC_CHAR *pcCrlBuffer, SEC_UINT ulCrlBufLen,
    SEC_INT iType);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objGetAllCRL(const SEC_PKI_OBJ_S *pstObject,
 ...
 *
 * @par Description
 * SEC_PKI_objGetAllCRL function returns all CRL from store.
 *
 * @param[in] pstObject Pointer to SEC_PKI_OBJ_S.[NA/NA]
 ...
 */
PSELINKDLL SEC_INT SEC_PKI_objGetAllCRL(const SEC_PKI_OBJ_S *pstObject, SEC_List_S **dpOutCRLList);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objRemoveCrl(const SEC_PKI_OBJ_S *pstObject,
 * SEC_NAME_S *pstIssuerName,
 ...
 */
PSELINKDLL SEC_INT SEC_PKI_objRemoveCrl(const SEC_PKI_OBJ_S *pstObject, SEC_NAME_S *pstIssuerName,
    SEC_BIGINT_S *pstExtnCRLNum);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objRemoveAllCrl(const SEC_PKI_OBJ_S *pstObject)
 * @endcode
 * @par Purpose
 ...
 * @retval SEC_INT On all failure conditions. [SEC_PKI_ERROR|NA]
 */
PSELINKDLL SEC_INT SEC_PKI_objRemoveAllCrl(const SEC_PKI_OBJ_S *pstObject);
...
* SEC_INT SEC_PKI_objGetLocalCertChainByGenName (
                          const SEC_PKI_OBJ_S *pstObject,
                                         const SEC_GEN_NAME_S  *pstGenName,
                                         SEC_List_S **dpOutCertChain);
* @endcode
*
* @par Purpose
...
*
*/
PSELINKDLL SEC_INT SEC_PKI_objGetLocalCertChainByGenName(const SEC_PKI_OBJ_S *pstObject,
    const SEC_GEN_NAME_S *pstGenName, SEC_List_S **dpOutCertChain);
...
*
* @par Description
* SEC_PKI_objGetCtxBaseCRLbyCert function returns the
...
*/
PSELINKDLL X509_CRL_S *SEC_PKI_objGetCtxBaseCRLbyCert(const SEC_PKI_OBJ_S *pstObject, X509_CERT_S *pstCert);
...
*
* @par Description
* SEC_PKI_objGetCtxDeltaCRLbyCert function returns the
...
*
*/
PSELINKDLL X509_CRL_S *SEC_PKI_objGetCtxDeltaCRLbyCert(const SEC_PKI_OBJ_S *pstObject, X509_CERT_S *pstCert);
...
*
* @par Description
* SEC_PKI_objGetBaseCRLbyCert function returns the
...
* Time, AKID, IDP Reasons, Direct/Indirect CRL, and Criticality extensions.
*/
PSELINKDLL X509_CRL_S *SEC_PKI_objGetBaseCRLbyCert(const SEC_PKI_OBJ_S *pstObject, X509_CERT_S *pstCert);
...
*
* @par Description
* SEC_PKI_objGetDeltaCRLbyCert function returns the
...
*
*/
PSELINKDLL X509_CRL_S *SEC_PKI_objGetDeltaCRLbyCert(const SEC_PKI_OBJ_S *pstObject, X509_CERT_S *pstCert);
 ...
 *
 */
PSELINKDLL SEC_INT SEC_PKI_objSetHandle(SEC_PKI_OBJ_S *pstObject, SEC_VOID *pHandle);
 ...
 * @par Prototype
 * @code
 * SEC_VOID * SEC_PKI_objGetHandle(const SEC_PKI_OBJ_S *pstObject)
 * @endcode
 * @par Purpose
 ...
 *
 */
PSELINKDLL SEC_VOID *SEC_PKI_objGetHandle(const SEC_PKI_OBJ_S *pstObject);
 ...
 */
PSELINKDLL SEC_INT SEC_PKI_objSetOptions(SEC_PKI_OBJ_S *pstObject, SEC_UINT uiOptions);
 ...
 */
PSELINKDLL SEC_INT SEC_PKI_objGetOptions(const SEC_PKI_OBJ_S *pstObject, SEC_UINT *puiOptions);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_PKI_objGetAppVerifyResult(const SEC_PKI_OBJ_S *pstObj, SEC_INT *piAppErr)
 * @endcode
 *
 * @par Purpose
 ...
 * SEC_PKI_objSetVerify
 */
PSELINKDLL SEC_INT SEC_PKI_objGetAppVerifyResult(const SEC_PKI_OBJ_S *pstObj, SEC_INT *piAppErr);

/**
 * @defgroup SEC_PKI_setLoadSameSubjNameCAConfig
 * @ingroup Object_Functions
 * @par Prototype
 * @code
 * SEC_VOID SEC_PKI_setLoadSameSubjNameCAConfig(SEC_PKI_LOAD_CA_CONIF_E eLoadCAConfig)
 * @endcode
 *
 * @par Purpose
 * This is used to enable or disable the loading of same subject name CA certificate in PKI context.
 *
 * @par Description
 * SEC_PKI_setLoadSameSubjNameCAConfig function is used to enable or disable loading of same subject name CA certificate
 * in PKI context. By default, library allow loading of same subject name CA certificate in PKI context
 *
 * @param[in] eLoadCAConfig SEC_PKI_ALLOW_LOAD_SAME_NAME_CA is passed to allow loading of same subject name CA and
 * SEC_PKI_DISABLE_LOAD_SAME_NAME_CA to disbale loading of same subject name CA. [0-1/NA]
 * @param[out] NA NA [NA/NA]
 *
 * @retval SEC_VOID This function does not return any value. [NA|NA]
 * @par Note
 * \n
 * - This API change the behavior of CA certificate loading API (SEC_PKI_ctxLoadTrustCACertificateBuffer and
 * SEC_PKI_ctxLoadTrustCACertificateFile).
 * - When application set SEC_PKI_DISABLE_LOAD_SAME_NAME_CA configuration, Loading CA API will check that CA certifcate
 * subject name and  SKID ( if present) is matchng with already loaded CA in PKI context .If any match found then CA
 * certificate will be ignored and continue to load other CA certificate
 * - This API configure global setting to PKI for that application. This API is not thread-safe API and must not use
 * in multiple thread
 * .
 * @par Related Topics
 * SEC_PKI_ctxLoadTrustCACertificateBuffer
 * SEC_PKI_ctxLoadTrustCACertificateFile
 */
PSELINKDLL SEC_VOID SEC_PKI_setLoadSameSubjNameCAConfig(SEC_PKI_LOAD_CA_CONIF_E eLoadCAConfig);

#ifndef __SEC_PKI_NO_OCSP__
/**
 * @defgroup SEC_PKI_objGetOcspInfoByCert
 * @ingroup Object_Functions
 * @par Prototype
 * @code
 * SEC_PKI_objGetOcspInfoByCert(
 * const SEC_PKI_OBJ_S *pstObject,
 * X509_CERT_S *pstCert,
 ...
 *
 * @par Description
 * SEC_PKI_objGetOcspInfoByCert is used to get ocsp response from the cache.
 *
 * @param[in] pstObject Pointer to SEC_PKI_OBJ_S.[NA/NA]
 * @param[in] pstCert Pointer to X509_CERT_S.[NA/NA]
 ...
 * To free this memory user has to call the OCSP_freeOCSPResp function.
 */
PSELINKDLL SEC_INT SEC_PKI_objGetOcspInfoByCert(
    const SEC_PKI_OBJ_S *pstObject, X509_CERT_S *pstCert, OCSP_RESP_S **ppOCSPResp);
