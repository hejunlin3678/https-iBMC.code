 ...
 * associated parameters) under which the message digest and associated information are encrypted with the signer's
 * private key.
 * @datastruct stEncryptedDigest encryptedDigest is the result of encrypting the message digest and associated
...
/* Signed data holds the Data ( present inside content info)  , signature ( part of signer info) , Certificates and
   CRL's to facilitate recipient to verify signature. The signed-data content type consists of content of any defined
   PKCS7 type and encrypted message digests of the content for zero or more signers. The encrypted digest for a signer
   is a "digital signature" on the content for that signer. Any type of content can be signed by any number of signers
   in parallel. Furthermore, the syntax has a degenerate case in which there are no signers on the content. The
   degenerate case provides a means for disseminating certificates and certificate-revocation lists.  */
/**
 ...
 * @datastruct pstDigestAlg digestAlgorithms is a group of message-digest algorithm identifiers. There may be any
 * number of elements in the group, including zero. Each element identifies the message-digest algorithm (and any
 ...
 * intended that the set be sufficient to contain chains from a recognized "root" or "top-level certification authority"
 * to all of the signers in the signerInfos field.
 * @datastruct pstCrls CRLs is a set of certificate-revocation lists. It is intended that the set contain
 * information sufficient to determine whether or not the certificates in the certificates field are "hot listed," but
 * such correspondence is not necessary.
 * @datastruct pstSignerInfos signerInfos is a group of per-signer information. It holds infor mation of Signers
 * Certificate Issuer , serial number and signature .There may be any number of elements in the group, including zero.
 */
typedef struct stPKCS7SignedData {
    SEC_AsnInt version;                   /* It shall be 1 for this version of the standard. */
    SEC_List_S *pstDigestAlg;             /* digestAlgorithms is a group of message-digest algorithm identifiers.
There may be any number of elements in the group, including zero. Each element identifies the message-digest
algorithm (and any associated parameters) under which the content is digested for a some signer.  */
    PKCS7_CONTENT_INFO_S *pstContentInfo; /* contentInfo is the content that is signed. It can have any of the PKCS#7
                                             data type */
...
correspondence is not necessary. */
    SEC_List_S *pstSignerInfos;  /* signerInfos is a group of per-signer information. It holds infor mation of Signers
                         Certificate Issuer , serial number and signature .There may be any number of
                         elements in the group, including zero. */
} PKCS7_SIGNED_S;
 ...
 * @datastruct pstRecipientInfos RecipientInfos is a group of per-recipient information.
...
/* The signed-and-enveloped-data content type is sequential combination of signed-data and
    ...
    of any defined PKCS7 type, encrypted content-encryption keys ( key used to encrypt content) for one or more
   recipients, and doubly encrypted message digests for one or more signers.
 ...
 *
 * @datastruct version It shall be 1 for this version of the standard.
 * @datastruct pstRecipientInfos recipientInfos is a group of per-recipient information. There must be at least one
 * element in the group. It holds encrypted content-encryption keys ( key used to encrypt content) encrypted with
 * recipients public key.
 * @datastruct pstDigestAlg DigestAlgorithms is a group of message-digest algorithm identifiers.
 * @datastruct pstEncryptedContentInfo pstEncryptedContentInfo is the encrypted content information.
 * It include information like type of Content encrypted , Algorithm used to encrypt and encrypted data.
 * @datastruct pstCertificates certificates is a set of PKCS #6 extended certificates OR X.509 certificates. It is
 * intended that the set be sufficient to contain chains from a recognized "root" or "top-level certification authority"
 ...
 * information sufficient to determine whether or not the certificates in the certificates field are "hot listed," but
 * such correspondence is not necessary.
 * @datastruct pstSignerInfos signerInfos is a group of per-signer information. It holds information of Signers
 * Certificate Issuer , serial number and signature .There may be any number of elements in the group, There must be at
 * least one element in the group.
 */
typedef struct stPKCS7SignedEnvelopedData {
    SEC_AsnInt version;                              /* It shall be 1 for this version of the standard */
    SEC_List_S *pstRecipientInfos;                   /* recipientInfos is a group of per-recipient
information. There must be at least one element in the group. It holds encrypted
content-encryption keys ( key used to encrypt content) encrypted with recipients public key */
    SEC_List_S *pstDigestAlg;                        /* DigestAlgorithms is a group of message-digest
algorithm identifiers */
    PKCS7_ENCRYPTED_INFO_S *pstEncryptedContentInfo; /* pstEncryptedContentInfo is the encrypted content information.
                                                        It include information like type of Content encrypted ,
                                                        Algorithm used to encrypt and encrypted data */
    SEC_List_S *pstCertificates; /* certificates is a set of PKCS #6 extended certificates OR X.509 certificates. It is
intended that the set be sufficient to contain chains from a recognized "root" or "top-level certification
...
correspondence is not necessary. */
    SEC_List_S *pstSignerInfos;  /* signerInfos is a group of per-signer information. It holds infor mation of Signers
              Certificate Issuer , serial number and signature .There may be any number of
              elements in the group, There must be at least one element in the group. */
} PKCS7_SIGN_ENVELOPED_S;
 ...
 * @datastruct pstContentInfo contentInfo is the content that is digested. It can have any of the PKCS7 defined content
 * types.
 ...
 *
 * @datastruct version It shall be 0 for this version of the standard.
 * @datastruct pstEncryptedContentInfo pstEncryptedContentInfo is the encrypted content information. It include
 * information like type of Content encrypted , Algorithm used to encrypt and encrypted data.
 */
typedef struct stPKCS7EncryptedData {
    SEC_AsnInt version;                              /* It shall be 0 for this version of the standard. */
    PKCS7_ENCRYPTED_INFO_S *pstEncryptedContentInfo; /* pstEncryptedContentInfo is the encrypted content information.
 ...
 * N/A
 */
PSELINKDLL PKCS7_MSG_S *PKCS7_createSimple(const SEC_UCHAR *pucContent, SEC_UINT32 uiContentLen);
 ...
 *
 */
PSELINKDLL PKCS7_MSG_S *PKCS7_createSigned(SEC_UINT32 uiVersion, const PKCS7_MSG_S *pstPKCS7);
 ...
 *
 */
PSELINKDLL PKCS7_MSG_S *PKCS7_createEnveloped(SEC_UINT32 uiVersion, SEC_UINT32 enCEAlgo, const PKCS7_MSG_S *pstPKCS7);
 ...
 *
 */
PSELINKDLL PKCS7_MSG_S *PKCS7_createSignedAndEnveloped(SEC_UINT32 uiVersion, SEC_UINT32 uiCEAlgo,
    const PKCS7_MSG_S *pstPKCS7);
 ...
 *
 */
PSELINKDLL PKCS7_MSG_S *PKCS7_createDigested(SEC_UINT32 uiVersion, SEC_UINT32 uiDigestAlgo,
    const PKCS7_MSG_S *pstPKCS7);
 ...
 *
 */
PSELINKDLL PKCS7_MSG_S *PKCS7_createEncrypted(SEC_UINT32 uiVersion, SEC_UCHAR *pucCEKey, SEC_UINT32 uiCEKeyLength,
    SEC_UINT32 enCEAlgo, const PKCS7_MSG_S *pstPKCS7);
 ...
 *
 * @par Description
 * This function creates signer info which consists of information about the Signer like serial number, issuer name of
 * the Signer certificate. Issuer and serialnumber inputs should be of the signer certificate. There are 2 Optional
 * steps to complete Signer info creation ( These two steps only for the signer info of the Signed data)\n
 * 1. Add Authenticated attributes (PKCS7_addAuthAttrToSignerInfo()). Authenticated by the signer, Sign is calculated
 * over these attributes if exists. If there are Authenticated attributes there should be 2 mandatory attributes
 ...
 * N/A
 */
PSELINKDLL PKCS7_SIGNER_INFO_S *PKCS7_createSignerInfo(SEC_UINT32 uiVersion, SEC_UINT32 uiDigestAlgo,
    SEC_UINT32 uiDigEncryAlgo, SEC_NAME_S *pstIssuer, const SEC_BIGINT_S *SN);
 ...
 *
 * @par Description
 * This function adds signer's info to the PKCS7 signed data OR Signed Enveloped data structure. Calculates signature
 * over the content Or authenticated attributes and saves signature value in signers info. Adds the digest algorithm to
 * Signed data digest algorithm list.
 *
 ...
 *
 * @retval SEC_UINT32 Successful addition of signer Info to signed data OR Signed Enveloped data structure.
 * [SEC_SUCCESS|N/A]
 * @retval SEC_UINT32 One of the input parameter is invalid like input parameters may be NULL, inappropriate PKCS7 data
 * type (Other than Signed and signed enveloped data ) OR Structure explicitly modified by user / corrupted.
 * [SEC_ERR_INVALID_ARG|N/A]
 * @retval SEC_UINT32 Dup Signer info failed due to corrupted Signer info OR memory allocation failure.
 * [SEC_ERR_DATA_COPY_FAILED|N/A]
 * @retval SEC_UINT32 Private key type is invalid, algorithm type mismatch with signer info uiDigEncryAlgo type.
 * [SEC_CRYPT_ERR_INVALID_PKEY_TYPE|N/A]
 * @retval SEC_UINT32 Memory allocation failed. [SEC_ERR_MALLOC_FAIL|N/A]
 * @retval SEC_UINT32 Authenticated attributes are present, but One OR both of the mandatory attributes are missing.
 ...
 * @retval SEC_UINT32 Digest algorithm specified in signer info is invalid, Corrupted  after signer info creation.
 * [SEC_ERR_INVALID_ALGID|N/A]
 * @retval SEC_UINT32 One of the mandatory field is NULL like PKCS7_ENCRYPTED_INFO_S field may be NULL in signed
 * enveloped data. [SEC_ERR_NULL_PTR|N/A]
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 PKCS7_addSignerInfo(PKCS7_SIGNER_INFO_S *pstSignerInfoin, SEC_PKEY_S *pstPrivKey,
    const PKCS7_MSG_S *pstPKCS7);
 ...
 *
 * @param[in] pstX509 Certificate to be added. It's either Certificate of the signer OR certificate in the path of
 * trusted CA ( certification authority). [N/A]
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 PKCS7_addCert(X509_CERT_S *pstX509, const PKCS7_MSG_S *pstPKCS7);
 ...
 *
 * @par Description
 * This function adds CRLs to signed data so the intended receiver of the message can know about the revoked
 * certificates even if he does not have the latest CRL's.
 *
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 PKCS7_addCrl(X509_CRL_S *pstCrlin, const PKCS7_MSG_S *pstPKCS7);
...
* N/A
*/
PSELINKDLL SEC_UINT32 PKCS7_addAuthAttrToSignerInfo(SEC_UINT32 enAttrType, SEC_VOID *pAttributeValue,
    PKCS7_SIGNER_INFO_S *pstSignerInfo);
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 PKCS7_addUnauthAttrToSignerInfo(SEC_UINT32 enAttrType, SEC_VOID *pAttributeValue,
    PKCS7_SIGNER_INFO_S *pstSignerInfo);
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 PKCS7_addRecipient(SEC_UINT32 uiVersion, X509_CERT_S *pstX509, const PKCS7_MSG_S *pstPKCS7);
 ...
 * @par Prototype
 * @code
 * SEC_INT32 PKCS7_getContentType (const PKCS7_MSG_S* pstPKCS7);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * This function returns type of the PKCS7 data	from PKCS7_MSG_S structure.
 *
 ...
 * N/A
 */
PSELINKDLL SEC_INT32 PKCS7_getContentType(const PKCS7_MSG_S *pstPKCS7);
 ...
 * @par Prototype
 * @code
 * SEC_List_S*    PKCS7_getRecipInfoList(const PKCS7_MSG_S* pstPKCS7 )
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns Recipient Infolist either from the Enveloped data OR Signed Enveloped data.
 *
 ...
 * N/A
 */
PSELINKDLL SEC_List_S *PKCS7_getRecipInfoList(const PKCS7_MSG_S *pstPKCS7);
 ...
 * @par Prototype
 * @code
 * SEC_List_S* PKCS7_getSignerInfoList(const PKCS7_MSG_S* pstPKCS7 )
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns Signer Infolist either from the Signed data OR Signed Enveloped data.
 *
 ...
 * N/A
 */
PSELINKDLL SEC_List_S *PKCS7_getSignerInfoList(const PKCS7_MSG_S *pstPKCS7);
 ...
 * @par Prototype
 * @code
 * SEC_List_S*  PKCS7_extractCertList(const PKCS7_MSG_S* pstPKCS7)
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_List_S *PKCS7_extractCertList(const PKCS7_MSG_S *pstPKCS7);
 ...
 * @par Prototype
 * @code
 * SEC_List_S*  PKCS7_getCrlList (const PKCS7_MSG_S* pstPKCS7);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns CRL list from the Signed data OR Signed Enveloped data.
 *
 * @param[in] pstPKCS7 PKCS7 message of Sigened data OR Signed Enveloped data. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL SEC_List_S *PKCS7_getCrlList(const PKCS7_MSG_S *pstPKCS7);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32  PKCS7_getVersion (const PKCS7_MSG_S* pPKCS7);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns version from the Any of the PKCS7 Data type.
 *
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 PKCS7_getVersion(const PKCS7_MSG_S *pstPKCS7);
 ...
 * @par Prototype
 * @code
 * SEC_List_S* PKCS7_getUnAuthAttrList(const PKCS7_SIGNER_INFO_S* pstSignerInfo)
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns UnAuthenticated attribute list from the Signer Info.
 *
 ...
 * N/A
 */
PSELINKDLL SEC_List_S *PKCS7_getUnAuthAttrList(const PKCS7_SIGNER_INFO_S *pstSignerInfo);
 ...
 * @par Prototype
 * @code
 * SEC_List_S* PKCS7_getAuthAttrList (const PKCS7_SIGNER_INFO_S* pstSignerInfo);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns Authenticated attrib list from the Signer Info.
 *
 * @param[in] pstSignerInfo Signer info data structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL SEC_List_S *PKCS7_getAuthAttrList(const PKCS7_SIGNER_INFO_S *pstSignerInfo);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32  PKCS7_getSignerVersion (const PKCS7_SIGNER_INFO_S* pstSignerInfo);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns version from the Signer Info.
 *
 * @param[in] pstSignerInfo Signer Info Structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 PKCS7_getSignerVersion(const PKCS7_SIGNER_INFO_S *pstSignerInfo);
 ...
 * @par Prototype
 * @code
 * SEC_ISSUER_AND_SERIAL_S* PKCS7_getIssuerAndSNFromSigner (const PKCS7_SIGNER_INFO_S* pstSignerInfo);
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_ISSUER_AND_SERIAL_S *PKCS7_getIssuerAndSNFromSigner(const PKCS7_SIGNER_INFO_S *pstSignerInfo);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32  PKCS7_getRecipVersion (const PKCS7_RECIPIENT_S* pstRecipInfo);
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns version from the Recipient Info.
 *
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 PKCS7_getRecipVersion(const PKCS7_RECIPIENT_S *pstRecipInfo);
 ...
 * @par Prototype
 * @code
 * SEC_ISSUER_AND_SERIAL_S* PKCS7_getIssuerAndSNFromRecip (const PKCS7_RECIPIENT_S* pstRecipientInfo );
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @retval SEC_ISSUER_AND_SERIAL_S* Issuer And Serialnumber structure. [SEC_ISSUER_AND_SERIAL_S*|N/A]
 * @retval SEC_ISSUER_AND_SERIAL_S* Recipient info OR Issuer and serial number of Recipient info may be NULL.
 * [SEC_NULL|N/A]
 *
 * @par Dependency
 * pkcs7.h
 ...
 * N/A
 */
PSELINKDLL SEC_ISSUER_AND_SERIAL_S *PKCS7_getIssuerAndSNFromRecip(const PKCS7_RECIPIENT_S *pstRecipientInfo);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32  PKCS7_verifySignature (const PKCS7_MSG_S*  pstPKCS7,
 * SEC_List_S*  pCertList,
 * SEC_NAME_S* pstSignerIssuer ,
 * const SEC_BIGINT_S*  pstSignerSN,
 * SEC_NAME_S* pstRecipIssuer ,
 * const SEC_BIGINT_S*  pstRecipSN,
 ...
 * @retval SEC_UINT32 Encode failed may be because of Invalid Signed OR signed enveloped data.
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 PKCS7_verifySignature(const PKCS7_MSG_S *pstPKCS7, SEC_List_S *pCertList,
    SEC_NAME_S *pstSignerIssuer, const SEC_BIGINT_S *pstSignerSN, SEC_NAME_S *pstRecipIssuer,
    const SEC_BIGINT_S *pstRecipSN, SEC_PKEY_S *pstPrivKeyInfo);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32  PKCS7_verifyAllSignature (const PKCS7_MSG_S*  pstPKCS7,
 * SEC_List_S*  pCertList,
 * SEC_NAME_S* pstRecipIssuer ,
 * const SEC_BIGINT_S*  pstRecipSN,
 * const SEC_PKEY_S* pstPrivKeyInfo
 * );
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 PKCS7_verifyAllSignature(const PKCS7_MSG_S *pstPKCS7, SEC_List_S *pCertList,
    SEC_NAME_S *pstRecipIssuer, const SEC_BIGINT_S *pstRecipSN, const SEC_PKEY_S *pstPrivKeyInfo);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32  PKCS7_verifyDigest (const PKCS7_MSG_S*  pstPKCS7);
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 PKCS7_verifyDigest(const PKCS7_MSG_S *pstPKCS7);
 ...
 * N/A
 */
PSELINKDLL PKCS7_MSG_S *PKCS7_decodePKCS7Msg(SEC_UCHAR *pucPKCS7Msg, SEC_UINT32 uiMsgLen, SEC_UINT32 *puiDecLen);
 ...
 * @param[in] ulPBEAlgo Algorithm used to encrypt the content. It should be a password based algorithm defined in
 * PKCS#5. [N/A]
 ...
 * N/A
 */
PSELINKDLL PKCS7_MSG_S *PKCS7_createPBEncrypted(SEC_UINT32 uiVersion, SEC_UCHAR *ulPassWrd, SEC_UINT32 pucPassLen,
    SEC_UINT32 uiPBEAlgo, const PKCS7_MSG_S *pstPKCS7);
 ...
 * @par Prototype
 * @code
 * PKCS7_MSG_S*  PKCS7_decryptPBEncrypted(	const PKCS7_MSG_S*  pstPKCS7,
 ...
 * N/A
 */
PSELINKDLL PKCS7_MSG_S *PKCS7_decryptPBEncrypted(const PKCS7_MSG_S *pstPKCS7, SEC_UCHAR *pucPassWrd,
    SEC_UINT32 ulPassLen);
 ...
 * @par Prototype
 * @code
 * PKCS7_MSG_S*  PKCS7_decryptEncrypted (const PKCS7_MSG_S*  pstPKCS7,
 ...
 * N/A
 */
PSELINKDLL PKCS7_MSG_S *PKCS7_decryptEncrypted(const PKCS7_MSG_S *pstPKCS7, const SEC_UCHAR *pucCEKey,
    SEC_UINT32 uiCEKeyLen);
 ...
 * @par Prototype
 * @code
 * PKCS7_MSG_S* PKCS7_openEnveloped (const PKCS7_MSG_S*  pstPKCS7,
 * SEC_PKEY_S*  pstPrivKeyInfo,
 * SEC_NAME_S* pstIssuer ,
 * const SEC_BIGINT_S*  pstSN );
 * @endcode
 ...
 * N/A
 */
PSELINKDLL PKCS7_MSG_S *PKCS7_openEnveloped(const PKCS7_MSG_S *pstPKCS7, SEC_PKEY_S *pstPrivKey, SEC_NAME_S *pstIssuer,
    const SEC_BIGINT_S *SN);
 ...
 * @par Prototype
 * @code
 * SEC_AsnOcts_S* PKCS7_getDataFromSimpleData(const PKCS7_MSG_S* pstPKCS7)
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * This function returns the pointer to the octs of the simple data if it is a simple data.
 *
 ...
 * N/A
 */
PSELINKDLL SEC_AsnOcts_S *PKCS7_getDataFromSimpleData(const PKCS7_MSG_S *pstPKCS7);
 ...
 * @par Prototype
 * @code
 * PKCS7_MSG_S* PKCS7_extractContentFromPKCS7Msg(const PKCS7_MSG_S* pstPKCS7)
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL PKCS7_MSG_S *PKCS7_extractContentFromPKCS7Msg(const PKCS7_MSG_S *pstPKCS7);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32 PKCS7_getDigestAlgFromSignerInfo(const PKCS7_SIGNER_INFO_S* pstSignerInfo)
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * This function returns digest algorithm from the signer info structure which is extracted either from Signed OR Signed
 * enveloped data.
 *
 * @param[in] pstSignerInfo Signer info structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval SEC_UINT32 CID of the digest algorithm identifier is returned on success. [CID of the digest algorithm
 * identifier|N/A]
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 PKCS7_getDigestAlgFromSignerInfo(const PKCS7_SIGNER_INFO_S *pstSignerInfo);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32 PKCS7_getDigestEncAlgFromSignerInfo(const PKCS7_SIGNER_INFO_S* pstSignerInfo)
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * This function returns digest encryption algorithm from the signer info structure which is extracted either from
 * Signed OR Signed enveloped data. How to get signer info? Get the Signer info list using PKCS7_getSignerInfoList and
 * then get signer info using list functions (sec_list.h).
 *
 * @param[in] pstSignerInfo Signer info structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 PKCS7_getDigestEncAlgFromSignerInfo(const PKCS7_SIGNER_INFO_S *pstSignerInfo);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32 PKCS7_getKeyEncAlgFromRecipInfo(const PKCS7_RECIPIENT_S* pstRecipInfo)
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * This function returns KEY encryption algorithm from the Recipient info structure which is extracted either from
 * Enveloped OR Signed enveloped data. How to get Recipient info? Get the Recipient info list using
 * PKCS7_getRecipInfoList and then get Recipient info using list functions (sec_list.h).
 *
 * @param[in] pstRecipInfo Recipient info structure. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 PKCS7_getKeyEncAlgFromRecipInfo(const PKCS7_RECIPIENT_S *pstRecipInfo);
 ...
 * N/A
 */
PSELINKDLL PKCS7_SIGNED_S *PKCS7_decodeSigned(SEC_UCHAR *pucPKCS7Msg, SEC_UINT32 uiMsgLen, SEC_UINT32 *puiDecLen);
 ...
 * N/A
 */
PSELINKDLL PKCS7_ENVELOPED_S *PKCS7_decodeEnveloped(SEC_UCHAR *pucPKCS7Msg, SEC_UINT32 uiMsgLen, SEC_UINT32 *puiDecLen);
 ...
 * N/A
 */
PSELINKDLL PKCS7_SIGN_ENVELOPED_S *PKCS7_decodeSignEnveloped(SEC_UCHAR *pucSigEnvMsg, SEC_UINT32 uiMsgLen,
    SEC_UINT32 *puiDecLen);
 ...
 * N/A
 */
PSELINKDLL PKCS7_DIGESTED_S *PKCS7_decodeDigested(SEC_UCHAR *pucDigMsg, SEC_UINT32 uiMsgLen, SEC_UINT32 *puiDecLen);
 ...
 * N/A
 */
PSELINKDLL PKCS7_ENCRYPTED_S *PKCS7_decodeEncrypted(SEC_UCHAR *pucEncMsg, SEC_UINT32 uiMsgLen, SEC_UINT32 *puiDecLen);
 ...
 * @par Prototype
 * @code
 * SEC_VOID* PKCS7_getContent(const PKCS7_MSG_S* pstPKCS7, SEC_UINT32* puiContentType )
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * Returns specific data from the PKCS7 message depends on the type the data.
 *
 ...
 * N/A
 */
PSELINKDLL SEC_VOID *PKCS7_getContent(const PKCS7_MSG_S *pstPKCS7, SEC_UINT32 *puiContentType);
 ...
 * @par Prototype
 * @code
 * PKCS7_MSG_S* PKCS7_dupPKCS7Msg(const PKCS7_MSG_S* pstSrcP7)
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL PKCS7_MSG_S *PKCS7_dupPKCS7Msg(const PKCS7_MSG_S *pstSrcP7);
 ...
 * @par Prototype
 * @code
 * SEC_VOID PKCS7_freeEncryptedData(PKCS7_ENCRYPTED_S *pstEncryData)
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @param[in] pstEncryData Encrypted data. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval SEC_VOID This function does not return any value. [N/A|N/A]
 *
 ...
 * N/A
 */
PSELINKDLL SEC_VOID PKCS7_freeEncryptedData(PKCS7_ENCRYPTED_S *pstEncryData);
 ...
 * @retval PKCS7_SIGNED_S* Failed to duplicate may be because of incomplete structure OR insufficient memory.
 * [SEC_NULL|N/A]
 *
 * @par Dependency
 * pkcs7.h
