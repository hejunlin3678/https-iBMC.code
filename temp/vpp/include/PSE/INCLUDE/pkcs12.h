 ...
 * Create: 2005-06-30
        ...
        1. Pwd Integrity Mode
           2. Public Key Integrity Mode
        It also allows user to change the Pwd Of the PFX File
*/
...
typedef enum enPKCS12_INTEGRITY_MODE {
    ...
    PKCS12_PASS_SIGN,                  /* for pwd Sign Mode */
...
typedef enum enPKCS12_PRIVACY_MODE {
    ...
    PKCS12_PASS_PRIVACY,            /* for pwd privacy Mode */
...
typedef struct stPKCS12_PFX {  /* SEQUENCE */
    ...
    PKCS12_MACDATA_S *macData; /* MacData OPTIONAL is used
                         for Pwd integrity verification */
} PKCS12_PFX_S;
...
* @par Prototype
* @code
* PKCS12_SAFEBAG_S * PKCS12_dataToSafeBag (const SEC_UCHAR* pucEncodedData,
                                             SEC_UINT32 uiLen);
* @endcode
*
* @par Purpose
...
*
*/
PSELINKDLL PKCS12_SAFEBAG_S *PKCS12_dataToSafeBag(const SEC_UCHAR *pucEncodedData, SEC_UINT32 uiLen);
...
* N/A
*/
PSELINKDLL SEC_UINT32 PKCS12_addAttrToSafeBag(PKCS12_SAFEBAG_S *pstSafeBag, SEC_ATTR_S *pstAttr);
...
SEC_UINT32 uiTypeAttr, const SEC_AsnOcts_S* pstValue)
* @endcode
*
* @par Purpose
...
*
*/
PSELINKDLL SEC_ATTR_S *PKCS12_createAttribute(SEC_UINT32 uiTypeAttr, const SEC_AsnOcts_S *pstValue);
...
const SEC_ATTR_S* pstAttr,SEC_UINT32* ulTypeAttr)
* @endcode
*
* @par Purpose
...
*
* @par Description
* This function returns attribute type and value from the SEC_ATTR_S.
...
* N/A
*/
PSELINKDLL SEC_AsnOcts_S *PKCS12_getAttributeVal(const SEC_ATTR_S *pstAttr, SEC_UINT32 *ulTypeAttr);
...
* @par Prototype
* @code
* SEC_ATTR_S* PKCS12_getAttrFromSafeBag(const PKCS12_SAFEBAG_S* pstSafeBag)
* @endcode
*
* @par Purpose
...
*
* @par Description
* This function returns the attribute from the Safe Bag. It gives
...
* N/A
*/
PSELINKDLL SEC_ATTR_S *PKCS12_getAttrFromSafeBag(const PKCS12_SAFEBAG_S *pstSafeBag);
...
const PKCS12_SAFEBAG_S* pstSafeBag,SEC_UINT32 ulIndex)
* @endcode
*
* @par Purpose
...
*
* @par Description
* This function returns the Attribute from the safe bag. It returns
...
* N/A
*/
PSELINKDLL SEC_ATTR_S *PKCS12_getAttrFromSafeBagByIndex(const PKCS12_SAFEBAG_S *pstSafeBag, SEC_UINT32 ulIndex);
...
* @par Prototype
* @code
* SEC_UINT32 PKCS12_getSafeBagType(const PKCS12_SAFEBAG_S* pstBag)
* @endcode
*
* @par Purpose
...
*
*/
PSELINKDLL SEC_UINT32 PKCS12_getSafeBagType(const PKCS12_SAFEBAG_S *pstSafeBag);
...
*
*/
PSELINKDLL X509_CERT_S *PKCS12_extractCertFromSafeBag(PKCS12_SAFEBAG_S *pstSafeBag);
...
* N/A
*/
PSELINKDLL X509_CRL_S *PKCS12_extractCRLFromSafeBag(PKCS12_SAFEBAG_S *pstSafeBag);
...
* N/A
*/
PSELINKDLL SEC_UCHAR *PKCS12_getDataFromSafeBag(PKCS12_SAFEBAG_S *pstSafeBag, SEC_UINT32 *pulLen);
...
* N/A
*/
PSELINKDLL PKCS12_SAFEBAG_S *PKCS12_privKeyToSafeBag(PKCS8_PRIVKEY_S *pstPrivKey);
...
* N/A
*/
PSELINKDLL PKCS12_SAFEBAG_S *PKCS12_encryptedPrivKeyToSafeBag(PKCS8_ENCRYPTED_PRIVKEY_S *pstEncPrivKeyInfo);
...
*
* @par Description
* This function returns PKCS8 Private Key structure from PKCS12 Safe Bag.
*
...
* N/A
*/
PSELINKDLL PKCS8_PRIVKEY_S *PKCS12_getPrivKeyFromSafeBag(PKCS12_SAFEBAG_S *pstSafeBag);
...
*
* @par Description
* This function returns PKCS8 Encrypted  Private Key  structure from safe bag.
*
...
* N/A
*/
PSELINKDLL PKCS8_ENCRYPTED_PRIVKEY_S *PKCS12_getEncryptedPrivKeyFromSafeBag(PKCS12_SAFEBAG_S *pstSafeBag);
...
* N/A
*/
PSELINKDLL SEC_UINT32 PKCS12_addBagToBagList(PKCS12_BAGLIST_S *pstSafeContents, PKCS12_SAFEBAG_S *pstSafeBag);
...
*
*/
PSELINKDLL PKCS12_SAFEBAG_S *PKCS12_getBagFromBagList(PKCS12_BAGLIST_S *pstSafeContent);
...
* N/A
*/
PSELINKDLL PKCS12_SAFEBAG_S *PKCS12_getBagFromBagListByIndex(PKCS12_BAGLIST_S *pstBagList, SEC_UINT32 ulIndex);
...
* @par Prototype
* @code
* PKCS12_PRIVACY_MODE_E PKCS12_getPrivacyMode(const PKCS7_MSG_S* pstContentInfo)
* @endcode
*
* @par Purpose
...
*
* @par Description
* This function returns the type of the privacy mode applied on data,
...
* N/A
*/
PSELINKDLL PKCS12_PRIVACY_MODE_E PKCS12_getPrivacyMode(const PKCS7_MSG_S *pstP7info);
...
* N/A
*/
PSELINKDLL SEC_UINT32 PKCS12_addBagListToAuthSafe(PKCS12_AUTHSAFE_S *pstAuthSafe, PKCS12_BAGLIST_S *pstSafeContents);
...
* N/A
*/
PSELINKDLL SEC_UINT32 PKCS12_encryptBagList(PKCS12_AUTHSAFE_S *pstAuthSafe, PKCS12_BAGLIST_S *pstSafeContent,
    SEC_UCHAR *pucPass, SEC_UINT32 ulPassLen, SEC_UINT32 ulPbeAlgId);
...
*
*/
PSELINKDLL SEC_UINT32 PKCS12_envelopBagList(PKCS12_AUTHSAFE_S *pstAuthSafe, PKCS12_BAGLIST_S *pstSafeContent,
    SEC_UINT32 enCEAlgo, X509_CERT_S *pstCertificate);
...
*
* @par Description
* This function returns the Bag List (Safe Contents) from Auth Safe.
...
*
*/
PSELINKDLL PKCS12_BAGLIST_S *PKCS12_extractBagListFromAuthSafe(PKCS12_AUTHSAFE_S *pstAuth);
...
*
*/
PSELINKDLL PKCS12_BAGLIST_S *PKCS12_decryptAuthSafe(PKCS12_AUTHSAFE_S *pstAuth, SEC_UCHAR *pucPass,
    SEC_UINT32 ulPassLen);
...
*
* @par Description
* This function returns the Safe Bag List (safe contents) from Auth Safe.
...
* N/A
*/
PSELINKDLL PKCS12_BAGLIST_S *PKCS12_openEnvelop(PKCS12_AUTHSAFE_S *pstAuth, SEC_PKEY_S *pstPrivKeyInfo,
    const X509_CERT_S *pstCert);
...
* N/A
*/
PSELINKDLL PKCS12_PFX_S *PKCS12_createPFXWithPubKey(PKCS12_AUTHSAFE_S *pstAuthSafe, SEC_UINT32 ulVersion,
    const X509_CERT_S *pstCert, SEC_PKEY_S *pstPrivKey);
...
*
*/
PSELINKDLL PKCS12_PFX_S *PKCS12_createPFXWithPasswd(PKCS12_AUTHSAFE_S *pstAuthSafe, SEC_UINT32 ulVersion,
    SEC_UCHAR *pucPassword, SEC_UINT32 ulPassLen, SEC_UINT32 ulAlgId);
...
* N/A
*/
PSELINKDLL PKCS12_PFX_S *PKCS12_changePFXPasswd(PKCS12_PFX_S *pstPFX, SEC_UCHAR *pucOldPass, SEC_UINT32 ulOldLen,
    SEC_UCHAR *pucNewPass, SEC_UINT32 ulNewLen, SEC_UINT32 ulPbeAlgId);
...
It decodes the PKCS7_MSG_S of PFX and returns
...
* @par Note
*
* It returns the Authsafe back from the PFX.
*
* @par Related Topics
* N/A
*
*
*/
PSELINKDLL PKCS12_AUTHSAFE_S *PKCS12_extractAuthSafeFromPFX(PKCS12_PFX_S *pstPFX);
...
*
*/
PSELINKDLL SEC_UINT32 PKCS12_verifyPFXWithPasswd(PKCS12_PFX_S *pstPFX, SEC_UCHAR *pucPassword, SEC_INT32 ulPassLen);
...
* @par Prototype
* @code
* PKCS12_INTEGRITY_MODE_E PKCS12_getIntegrityMode(const PKCS12_PFX_S* pstPFX)
* @endcode
*
* @par Purpose
...
*
* @par Description
* This function returns the integrity mode applied on PFX.
*
...
* N/A
*/
PSELINKDLL PKCS12_INTEGRITY_MODE_E PKCS12_getIntegrityMode(const PKCS12_PFX_S *pstPFX);
...
* N/A
*/
PSELINKDLL SEC_UCHAR *PKCS12_encodePFX(PKCS12_PFX_S *pstPFX, SEC_UINT32 *pulLenEncoded);
...
* N/A
*/
PSELINKDLL PKCS12_PFX_S *PKCS12_decodePFX(SEC_UCHAR *pucEncodedPDU, SEC_UINT32 ulEncPDULen, SEC_UINT32 *pulLenDecoded);
...
* @par Prototype
* @code
* SEC_UINT32 PKCS12_verifyPFXWithPubKey(const PKCS12_PFX_S *pstPFX,
* X509_CERT_S* pstCERT)
* @endcode
*
* @par Purpose
...
*
*/
PSELINKDLL SEC_UINT32 PKCS12_verifyPFXWithPubKey(const PKCS12_PFX_S *pstPFX, X509_CERT_S *pstCERT);
...
* @par Prototype
* @code
* SEC_VOID PKCS12_freeBagList(PKCS12_BAGLIST_S* pstSafeContent)
* @endcode
*
* @par Purpose
...
*
* @param[in] pstSafeContent A list of Safe Bag to hold information
...
* N/A
*/
PSELINKDLL SEC_VOID PKCS12_freeBagList(PKCS12_BAGLIST_S *pstSafeContent);
 ...
 * N/A
 */
PSELINKDLL SEC_VOID PKCS12_freeSafeBagSetOf(PKCS12_SafeBagSetOf_S *pstSafeBagSetOf);
...
* @par Prototype
* @code
* SEC_VOID PKCS12_freeSafeBAG (PKCS12_SAFEBAG_S * pstSafeBag);
* @endcode
*
* @par Purpose
...
*
* @param[in] pstSafeBag Safe Bag to hold information
...
*
*/
PSELINKDLL SEC_VOID PKCS12_freeSafeBAG(PKCS12_SAFEBAG_S *pstSafeBag);
...
*
* @param[in] pSrc The PKCS12_MACDATA_S pointer. [N/A]
* @param[out] N/A N/A [N/A]
*
...
* N/A
*/
PSELINKDLL PKCS12_SafeBagSetOf_S *PKCS12_dupSafeBagSetOf(PKCS12_SafeBagSetOf_S *pSrc);
...
* N/A
*/
PSELINKDLL PKCS12_AUTHSAFE_S *PKCS12_dupAuthenticatedSafe(PKCS12_AUTHSAFE_S *pSrc);
