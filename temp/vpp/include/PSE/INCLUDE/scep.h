 ...
 * Description: Simple Certificate Enrollment Protocol funtions and datatypes
                declerations.
...
/* HTTP Content structure IS SEC_AsnOcts_S which holds data and data length */
 ...
 * @par Prototype
 * @code
 * SEC_CHAR* SCEP_createTID(const SEC_PKEY_S* pstPublicKey, SEC_UINT32 enHashAlg)
 * @endcode
 *
 * @par Purpose
 ...
 * given it is an error. Transaction ID is used to maintain a
 ...
 * @retval SEC_CHAR* Input arguments are invalid during CRYPT_digest() [SEC_NULL|N/A]
...
PSELINKDLL SEC_CHAR *SCEP_createTID(const SEC_PKEY_S *pstPublicKey, SEC_UINT32 enHashAlg);
 ...
 * @retval PKCS10_REQ_S* In case of failure [SEC_NULL|N/A]
 *
 * @par Dependency
 * scep.h
 *
...
PSELINKDLL PKCS10_REQ_S *SCEP_createCertReq(SEC_NAME_S *pstRequestorName, const SEC_PKEY_S *pstPubKey,
    SEC_UCHAR *pcChallengPass, SEC_INT32 ulPassLen, SEC_PKEY_S *pstPvtKey, SEC_EXTN_S *pstSubAltNameExtnAttr,
    SEC_EXTN_S *pstKeyUsageExtnAttr, SEC_EXTN_S *pstExtKeyUsageExtnAttr, SEC_UINT32 enHashAlgID);
 ...
 * @retval SCEP_CERTRESP_S* In case of failure [SEC_NULL|N/A]
 *
 * @par Dependency
 * scep.h
 *
...
PSELINKDLL SCEP_CERTRESP_S *SCEP_createCertResp(X509_CERT_S *pstIssued, X509_CERT_S *pstCACert, X509_CERT_S *pstRACert);
 ...
 * SEC_PKEY_S* pstPvtKey,
 * SEC_NAME_S* pstIssuer,
 * const SEC_BIGINT_S* pstSerialNum,
 ...
 * @param[in] pcTId Transaction ID, used to maintain a transaction between
 * requester and server. pcTId must be null terminated buffer. [N/A]
 ...
 * @retval SCEP_MSG_S* In case of failure [SEC_NULL|N/A]
 *
 * @par Dependency
 * scep.h
 *
...
PSELINKDLL SCEP_MSG_S *SCEP_createPendFailCertResp(SCEP_STATUS_E enStatus, SCEP_REASON_E enReason, SEC_CHAR *pcTId,
    SEC_CHAR *pcSNonce, SEC_UINT32 ulSLen, SEC_CHAR *pcRNonce, SEC_UINT32 ulRLen, SEC_PKEY_S *pstPvtKey,
    SEC_NAME_S *pstIssuer, const SEC_BIGINT_S *pstSerialNum, SEC_UINT32 enDigestAlgo, SEC_UINT32 enDigEncryAlgo);
 ...
 * @retval SCEP_CERTPOLLREQ_S* In case of failure [SEC_NULL|N/A]
 *
 * @par Dependency
 * scep.h
 *
...
PSELINKDLL SCEP_CERTPOLLREQ_S *SCEP_createCertPollReq(SEC_NAME_S *pstCAName, SEC_NAME_S *pstReqName);
 ...
 * @retval SCEP_CERTQUERY_S* In case of failure [SEC_NULL|N/A]
 *
 * @par Dependency
 * scep.h
 *
...
PSELINKDLL SCEP_CERTQUERY_S *SCEP_createCertQuery(SEC_NAME_S *pstCAName, SEC_BIGINT_S *pstSerial);
 ...
 * const SEC_BIGINT_S* pstSerialNum, SEC_List_S* pstDistPoint)
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Description
 * This function Creates and returns an SCEP GetCRL message. The query of the CRL can only be initialized by the
 * requester. The CRL may be retrieved by a simple HTTP GET. If the CA supports this method, it should encode the URL
 * into a CRL Distribution Point extension in the certificates it issues. Refer RFC 2587 to study CRL Distribution
 * Point.
 *
 * @param[in] pstCAName CA's Name [N/A]
 ...
 * @retval SCEP_CRLQUERY_S* In case of failure [SEC_NULL|N/A]
 *
 * @par Dependency
 * scep.h
 *
...
PSELINKDLL SCEP_CRLQUERY_S *SCEP_createCRLQuery(SEC_NAME_S *pstCAName, const SEC_BIGINT_S *pstSerialNum,
 ...
 * @retval SCEP_CRLRESP_S* In case of failure [SEC_NULL|N/A]
 *
 * @par Dependency
 * scep.h
 *
...
PSELINKDLL SCEP_CRLRESP_S *SCEP_createCRLResp(X509_CRL_S *pstCRL);
 ...
 * @param[in] pcTId Transaction ID,to be added as the attribute, pcTId buffer must be null terminated buffer [N/A]
...
PSELINKDLL SCEP_MSG_S *SCEP_createEnvAndSignReq(SEC_VOID *pData, SCEP_MSGTYPE_E enMsgType, X509_CERT_S *pstRecv,
    X509_CERT_S *pstSign, SEC_CHAR *pcTId, SEC_CHAR *pcSNonce, SEC_UINT32 ulSLen, SEC_PKEY_S *pstSignKey,
    SEC_UINT32 enDigestAlgo, SEC_UINT32 enDigEncryAlgo, SEC_UINT32 enCEAlgo);
 ...
 * 				   (Same as recieved in request message). pcTId must be null terminated buffer [N/A]
 * @param[in] pcSNonce Sender Nonce [N/A]
 * @param[in] ulSLen Length of the sender nonce [N/A]
 * @param[in] pcRNonce Recipient Nonce [N/A]
 * @param[in] ulRLen Length of the Recipient nonce [N/A]
...
PSELINKDLL SCEP_MSG_S *SCEP_createEnvAndSignResp(SEC_VOID *pData, SCEP_MSGTYPE_E enMsgType, X509_CERT_S *pstRecv,
    X509_CERT_S *pstSign, SEC_CHAR *pcTId, SEC_CHAR *pcSNonce, SEC_UINT32 ulSLen, SEC_CHAR *pcRNonce, SEC_UINT32 ulRLen,
    SEC_PKEY_S *pstSignKey, SEC_UINT32 enDigestAlgo, SEC_UINT32 enDigEncryAlgo, SEC_UINT32 enCEAlgo);
 ...
 * const SEC_CHAR* pcCgiPath, SEC_BOOL bPost, const SEC_CHAR* pMsg, SEC_UINT32 ulMsgLen)
 * @endcode
 *
 * @par Purpose
 ...
 * @param[in] pcCgiPath The path of CGI Program, This is a string and must be null terminated.
 * Max value is set to SCEP_setMaxPKIMsgHTTPSize.[N/A]
 * @param[in] bPost The Flag. TRUE for POST and FALSE for GET [N/A]
 * @param[in] pMsg Message to be included in the HTTP Content, pMsg buffer must be null terminated buffer [N/A]
 * @param[in] ulMsgLen Length of the message (pMsg). Max value is set to SCEP_setMaxPKIMsgHTTPSize [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval SCEP_HTTPCONTENT_S* Created HTTP Content [SCEP_HTTPCONTENT_S*|N/A]
 * @retval SCEP_HTTPCONTENT_S* In case of failure [SEC_NULL|N/A]
 *
 * @par Dependency
 * scep.h
 *
...
PSELINKDLL SCEP_HTTPCONTENT_S *SCEP_createHTTPContent(SCEP_MSGTYPE_E enMsgType, const SEC_CHAR *pcCgiPath,
    SEC_BOOL bPost, const SEC_CHAR *pMsg, SEC_UINT32 ulMsgLen);
 ...
 * @par Prototype
 * @code
 * SCEP_HTTPCONTENT_S* SCEP_createPKIMsgHTTPResp(const SEC_CHAR* pMsg, SEC_UINT32 ulMsgLen)
 * @endcode
 *
 * @par Purpose
 ...
 * @param[in] ulMsgLen Length of the given PKI Message. Max limit is set by SCEP_setMaxPKIMsgHTTPSize [N/A]
 * @param[out] N/A N/A [N/A]
 *
...
PSELINKDLL SCEP_HTTPCONTENT_S *SCEP_createPKIMsgHTTPResp(const SEC_CHAR *pMsg, SEC_UINT32 ulMsgLen);
...
PSELINKDLL SCEP_HTTPCONTENT_S *SCEP_createCACertResp(X509_CERT_S *pstCACert, X509_CERT_S *pstRACert);
 ...
 * const X509_CERT_S* pstCurrCACert,
 * const SEC_PKEY_S* pstSignKey,
 * SEC_UINT32 enDigestAlgo,
 * SEC_UINT32 enDigEncryAlgo);
 * @endcode
 *
...
PSELINKDLL SCEP_HTTPCONTENT_S *SCEP_createNextCACertResp(X509_CERT_S *pstNextCert, X509_CERT_S *pstRACert,
    const X509_CERT_S *pstCurrCACert, const SEC_PKEY_S *pstSignKey, SEC_UINT32 enDigestAlgo, SEC_UINT32 enDigEncryAlgo);
...
PSELINKDLL SCEP_HTTPCONTENT_S *SCEP_createCACapsResp(SEC_UINT32 ulCaps);
...
PSELINKDLL SCEP_HTTPCONTENT_S *SCEP_createCACertChainResp(SEC_List_S *pCertChain);
 ...
 * @par Description
 * This function returns the content from the given Message.
 *
 ...
 * @retval SEC_VOID* In case of failure [SEC_NULL|N/A]
 *
 * @par Dependency
 * scep.h
 *
...
PSELINKDLL SEC_VOID *SCEP_extractContentFromMsg(SCEP_MSG_S *pMsg, SEC_PKEY_S *pstPvtKey, SEC_NAME_S *pstIssuer,
    SEC_BIGINT_S *pstSerialNum, SCEP_MSGTYPE_E *pMessageType);
 ...
 * @par Description
 * This function returns content from the given HTTP Message. If the
 * message is PKI Message, returns SEC_AsnOcts_S pointer with PKIMessage.
...
PSELINKDLL SEC_VOID *SCEP_extractContentFromHTTPMsg(SCEP_HTTPCONTENT_S *pMsg, SCEP_MSGTYPE_E *pMessageType);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32 SCEP_verifyMsg(const PKCS7_MSG_S*  pstPKCS7,
...
PSELINKDLL SEC_UINT32 SCEP_verifyMsg(const PKCS7_MSG_S *pstPKCS7, SEC_List_S *pCertList, SEC_NAME_S *pstSignerIssuer,
    SEC_BIGINT_S *signerSN, SEC_NAME_S *pstRecipIssuer, SEC_BIGINT_S *recipSN, SEC_PKEY_S *pstPrivKeyInfo);
 ...
 * by encrypting it.
 *
 * @param[in] ulLen Length of the required challenge Password,Max value is 1048576. [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval SEC_CHAR* Pointer to the generated challenge Password [SEC_CHAR*|N/A]
 * @retval SEC_CHAR* In case of failure [SEC_NULL|N/A]
 *
 * @par Dependency
 * scep.h
 *
...
PSELINKDLL SEC_UCHAR *SCEP_genChallengePasswd(SEC_UINT32 ulLen);
 ...
 * @retval SEC_UCHAR* In case of failure [SEC_NULL|N/A]
 *
 * @par Dependency
 * scep.h
 *
...
PSELINKDLL SEC_UCHAR *SCEP_generateNonce(SEC_INT32 *pulNonceLen);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32 SCEP_compareNonce(const SEC_CHAR* pcSrcNonce, SEC_UINT32 ulSrcNonceLen,
 * const SEC_CHAR* pcDestNonce, SEC_UINT32 ulDestNonceLen)
 * @endcode
 *
 * @par Purpose
...
PSELINKDLL SEC_UINT32 SCEP_compareNonce(const SEC_CHAR *pcSrcNonce, SEC_UINT32 ulSrcNonceLen,
    const SEC_CHAR *pcDestNonce, SEC_UINT32 ulDestNonceLen);
 ...
 * @par Prototype
 * @code
 * SCEP_MSGTYPE_E SCEP_getMsgType(const SCEP_MSG_S* pMsg)
 * @endcode
 *
 * @par Purpose
 * To fetch the type of the given SCEP message.
 * @par Description
 * This function returns the message type from the given SCEP message.
 ...
 * N/A
 */
/* Returns the message type from the given message */
PSELINKDLL SCEP_MSGTYPE_E SCEP_getMsgType(const SCEP_MSG_S *pMsg);
 ...
 * @par Prototype
 * @code
 * SCEP_MSGTYPE_E SCEP_getHTTPContentType(const SCEP_HTTPCONTENT_S* pMsg)
 * @endcode
 *
 * @par Purpose
 * To fetch the content type from the given HTTP Content message.
 * @par Description
 * This function returns the content type from the given HTTPContent.
 ...
 * N/A
 */
/* Returns the content type from the given HTTPContent  */
PSELINKDLL SCEP_MSGTYPE_E SCEP_getHTTPContentType(const SCEP_HTTPCONTENT_S *pMsg);
 ...
 * @par Description
 * This function returns the CACert from the given HTTPContent
 *
 * @param[in] pMsg Pointer to HTTP Content Message [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval X509_CERT_S* CA Certificate from Message [X509_CERT_S*|N/A]
 * @retval X509_CERT_S* In case of failure [SEC_NULL|N/A]
 *
 * @par Dependency
 * scep.h
 *
 ...
 * N/A
 */
/* Returns the CACert from the given HTTPContent */
PSELINKDLL X509_CERT_S *SCEP_extractCACert(SCEP_HTTPCONTENT_S *pMsg);
 ...
 * @par Description
 * This function returns the Certificate from the given Certificate Response.
 ...
 * N/A
 */
/* Returns the Cert from the given Certificate Response */
PSELINKDLL X509_CERT_S *SCEP_getCert(SCEP_CERTRESP_S *pCertResp);
 ...
 * N/A
 */
/* Returns the CRL from the given Response */
PSELINKDLL X509_CRL_S *SCEP_getCRL(SCEP_CRLRESP_S *pCRLResp);
 ...
 * @par Description
 * This function returns CA cert or RA cert from the CertRep message
 ...
 * N/A
 */
/* Returns CA/RA cert fields from the CertRep message */
PSELINKDLL X509_CERT_S *SCEP_getCARACert(SCEP_CERTRESP_S *pCertResp, SEC_NAME_S *pstIssuer,
 ...
 * @par Description
 * This function returns the CA Capabilities from the HTTP Content Message.
 *
 * @param[in] pMsg Pointer to HTTP Content Message [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
/* Returns the CA Capabilities from HTTP Messages */
PSELINKDLL SEC_UINT32 SCEP_getCACaps(SCEP_HTTPCONTENT_S *pMsg);
 ...
 * @par Description
 * This function returns the Certificate List from Certificate Response.
 *
 ...
 * @retval SEC_List_S* In case of failure [SEC_NULL|N/A]
 *
 * @par Dependency
 * scep.h
 *
 ...
 * N/A
 */
/* Returns the Certificate List from Cert Response */
PSELINKDLL SEC_List_S *SCEP_extractCertList(SCEP_CERTRESP_S *pCertResp);
 ...
 * @par Prototype
 * @code
 * SCEP_STATUS_E SCEP_getStatus(const SCEP_MSG_S* pMsg)
 * @endcode
 *
 * @par Purpose
 * To fetch the Status of the given SCEP message.
 * @par Description
 * This function returns the status from the SCEP message.
 *
 ...
 */
/* Returns the status */
PSELINKDLL SCEP_STATUS_E SCEP_getStatus(const SCEP_MSG_S *pMsg);
 ...
 * @par Prototype
 * @code
 * SCEP_REASON_E SCEP_getReason(const SCEP_MSG_S* pMsg)
 * @endcode
 *
 * @par Purpose
 * To fetch the reason for failure from the given SCEP response message.
 * @par Description
 * This function returns the reason for failure from the SCEP response message.
 *
 ...
 */
/* Returns the reason */
PSELINKDLL SCEP_REASON_E SCEP_getReason(const SCEP_MSG_S *pMsg);
 ...
 * @par Description
 * This function returns the sender nonce from the SCEP message.
 *
 * @param[in] pMsg Pointer to the Message [N/A]
...
PSELINKDLL SEC_CHAR *SCEP_getSenderNonce(SCEP_MSG_S *pMsg, SEC_UINT32 *pLen);
 ...
 * @par Description
 * This function returns the recipient nonce from the SCEP message.
 *
 ...
 * N/A
 */
/* Returns the recipient nonce */
PSELINKDLL SEC_CHAR *SCEP_getRecipientNonce(SCEP_MSG_S *pMsg, SEC_UINT32 *pLen);
 ...
 * @par Description
 * This function returns the transaction ID from the SCEP message.
 *
 * @param[in] pMsg Pointer to the Message [N/A]
...
PSELINKDLL SEC_CHAR *SCEP_getTID(SCEP_MSG_S *pMsg, SEC_UINT32 *pLen);
 ...
 * @par Prototype
 * @code
 * SEC_NAME_S* SCEP_getIssuerFromCertPollReq(const SCEP_CERTPOLLREQ_S* pstCertPollReq)
 * @endcode
 *
 * @par Purpose
 * To fetch the Issuer name from the given SCEP Certificate Poll request structure.
 * @par Description
 * This function returns the Issuer from Certificate Poll Request Structure.
 *
 * @param[in] pstCertPollReq Cert Poll Request Pointer [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval SEC_NAME_S* Issuer Name [SEC_NAME_S*|N/A]
 * @retval SEC_NAME_S* In case of failure [SEC_NULL|N/A]
 *
 * @par Dependency
 * scep.h
 *
 ...
 * N/A
 */
/* Returns the Issuer from Cert Poll Request Structure */
PSELINKDLL SEC_NAME_S *SCEP_getIssuerFromCertPollReq(const SCEP_CERTPOLLREQ_S *pstCertPollReq);
 ...
 * @par Prototype
 * @code
 * SEC_NAME_S* SCEP_getSubjectFromCertPollReq(const SCEP_CERTPOLLREQ_S* pstCertPollReq)
 * @endcode
 *
 * @par Purpose
 * To fetch the Subject Name from the given SCEP Certificate Poll request structure.
 * @par Description
 * This function returns the Subject from Cert Poll Request Structure.
 *
 * @param[in] pstCertPollReq Cert Poll Request Pointer [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
/* Returns the Subject from Cert Poll Request Structure */
PSELINKDLL SEC_NAME_S *SCEP_getSubjectFromCertPollReq(const SCEP_CERTPOLLREQ_S *pstCertPollReq);
 ...
 * @par Prototype
 * @code
 * SEC_BIGINT_S* SCEP_getSNFromCRLQuery(const SCEP_CRLQUERY_S* pstCRLQuery)
 * @endcode
 *
 * @par Purpose
 * To fetch the Serial Number from the given SCEP CRL query structure.
 * @par Description
 * This function returns the SerialNumber from CRL Query Structure.
 *
 * @param[in] pstCRLQuery CRL Query Pointer [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval SEC_BIGINT_S* Serial Number [SEC_BIGINT_S*|N/A]
 * @retval SEC_BIGINT_S* In case of failure [SEC_NULL|N/A]
 *
 * @par Dependency
 * scep.h
 *
 ...
 * N/A
 */
/* Returns the SerialNumber from CRL Query Structure */
PSELINKDLL SEC_BIGINT_S *SCEP_getSNFromCRLQuery(const SCEP_CRLQUERY_S *pstCRLQuery);
 ...
 * @par Prototype
 * @code
 * SEC_NAME_S* SCEP_getIssuerFromCRLQuery(const SCEP_CRLQUERY_S* pstCRLQuery)
 * @endcode
 *
 * @par Purpose
 * To fetch the Issuer Name from the given SCEP CRL Query structure.
 * @par Description
 * This function returns the Issuer from CRL Query Structure.
 *
 * @param[in] pstCRLQuery CRL Query Pointer [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
/* Returns the Issuer from CRL Query Structure */
PSELINKDLL SEC_NAME_S *SCEP_getIssuerFromCRLQuery(const SCEP_CRLQUERY_S *pstCRLQuery);
 ...
 * @par Prototype
 * @code
 * SEC_NAME_S* SCEP_getIssuerFromCertQuery(const SCEP_CERTQUERY_S* pstCertQuery)
 * @endcode
 *
 * @par Purpose
 * To fetch the Issuer name from the givne SCEP Certificate query structure.
 * @par Description
 * This function returns the Issuer from Cert Query Structure.
 *
 ...
 * N/A
 */
/* Returns the Issuer from Cert Query Structure */
PSELINKDLL SEC_NAME_S *SCEP_getIssuerFromCertQuery(const SCEP_CERTQUERY_S *pstCertQuery);
 ...
 * @par Description
 * This function returns the SerialNumber from Certficate Query Structure.
 *
 * @param[in] pstCertQuery Cert Query Pointer [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * N/A
 */
/* Returns the SerialNumber from Cert Query Structure */
PSELINKDLL SEC_BIGINT_S *SCEP_getSNFromCertQuery(SCEP_CERTQUERY_S *pstCertQuery);
...
PSELINKDLL SEC_VOID SCEP_freeCertReq(PKCS10_REQ_S *pCertReq);
...
PSELINKDLL SEC_VOID SCEP_freeCertResp(SCEP_CERTRESP_S *pCertResp);
...
PSELINKDLL SEC_VOID SCEP_freeCertPollReq(SCEP_CERTPOLLREQ_S *pCertPollReq);
...
PSELINKDLL SEC_VOID SCEP_freeCertQuery(SCEP_CERTQUERY_S *pCertQuery);
...
PSELINKDLL SEC_VOID SCEP_freeCRLQuery(SCEP_CRLQUERY_S *pCRLQuery);
...
PSELINKDLL SEC_VOID SCEP_freeHTTPContent(SCEP_HTTPCONTENT_S *pHTTPContent);
...
PSELINKDLL SEC_VOID SCEP_freeCRLResp(SCEP_CRLRESP_S *pCRLResp);
...
PSELINKDLL SEC_VOID SCEP_freeSCEPMsg(SCEP_MSG_S *pSCEPMessage);
...
PSELINKDLL SEC_UCHAR *SCEP_encodeSCEPMsg(SCEP_MSG_S *pstSCEPMsg, SEC_UINT32 *pulEncodedLen);
...
PSELINKDLL SEC_UCHAR *SCEP_encodeCertResp(SCEP_CERTRESP_S *pstCerResp, SEC_UINT32 *pulEncodedLen);
...
PSELINKDLL SEC_UCHAR *SCEP_encodeCRLResp(SCEP_CRLRESP_S *pstCRLResp, SEC_UINT32 *pulEncodedLen);
...
PSELINKDLL SEC_UCHAR *SCEP_encodeCertQuery(SCEP_CERTQUERY_S *pstCertQuery, SEC_UINT32 *pulEncodedLen);
...
PSELINKDLL SEC_UCHAR *SCEP_encodeHTTPContent(SCEP_HTTPCONTENT_S *pstHTTPContent, SEC_UINT32 *pulEncodedLen);
...
PSELINKDLL SEC_UCHAR *SCEP_encodeCertPollReq(SCEP_CERTPOLLREQ_S *pstCertPollReq, SEC_UINT32 *pulEncodedLen);
...
PSELINKDLL SEC_UCHAR *SCEP_encodeCRLQuery(SCEP_CRLQUERY_S *pstCRLQuery, SEC_UINT32 *pulEncodedLen);
...
PSELINKDLL SCEP_MSG_S *SCEP_decodeSCEPMsg(SEC_UCHAR *pcEncodedValue, SEC_UINT32 ulLength, SEC_UINT32 *pulDecodedLen);
...
PSELINKDLL SCEP_CERTRESP_S *SCEP_decodeCertResp(SEC_UCHAR *pcEncodedValue, SEC_UINT32 ulLength,
    SEC_UINT32 *pulDecodedLen);
...
PSELINKDLL SCEP_CRLRESP_S *SCEP_decodeCRLResp(SEC_UCHAR *pcEncodedValue, SEC_UINT32 ulLength,
    SEC_UINT32 *pulDecodedLen);
...
PSELINKDLL SCEP_CERTQUERY_S *SCEP_decodeCertQuery(SEC_UCHAR *pcEncodedValue, SEC_UINT32 ulLength,
    SEC_UINT32 *pulDecodedLen);
...
PSELINKDLL SCEP_HTTPCONTENT_S *SCEP_decodeHTTPContent(SEC_UCHAR *pcEncodedValue, SEC_UINT32 ulLength,
    SEC_UINT32 *pulDecodedLen);
...
PSELINKDLL SCEP_CERTPOLLREQ_S *SCEP_decodeCertPollReq(SEC_UCHAR *pcEncodedValue, SEC_UINT32 ulLength,
    SEC_UINT32 *pulDecodedLen);
...
PSELINKDLL SCEP_CRLQUERY_S *SCEP_decodeCRLQuery(SEC_UCHAR *pcEncodedValue, SEC_UINT32 ulLength,
    SEC_UINT32 *pulDecodedLen);
 ...
 * @par Prototype
 * @code
 * CRLDistributionPoints* SCEP_getCRLDistPoint(const SCEP_CRLQUERY_S* pstCRLQuery)
 * @endcode
 *
 * @par Purpose
 * To fetch the CRL Distribution Point from the given CRL query structure.
 * @par Description
 * This function returns the CRL Distribution Points from CRL Query Structure.
 *
 * @param[in] pstCRLQuery CRL Query Pointer [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval CRLDistributionPoints* CRL Distribution Points [CRLDistributionPoints*|N/A]
 * @retval CRLDistributionPoints* In case of failure [SEC_NULL|N/A]
 *
 * @par Dependency
 * scep.h
 *
 ...
 * N/A
 */
/* Returns the CRL distribution point from the CRL Query Structure */
PSELINKDLL CRLDistributionPoints *SCEP_getCRLDistPoint(const SCEP_CRLQUERY_S *pstCRLQuery);
...
* @retval SCEP_CRLQUERY_EX_S* In case of failure [SEC_NULL|N/A]
*
* @par Dependency
* scep.h
*
...
*/
PSELINKDLL
SCEP_CRLQUERY_EX_S *SCEP_createCRLQuery_Ex(SEC_NAME_S *pstCAName, SEC_BIGINT_S *pstSerial);
...
/**
 * @defgroup SCEP_setMaxPKIMsgHTTPSize
 * @ingroup scepFunctions
 * @par Prototype
 * @code
 * SEC_INT SCEP_setMaxPKIMsgHTTPSize(SEC_UINT32 uiMaxSize)
 * @endcode
 *
 * @par Purpose
 * To set maximum size required as output of SCEP_createPKIMsgHTTPResp,SCEP_createHTTPContent. Default value is 1 MB
 * @par Description
 * This function is used to set maximum size required as output of SCEP_setMaxPKIMsgHTTPSize. Default value is 1 MB
 *
 * @param[in] uiMaxSize  Maximum Length of PKI Message. Max 100MB can be set.[N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval SEC_INT If the set is successful.[SEC_SUCCESS|N/A]
 * @retval SEC_INT If it fail to set uiMaxSize [IPSI_FAILURE|N/A]
 *
 * @par Dependency
 * scep.h
 *
 * @par Note
 * This is a configuration API. It is not  a thread safe API. It should be called once during init.
 * It should be called before any PSE or SCEP Operation.
 *
 * @par Related Topics
 * N/A
 */
PSELINKDLL SEC_INT SCEP_setMaxPKIMsgHTTPSize(SEC_UINT32 uiMaxSize);

/**
 * @defgroup SCEP_getMaxPKIMsgHTTPSize
 * @ingroup scepFunctions
 * @par Prototype
 * @code
 * SEC_UINT32 SCEP_getMaxPKIMsgHTTPSize()
 * @endcode
 *
 * @par Purpose
 * To get maximum size required as output of SCEP_createPKIMsgHTTPResp .
 * @par Description
 * This function is used to get maximum size required as output of SCEP_setMaxPKIMsgHTTPSize .
 *
 * @param[in] N/A N/A [N/A]
 * @param[out] N/A N/A [N/A]
 *
 * @retval SEC_UINT32 Returns Configured value for PKI Message Size [N/A|N/A]
 *
 * @par Dependency
 * scep.h
 *
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 SCEP_getMaxPKIMsgHTTPSize(void);
