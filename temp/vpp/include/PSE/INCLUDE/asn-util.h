 ...
 * Description: Header file contains the asn-util Function declaration
 * Author: VPP
 * Create: 2012/10/20
 */
#ifndef ASN_UTIL_H
 ...
 * @par Prototype
 * @code
 * SEC_AsnOcts_S* SEC_BigIntToAsnOcts(const SEC_BIGINT_S * pstBigInt)
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_AsnOcts_S *SEC_BigIntToAsnOcts(const SEC_BIGINT_S *pstBigInt);
 ...
 * @par Prototype
 * @code
 * SEC_BIGINT_S* SEC_AsnOctsToBigInt(const SEC_AsnOcts_S *pstAsnOcts)
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_BIGINT_S *SEC_AsnOctsToBigInt(const SEC_AsnOcts_S *pstAsnOcts);
 ...
 * N/A
 */
PSELINKDLL void SEC_freeAsnBits(SEC_AsnBits_S *v);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_cmpAsnBits  (const SEC_AsnBits_S *pstAsnBits1, const SEC_AsnBits_S *pstAsnBits2);
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_INT SEC_cmpAsnBits(const SEC_AsnBits_S *b1, const SEC_AsnBits_S *b2);
 ...
 * @par Prototype
 * @code
 * void SEC_SetAsnBit  (const SEC_AsnBits_S *pstAsnBits1, SEC_UINT bit);
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL void SEC_SetAsnBit(const SEC_AsnBits_S *b1, SEC_UINT bit);
 ...
 * @par Prototype
 * @code
 * void SEC_ClrAsnBit  (const SEC_AsnBits_S *pstAsnBits1, SEC_UINT bit);
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL void SEC_ClrAsnBit(const SEC_AsnBits_S *b1, SEC_UINT bit);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_GetAsnBit  (const SEC_AsnBits_S *pstAsnBits1, SEC_UINT bit);
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_INT SEC_GetAsnBit(const SEC_AsnBits_S *b1, SEC_UINT bit);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32 SEC_cpyAsnBits(SEC_AsnBits_S *pstDestAsnBits,const SEC_AsnBits_S *pstSrcAsnBits)
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 SEC_cpyAsnBits(SEC_AsnBits_S *pstDestAsnBits, const SEC_AsnBits_S *pstSrcAsnBits);
 ...
 * @par Prototype
 * @code
 * SEC_AsnBits_S* SEC_dupAsnBits(const SEC_AsnBits_S *pstSrcAsnBits)
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_AsnBits_S *SEC_dupAsnBits(const SEC_AsnBits_S *pstSrcAsnBits);
 ...
 * N/A
 */
PSELINKDLL void SEC_freeBMPString(SEC_BMPString_S *o);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_cvtBMPString2wchar(const SEC_BMPString_S *inOcts, SEC_WCHAR **outStr)
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_INT SEC_cvtBMPString2wchar(const SEC_BMPString_S *inOcts, SEC_WCHAR **outStr);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32 SEC_cpyAsnBool(SEC_AsnBool* puiDstAsnBool,const SEC_AsnBool* puiSrcAsnBool)
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 SEC_cpyAsnBool(SEC_AsnBool *puiDstAsnBool, const SEC_AsnBool *puiSrcAsnBool);
 ...
 * @par Prototype
 * @code
 * SEC_AsnBool* SEC_dupAsnBool(const SEC_AsnBool* pbSrcAsnBool)
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_AsnBool *SEC_dupAsnBool(const SEC_AsnBool *pbSrcAsnBool);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_checkIA5String(const SEC_IA5String_S *octs)
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_INT SEC_checkIA5String(const SEC_IA5String_S *oct);
 ...
 * N/A
 */
PSELINKDLL void SEC_freeIA5String(SEC_IA5String_S *o);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32 SEC_cpyAsnInt(SEC_AsnInt* puiDstAsnInt,const SEC_AsnInt* puiSrcAsnInt)
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 SEC_cpyAsnInt(SEC_AsnInt *puiDstAsnInt, const SEC_AsnInt *puiSrcAsnInt);
 ...
 * @par Prototype
 * @code
 * SEC_AsnInt* SEC_dupAsnInt(const SEC_AsnInt* puiSrcAsnInt)
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_AsnInt *SEC_dupAsnInt(const SEC_AsnInt *puiSrcAsnInt);
 ...
 * @par Prototype
 * @code
 * SEC_AsnNull* SEC_dupAsnNull(const SEC_AsnNull *pcSrcNULL)
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_AsnNull *SEC_dupAsnNull(const SEC_AsnNull *pcSrcNULL);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32 SEC_cpyAsnNull(SEC_AsnNull *pcDstNULL,const SEC_AsnNull *pcSrcNULL)
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 SEC_cpyAsnNull(SEC_AsnNull *pcDstNULL, const SEC_AsnNull *pcSrcNULL);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_chkNumericString (const SEC_NumericString_S *checkBuf);
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_INT SEC_chkNumericString(const SEC_NumericString_S *checkBuf);
 ...
 * N/A
 */
PSELINKDLL void SEC_freeNumericString(SEC_NumericString_S *o);
 ...
 * N/A
 */
PSELINKDLL void SEC_freeAsnOcts(SEC_AsnOcts_S *v);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32 SEC_cpyAsnOcts(SEC_AsnOcts_S *pstDestAsnOcts, const SEC_AsnOcts_S *pstSrcAsnOcts)
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Note
 * Care should be taken in calls to SEC_cpyAsnOcts as it can deplete memory.
 * Memory Allocated should be freed using SEC_freeAsnOcts immediately  after use.
 * N/A
 *
 * @par Related Topics
 * N/A
 */
PSELINKDLL SEC_UINT32 SEC_cpyAsnOcts(SEC_AsnOcts_S *pstDestAsnOcts, const SEC_AsnOcts_S *pstSrcAsnOcts);
 ...
 * @par Prototype
 * @code
 * SEC_AsnOcts_S * SEC_dupAsnOcts(const SEC_AsnOcts_S *pstSrcAsnOcts)
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @par Note
 * Care should be taken in calls to SEC_dupAsnOcts as it can deplete memory.
 * Memory Allocated should be freed using SEC_freeAsnOcts immediately  after use.
 * N/A
 *
 * @par Related Topics
 * N/A
 */
PSELINKDLL SEC_AsnOcts_S *SEC_dupAsnOcts(const SEC_AsnOcts_S *pstSrcAsnOcts);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_cmpAsnOcts  (const SEC_AsnOcts_S *pstAsnOcts1, const SEC_AsnOcts_S *pstAsnOcts2);
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_INT SEC_cmpAsnOcts(const SEC_AsnOcts_S *o1, const SEC_AsnOcts_S *o2);
 ...
 * N/A
 */
PSELINKDLL void SEC_freeAsnOid(SEC_AsnOid_S *o);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32 SEC_cpyAsnOid(SEC_AsnOid_S *pstDestOID,const SEC_AsnOid_S *pstSrcOID)
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 SEC_cpyAsnOid(SEC_AsnOid_S *pstDestOID, const SEC_AsnOid_S *pstSrcOID);
 ...
 * @par Prototype
 * @code
 * SEC_BOOL SEC_compareOid(const SEC_AsnOid_S *pstDestOID, const SEC_AsnOid_S *pstSrcOID)
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_BOOL SEC_compareOid(const SEC_AsnOid_S *pstDestOID, const SEC_AsnOid_S *pstSrcOID);
 ...
 * @par Prototype
 * @code
 * SEC_AsnOid_S* SEC_dupAsnOid(const SEC_AsnOid_S *pstSrcOID)
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_AsnOid_S *SEC_dupAsnOid(const SEC_AsnOid_S *pstSrcOID);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_chkPrintableString(const SEC_PrintableString_S *checkBuf)
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_INT SEC_chkPrintableString(const SEC_PrintableString_S *pCheckBuf);
 ...
 * N/A
 */
PSELINKDLL void SEC_freePrintableString(SEC_PrintableString_S *o);
 ...
 * N/A
 */
PSELINKDLL void SEC_freeTeletexString(SEC_TeletexString_S *o);
 ...
 * N/A
 */
PSELINKDLL void SEC_freeUniversalString(SEC_UniversalString_S *o);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_cvtUniversalString2wchar(const SEC_UniversalString_S *inOcts, SEC_WCHAR **outStr)
 * @endcode
 *
 * @par Purpose
 ...
 * @retval SEC_INT Upon success [0|N/A]
 * @retval SEC_INT Upon failure [Less than zero|N/A]
 * @retval SEC_INT if inOcts->octetLen is greater than value set by SEC_setMaxPSEBuffSize.
 * By default this value is 10 MB [Less than zero|N/A]
 * @par Dependency
 * asn-util.h
 *
 * @par Note
 ...
 * N/A
 */
PSELINKDLL SEC_INT SEC_cvtUniversalString2wchar(const SEC_UniversalString_S *inOct, SEC_WCHAR **outStr);
 ...
 * N/A
 */
PSELINKDLL void SEC_freeUTCTime(SEC_UTCTime_S *o);
 ...
 * N/A
 */
PSELINKDLL void SEC_freeGeneralizedTime(SEC_GeneralizedTime_S *o);
 ...
 * @par Prototype
 * @code
 * SEC_UINT32 SEC_cpyGenTime(SEC_GeneralizedTime_S *pstDestGenTime,const SEC_GeneralizedTime_S *pstSrcGenTime)
 * @endcode
 *
 * @par Purpose
 * To copy one SEC_GeneralizedTime_S structure onto another.
 *
 * @par Description
 ...
 * N/A
 */
PSELINKDLL SEC_UINT32 SEC_cpyGenTime(SEC_GeneralizedTime_S *pstDestGenTime, const SEC_GeneralizedTime_S *pstSrcGenTime);
 ...
 * @par Prototype
 * @code
 * SEC_GeneralizedTime_S * SEC_dupGenTime(const SEC_GeneralizedTime_S *pstSrcGenTime)
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_GeneralizedTime_S *SEC_dupGenTime(const SEC_GeneralizedTime_S *pstSrcGenTime);
 ...
 * @par Prototype
 * @code
 * DATE_COMPARE_E SEC_compareGenTime(const SEC_GeneralizedTime_S *pstDestGenTime,
 * const SEC_GeneralizedTime_S *pstSrcGenTime,SEC_UINT32 *pulDiffSeconds)
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL DATE_COMPARE_E SEC_compareGenTime(const SEC_GeneralizedTime_S *pstDestGenTime,
    const SEC_GeneralizedTime_S *pstSrcGenTime, SEC_UINT32 *pulDiffSeconds);
 ...
 * @par Prototype
 * @code
 * SEC_GeneralizedTime_S* SEC_DateTimeToGenTime(const DATETIME_S* pDateTime)
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL SEC_GeneralizedTime_S *SEC_DateTimeToGenTime(const DATETIME_S *pDateTime);
 ...
 * @par Prototype
 * @code
 * DATETIME_S* SEC_GenTimeToDateTime(const SEC_GeneralizedTime_S* pGenTime)
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL DATETIME_S *SEC_GenTimeToDateTime(const SEC_GeneralizedTime_S *pGenTime);

SEC_INT SEC_GenTimeToDateTime_ex(const SEC_GeneralizedTime_S *pGenTime, DATETIME_S *pDateTime);
 ...
 * @par Prototype
 * @code
 * DATETIME_S* SEC_UTCTimeToDateTime(const SEC_UTCTime_S* pUTCTime)
 * @endcode
 *
 * @par Purpose
 ...
 * N/A
 */
PSELINKDLL DATETIME_S *SEC_UTCTimeToDateTime(const SEC_UTCTime_S *pUTCTime);
 ...
 * N/A
 */
PSELINKDLL void SEC_freeUTF8String(SEC_UTF8String_S *o);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_cvtUTF8String2wchar(const SEC_UTF8String_S *inOcts, SEC_WCHAR **outStr)
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @param[in] inOcts The UTF8String to be converted. Should be a NULL terminated String [N/A]
 ...
 * N/A
 */
PSELINKDLL SEC_INT SEC_cvtUTF8String2wchar(const SEC_UTF8String_S *pstOcts, SEC_WCHAR **dpOutStr);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_cvtUTF8towchar(const SEC_CHAR *utf8Str, SEC_WCHAR **outStr)
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @param[in] utf8Str The UTF8 structure to be converted. utf8Str must be null terminated buffer[N/A]
 ...
 * @retval SEC_INT In case of utf8Str is greater than value set by SEC_setMaxPSEBuffSize.
 * By default this value is 10 MB [Less than zero|N/A]
 * @par Dependency
 * asn-util.h
 *
 ...
 * N/A
 */
PSELINKDLL SEC_INT SEC_cvtUTF8towchar(const SEC_CHAR *pcUtf8Str, SEC_WCHAR **dpOutStr);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_cvtWchar2UTF8(const SEC_WCHAR *inStr, SEC_CHAR **utf8Str)
 * @endcode
 *
 * @par Purpose
 ...
 *
 * @param[in] inStr The Wide char structure to be converted. Suppports a max wchar string of length set by
 * SEC_setMaxPSEBuffSize.By default this value is 10 MB[N/A]
 ...
 * N/A
 */
PSELINKDLL SEC_INT SEC_cvtWchar2UTF8(const SEC_WCHAR *pInStr, SEC_CHAR **dpcUtf8Str);
 ...
 * @par Prototype
 * @code
 * SEC_INT SEC_isValidUTF8String(const SEC_UTF8String_S* octs)
 * @endcode
 *
 * @par Purpose
 ...
 * @retval SEC_INT If octs->octetLen is greater than value set by
 * SEC_setMaxPSEBuffSize. By default this value is 10 MB [FALSE|N/A]
 * @par Dependency
 * asn-util.h
 *
 * @par Note
 ...
 * N/A
 */
PSELINKDLL SEC_INT SEC_isValidUTF8String(const SEC_UTF8String_S *psOcts);
 ...
 * N/A
 */
PSELINKDLL void SEC_freeVisibleString(SEC_VisibleString_S *o);
 ...
 * @param[in] uiCount The number of items in aPvtOIDInfo array. It should in the range of [1,0xfffff] [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 * 4. This API is not thread safe. Should be called in single thread when no other module is using private OIDs.
 *
 * @par Related Topics
 * N/A
 */
