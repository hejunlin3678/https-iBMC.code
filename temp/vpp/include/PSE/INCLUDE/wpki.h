 ...
 * Description: Contains various wpki interface functions
                            ALL RIGHTS RESERVED
 ...
 *
 */
PSELINKDLL X509_CERT_S *WPKI_createCert(X509_CERTVERSION_E enVersion, SEC_BIGINT_S *pstCertSelNum,
 ...
 * pucEncodedExtn and  uiHashAlgID parameters. pcURL must be null terminated buffer. [N/A]
 ...
 *
 */
PSELINKDLL WPKI_DOMAIN_INFO_S *WPKIExtn_createDomainInfo(SEC_UINT32 uiStatusFlag, SEC_NAME_S *pstAuthId,
    SEC_CHAR *pcURL, SEC_UCHAR *pucEncodedExtn, SEC_UINT32 uiHashAlgID, SEC_UINT32 uiEncLen);
 ...
 *
 */
PSELINKDLL SEC_UINT32 WPKI_getCertUsage(X509_CERT_S *pstCertificate);
 ...
 * @par Prototype
 * @code
 * SEC_CHAR*  WPKI_getURLFromDomainInfo (const WPKI_DOMAIN_INFO_S* pstDomainInfo);
 * @endcode
 *
 * @par Purpose
 ...
 *
 */
PSELINKDLL SEC_CHAR *WPKI_getURLFromDomainInfo(const WPKI_DOMAIN_INFO_S *pstDomainInfo);
 ...
 * @par Prototype
 * @code
 * SEC_INT32  WPKI_getDomainInfoFlag(const WPKI_DOMAIN_INFO_S* pstDomainInfo)
 * @endcode
 *
 * @par Purpose
 ...
 *
 */
PSELINKDLL SEC_INT32 WPKI_getDomainInfoFlag(const WPKI_DOMAIN_INFO_S *pstDomainInfo);
 ...
 * @par Prototype
 * @code
 * SEC_NAME_S* WPKI_getRCAName (const WPKI_DOMAIN_INFO_S* pstDomainInfo);
 * @endcode
 *
 * @par Purpose
 ...
 *
 */
PSELINKDLL SEC_NAME_S *WPKI_getRCAName(const WPKI_DOMAIN_INFO_S *pstDomainInfo);
 ...
 * @retval SEC_UINT32 This error code is returned if there is mismatch in the signature OIDs in the X509_CERT_S
 * structure and SEC_TBSCERT_S structure. [SEC_ERR_OID_MISMATCH|N/A]
 ...
 * @par Prototype
 * @code
 * SEC_NAME_S* WPKI_createDN(SEC_UINT32 uiDNAttrLen, const X509_DN_ATTR_VALUE_S* pstDNAttrValue)
 * @endcode
 *
 * @par Purpose
 ...
 * @param[in] pstDNAttrValue Pointer to the array of structures.The string is not validated for String Type other than
 * Printable string. Should be NULL terminated string [N/A]
 * @param[out] N/A N/A [N/A]
 *
 ...
 *
 */
PSELINKDLL SEC_NAME_S *WPKI_createDN(SEC_UINT32 uiDNAttrLen, const X509_DN_ATTR_VALUE_S *pstDNAttrValue);
 ...
 *
 */
PSELINKDLL SEC_UINT32 WPKI_addExtnToCert(SEC_EXTN_S *pstExtension, const X509_CERT_S *pstCertificate);
 ...
 * @par Prototype
 * @code
 * SEC_BOOL  WPKI_verifyExtnDigest (const WPKI_DOMAIN_INFO_S* pstDomainInfo,
 * const SEC_UCHAR*  pucEncodedExtn,
 * SEC_UINT32  uiEncLen);
 * @endcode
 *
 * @par Purpose
 ...
 *
 */
PSELINKDLL SEC_BOOL WPKI_verifyExtnDigest(const WPKI_DOMAIN_INFO_S *pstDomainInfo, const SEC_UCHAR *pucEncodedExtn,
    SEC_UINT32 uiEncLen);
