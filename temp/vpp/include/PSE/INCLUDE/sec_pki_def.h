...
************************************************************************** */
#ifndef SEC_PKI_DEF_H
#define SEC_PKI_DEF_H
...
#define SEC_PKI_SHA_HASH_LEN 20
 ...
 * SEC_PKI_X509_CHECK_CERT_KEYUSAGE = 0x00000020,
 ...
 * SEC_PKI_CHECK_OCSP_ALL      = 0x00004000,
 * SEC_PKI_OCSP_RESPONDER_CHECK_CRL = 0x00008000,
 * SEC_PKI_OCSP_RESPONDER_CHECK_DELTA_CRL = 0x00010000,
 * SEC_PKI_CHECK_OCSP = 0x00020000
 ...
 * @datastruct SEC_PKI_X509_CHECK_CERT_KEYUSAGE Enables keyUsage extension validation.
 ...
 * @datastruct SEC_PKI_CHECK_OCSP_ALL Enables OCSP validation for entire chain
 ...
 * @datastruct SEC_PKI_X509_CHECK_CERT_KEY_ENCIPHER_KEYUSAGE Enables Encryption Cert keyUsage extension validation
 */
typedef enum {
    SEC_PKI_CHECK_TIME = 0x00000001,
    SEC_PKI_CHECK_CRL = 0x00000002,
    ...
    SEC_PKI_EXTENDED_CRL_SUPPORT = 0x00000100,
    SEC_PKI_OBJ_CRL_SUPPORT = 0x00000200,
    SEC_PKI_CHECK_TIME_STRICK = 0x00000400,
    SEC_PKI_CRL_SELECT_RULE_NEWEST = 0x00000800,
    SEC_PKI_CHECK_WITH_VERIFY_STORE = 0x00001000,
    SEC_PKI_CHECK_PARTIAL_CHAIN = 0x00002000,
    SEC_PKI_CHECK_OCSP_ALL = 0x00004000,
    SEC_PKI_OCSP_RESPONDER_CHECK_CRL = 0x00008000,
    SEC_PKI_OCSP_RESPONDER_CHECK_DELTA_CRL = 0x00010000,
    SEC_PKI_CHECK_OCSP = 0x00020000,
    SEC_PKI_X509_CHECK_CERT_KEY_ENCIPHER_KEYUSAGE = 0x00040000
} SEC_PKI_VERIFY_TYPE_E;
...
* @datastruct SEC_PKI_TYPE_IPADDRESS IP addr as subject alternative name.
 ...
 * typedef enum
 * {
 * SEC_ALG_RSA equal to ALGID_RSA,
 * SEC_ALG_DSA equal to ALGID_DSA,
 * SEC_ALG_ECDSA equal to ALGID_ECDSA,
 * SEC_ALG_ED25519 equal to ALGID_ED25519
...
typedef enum enPKIX509AlgID {
    ...
    SEC_ALG_ED25519 = ALGID_ED25519 /* Algorithm type ED25519 */
} SEC_PKI_X509_ALG_TYPE_E;
...
/**
 * @defgroup SEC_PKI_X509_STORE_S
 * @ingroup Structures
 * @par Description
 * This structure holds the x509 store.
 * @par Prototype
 * @code
 * typedef struct stPKI_X509_STORE SEC_PKI_X509_STORE_S;
 * @endcode
 *
 */
typedef struct stPKI_X509_STORE SEC_PKI_X509_STORE_S;
...
/**
 * @defgroup SEC_PKI_LOAD_CA_CONIF_E
 * @ingroup Enums
 * @par Description
 * Indicates the configuration of CA loading.
 * @par Prototype
 * @code
 * typedef enum
 * {
 * SEC_PKI_DISABLE_LOAD_SAME_NAME_CA,
 * SEC_PKI_ALLOW_LOAD_SAME_NAME_CA
 * }SEC_PKI_LOAD_CA_CONIF_E;
 * @endcode
 * @datastruct SEC_PKI_DISABLE_LOAD_SAME_NAME_CA Disable loading of same name CA.
 * @datastruct SEC_PKI_ALLOW_LOAD_SAME_NAME_CA Enable loading of same name CA.
 *
 */
typedef enum {
    SEC_PKI_DISABLE_LOAD_SAME_NAME_CA,
...
#undef X509_V_ERR_DIFFERENT_CRL_SCOPE
#undef X509_V_ERR_CRL_PATH_VALIDATION_ERROR
#undef X509_V_ERR_NO_CERT_IN_CA_STORE
/* END */
...
#define X509_V_ERR_ERROR_IN_CMP_CERT_NOT_BEFORE_FIELD 48
...
/* 证书状态不属于OCSP_CERT_STATUS_TYPE_E宏内定义的错误 */
#define X509_V_ERR_CERT_STATUS_ERROR_BY_OCSP_RESP 114

/* 版本错误 */
#define X509_V_ERR_RESPONSE_VERSION_ERROR_IN_OCSP_RESP 115

/* producedAt错误 */
#define X509_V_ERR_ERROR_IN_OCSP_RESP_PRODUCE_AT_FIELD 116

/* revocationTime错误 */
#define X509_V_ERR_ERROR_IN_OCSP_RESP_REVOCATION_TIME_FIELD 117
...
typedef struct stPKICertCryptFields {
    ...
    SEC_UCHAR aucSha1Hash[SEC_PKI_SHA_HASH_LEN];
...
typedef enum SEC_PKI_CertType {
    SEC_PKI_VERIFY_OBJ_DFLT_CERT
} SEC_PKI_CERT_TYPE_E;
typedef enum SEC_PKI_VerifyScenario {
    SEC_PKI_KEYUSAGE_WITH_KEY_ENCIPHERMENT = 0x0020,
    SEC_PKI_KEYUSAGE_WITH_ANY_DIGITAL_SIGN = (0x0080 | 0x0040)
} SEC_PKI_VERIFY_SCENARIO_E;

typedef SEC_INT(SEC_PKI_EXTERN_VERIFY_CALLBACK)(SEC_EXTN_S *pstExtn, SEC_VOID *pAppPtr);
