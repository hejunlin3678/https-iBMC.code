 ...
 * Description: IPSI SCEP objects declarations
 * Create: 04-06-2010
Function List: IPSI_SCEP_ObjSetMaxRACACerts
               IPSI_SCEP_ObjSetExtraCertsCB
               IPSI_SCEP_ObjSetFingerPrintCB
               IPSI_SCEP_ObjSetDebugMsgCB
               IPSI_SCEP_setDebugMsgCB
               IPSI_SCEP_ObjFreeAllRequest
               IPSI_SCEP_ObjClientDoGetCrlReq
               IPSI_SCEP_FreeRespMsg
               IPSI_SCEP_ObjClientHandleError
               IPSI_SCEP_ObjClientDoGetNextCAReq
               IPSI_SCEP_ObjClientDoGetCACapsReq
               ...
               IPSI_SCEP_ObjLoadCARACert
               IPSI_SCEP_ObjGetFingerPrint
...
----------------------------------------------------------------------------
*************************************************************************** */
#ifndef IPSI_SCEP_OBJECT_H
#define IPSI_SCEP_OBJECT_H
...
// IPSI_SCEP_ALLOW_MULTIPLE_RACA will be used to allow multiple CA with Max 2RA in the response of GextCACert
// request.
#define IPSI_SCEP_ALLOW_MULTIPLE_RACA 4
 ...
 * 	- The default value
 * for the digest & encryption algorithm will be set to 0,
 * Application need to configure the digest & encryption algorithm using IPSI_SCEP_ObjSetAlgo API.
 *
 * @par Related Topic
 * IPSI_SCEP_ObjFree
 * IPSI_SCEP_ObjSetAlgo
...
*/
PSELINKDLL
SEC_INT IPSI_SCEP_ObjSetAlgo(IPSI_SCEP_OBJ_S *pstScepObj, SEC_UINT uiDigestAlgo, SEC_UINT uiCEAlgo);
...
* @par Prototype
* @code
* SEC_INT IPSI_SCEP_ObjGetAlgo(const IPSI_SCEP_OBJ_S *pstScepObj,
                          SEC_UINT *puiDigestAlgo,  SEC_UINT *puiCEAlgo)
*
* @endcode
*
* @par Purpose
* IPSI_SCEP_ObjGetAlgo gives the algorithms from the SCEP object.
* @par Description
* IPSI_SCEP_ObjGetAlgo gives the digest algorithm and encryption
* algorithm from the SCEP object. If no algorithms have been set by the user
* using IPSI_SCEP_ObjSetAlgo API, then the default value 0 for
* digest & encryption algorithm which is
...
*/
PSELINKDLL
SEC_INT IPSI_SCEP_ObjGetAlgo(const IPSI_SCEP_OBJ_S *pstScepObj, SEC_UINT *puiDigestAlgo, SEC_UINT *puiCEAlgo);
...
* SEC_INT IPSI_SCEP_ObjSetFingerPrint( IPSI_SCEP_OBJ_S *pstScepObj,
                                     const IPSI_SCEP_FINGER_PRINT_S *pstFingerPrint)
*
* @endcode
*
* @par Purpose
...
*/
PSELINKDLL
SEC_INT IPSI_SCEP_ObjSetFingerPrint(IPSI_SCEP_OBJ_S *pstScepObj, const IPSI_SCEP_FINGER_PRINT_S *pstFingerPrint);
...
* @par Prototype
* @code
* SEC_INT IPSI_SCEP_ObjGetFingerPrint(const IPSI_SCEP_OBJ_S *pstScepObj,
                                 IPSI_SCEP_FINGER_PRINT_S* pstFingerPrint)
*
* @endcode
*
* @par Purpose
* IPSI_SCEP_ObjGetFingerPrint gives the finger print for the SCEP object.
* @par Description
* IPSI_SCEP_ObjGetFingerPrint gives the finger print for the SCEP object.
...
*/
PSELINKDLL
SEC_INT IPSI_SCEP_ObjGetFingerPrint(const IPSI_SCEP_OBJ_S *pstScepObj, IPSI_SCEP_FINGER_PRINT_S *pstFingerPrint);
...
* IPSI_SCEP_ObjNew
*/
PSELINKDLL SEC_INT IPSI_SCEP_ObjLoadCARACert(IPSI_SCEP_OBJ_S *pstScepObj, IPSI_SCEP_CA_RA_CERT_S *pstCaRaCerts);
...
* SEC_INT IPSI_SCEP_ObjLoadClientCertKeyFile(IPSI_SCEP_OBJ_S *pstScepObj,
                                 const IPSI_SCEP_CERTKEY_CONF_S *pstCertKeyConf,
...
*        then need to call API IPSI_setPemMaxSize. Please refer to PSE developer guide for API description.
...
*/
PSELINKDLL
SEC_INT IPSI_SCEP_ObjLoadClientCertKeyFile(IPSI_SCEP_OBJ_S *pstScepObj, const IPSI_SCEP_CERTKEY_CONF_S *pstCertKeyConf,
    PEM_WARNING_CODE_E *peWarningCode);
...
*/
PSELINKDLL
SEC_INT IPSI_SCEP_ObjLoadClientCertKeyBuf(IPSI_SCEP_OBJ_S *pstScepObj, IPSI_SCEP_CERTKEY_BUFF_CONF_S *pstCertKeyConf,
    PEM_WARNING_CODE_E *peWarningCode);
...
*/
PSELINKDLL
SEC_INT IPSI_SCEP_ObjLoadClientCertKey(IPSI_SCEP_OBJ_S *pstScepObj, X509_CERT_S *pstCert, SEC_PKEY_S *pstKey);
...
* @par Prototype
* @code
* SEC_INT IPSI_SCEP_ObjGetClientCertKey(const IPSI_SCEP_OBJ_S *pstScepObj,
                                X509_CERT_S** dpstCert, SEC_PKEY_S** dpstKey)
*
* @endcode
*
* @par Purpose
* IPSI_SCEP_ObjGetClientCertKey gives the client certificate and private key
* from the SCEP object into the variables dpstCert and dpstKey.
*
* @par Description
* IPSI_SCEP_ObjGetClientCertKey gives the client certificate and key
* into the SCEP object. The client certificate and key are overridden.
*
* @param[in] pstScepObj Pointer to SCEP object.[NA/NA]
...
*/
PSELINKDLL
SEC_INT IPSI_SCEP_ObjGetClientCertKey(const IPSI_SCEP_OBJ_S *pstScepObj, X509_CERT_S **dpstCert, SEC_PKEY_S **dpstKey);
...
*/
PSELINKDLL
SEC_INT IPSI_SCEP_ObjClientDoGetCAReq(IPSI_SCEP_OBJ_S *pstScepObj, SEC_UINT uiRequestId, SEC_UCHAR *pucCAIssuerId,
    SEC_UINT uiCAIssuerIdLen);
...
*/
PSELINKDLL
SEC_INT IPSI_SCEP_ObjClientHandleResp(IPSI_SCEP_OBJ_S *pstScepObj, SEC_UINT uiRequestId, SEC_UCHAR *pucBuf,
    SEC_UINT uiLen, SEC_VOID *pData, IPSI_SCEP_RESP_MSG_S *pstRespMsg);
...
*        will return error.
*   - If application does not set seeds and entropy on frequent intervals, it can lead to vulnerable keys or random
*     value. It is recommended to set seeds and entropy on frequent intervals or update the version that migrate random
...
*/
PSELINKDLL
SEC_INT IPSI_SCEP_ObjClientDoGetCertReq(IPSI_SCEP_OBJ_S *pstScepObj, SEC_UINT uiRequestId, SEC_NAME_S *pstIssuerName,
    SEC_BIGINT_S *pstSerial);
 ...
 */
PSELINKDLL
SEC_INT IPSI_SCEP_ObjClientDoEnrollCertReq(IPSI_SCEP_OBJ_S *pstScepObj, SEC_UINT uiRequestId,
    IPSI_SCEP_ENROLL_CERT_IN_PARAM_S *pstEnrollCertParam, IPSI_SCEP_ENROLL_CERTOBJ_S **dpstEnrollObj,
    PKCS10_REQ_S **dpstPKCSReq);
 ...
 * IPSI_SCEP_OBJ_S *pstScepObj,
 * SEC_UINT uiRequestId,
 * const IPSI_SCEP_ENROLL_CERTOBJ_S *pstEnrollObj)
 *
 * @endcode
 *
 * @par Purpose
 ...
 */
PSELINKDLL
SEC_INT IPSI_SCEP_ObjClientDoGetCertInitialReq(IPSI_SCEP_OBJ_S *pstScepObj, SEC_UINT uiRequestId,
    const IPSI_SCEP_ENROLL_CERTOBJ_S *pstEnrollObj);
 ...
 * @par Prototype
 * @code
 * SEC_VOID IPSI_SCEP_freeEnrollCertObj(
...
*/
PSELINKDLL
SEC_INT IPSI_SCEP_ObjClientDoGetCACapsReq(IPSI_SCEP_OBJ_S *pstScepObj, SEC_UINT uiRequestId, SEC_UCHAR *pucCAIssuerId,
    SEC_UINT uiCAIssuerIdLen);
...
*/
PSELINKDLL
SEC_INT IPSI_SCEP_ObjClientDoGetNextCAReq(IPSI_SCEP_OBJ_S *pstScepObj, SEC_UINT uiRequestId, SEC_UCHAR *pucCAIssuerId,
    SEC_UINT uiCAIssuerIdLen);
...
*/
PSELINKDLL
SEC_INT IPSI_SCEP_ObjClientHandleError(IPSI_SCEP_OBJ_S *pstScepObj, SEC_UINT uiRequestId, SEC_UINT uiErr);
...
*/
PSELINKDLL
SEC_INT IPSI_SCEP_ObjClientDoGetCrlReq(IPSI_SCEP_OBJ_S *pstScepObj, SEC_UINT uiRequestId, SEC_NAME_S *pstIssuerName,
    SEC_BIGINT_S *pstSerial);
 ...
 *
 * @par Purpose
 * This is the prototype of dbg message callback function.
 *
 * @par Description
 * IPSI_SCEP_DEBUG_MSG_CB provides the prototype of SCEP dbg message
 * callback function which will be called when SCEP message is sent.
 *
 * @param[in] pstScepObj Pointer to scep object. [NA/NA]
 * @param[in] pucDebugBuf Pointer to dbg message buffer.[NA/NA]
 * @param[in] uiBufLen Length of the dbg message buffer. [NA/NA]
 ...
 *
 */
typedef SEC_INT (*IPSI_SCEP_DEBUG_MSG_CB)(IPSI_SCEP_OBJ_S *pstScepObj, SEC_UCHAR *pucDebugBuf, SEC_UINT uiBufLen,
    SEC_INT iLevel, SEC_VOID *pvUserData);
...
*
* @par Purpose
* This function is used to register the dbg message callback function with
* the global structure.
*
* @par Description
* IPSI_SCEP_setDebugMsgCB function registers the dbg message callback function
* with the global structure.
*
* @param[in] pfDebugMsgCB Dbg Message Callback [NA/NA]
* @param[in] pvUserData Pointer to user specific data. You can pass your
...
*
*/
PSELINKDLL SEC_INT IPSI_SCEP_setDebugMsgCB(IPSI_SCEP_DEBUG_MSG_CB pfDebugMsgCB, SEC_VOID *pvUserData);
...
*
* @par Purpose
* This function is used to register the dbg message callback function
* with the object.
*
* @par Description
* IPSI_SCEP_setDebugMsgCB function registers the dbg message callback
...
*
*/
PSELINKDLL SEC_INT IPSI_SCEP_ObjSetDebugMsgCB(IPSI_SCEP_OBJ_S *pstScepObj, IPSI_SCEP_DEBUG_MSG_CB pfDebugMsgCB,
    SEC_VOID *pvUserData);
 ...
 *
 */
typedef SEC_INT (*IPSI_SCEP_CA_FINGERPRINT_CB)(IPSI_SCEP_OBJ_S *pstScepObj, SEC_UINT uiRequestId,
    X509_CERT_S *pstCACert, SEC_VOID *pvUserData);
 ...
 *
 */
PSELINKDLL SEC_INT IPSI_SCEP_ObjSetFingerPrintCB(IPSI_SCEP_OBJ_S *pstScepObj, IPSI_SCEP_CA_FINGERPRINT_CB pfCAFngPrnCB,
    SEC_VOID *pvUserData);

/**
 * @defgroup IPSI_SCEP_EXTRA_CERT_CB
 * @ingroup Callback_Functions
 * @par Prototype
 * @code
 * typedef void (*IPSI_SCEP_EXTRA_CERT_CB)(IPSI_SCEP_OBJ_S *pstScepObj,
 * SEC_List_S * pstExtraCertList,
 * SEC_VOID *pvUserData);
 * @endcode
 *
 * @par Purpose
 * This is the prototype of Extra certificate callback function.
 *
 * @par Description
 * IPSI_SCEP_EXTRA_CERT_CB provides the prototype of SCEP extra certificate
 * callback function which will be called during GetCA operation.
 * This callback function will be called when the server response  having RA and CA certificates .
 * CA certificates other than issuer of RA will be provided in this callback
 *
 * @param[in] pstScepObj Pointer to scep object. [NA/NA]
 * @param[in] pstExtraCertList Pointer to list having extra certificate received from server.[NA/NA]
 * @param[in] pvUserData Pointer to user specific data. You can pass your
 * own pointer to pUserData. Same pointer will be passed
 * when callback is called. This parameter is provided if
 * you want to use any of the application
 ...
 * @par Note
 * \n
 * pstExtraCertList is the list of  x509 certificate and application should free this certifacte list using
 * SEC_LIST_FREE and X509_freeCert as free function.
 */
typedef void (*IPSI_SCEP_EXTRA_CERT_CB)(IPSI_SCEP_OBJ_S *pstScepObj, SEC_List_S *pstExtraCertList,
    SEC_VOID *pvUserData);

/**
 * @defgroup IPSI_SCEP_ObjSetExtraCertsCB
 * @ingroup Callback_Functions
 * @par Prototype
 * @code
 * SEC_INT IPSI_SCEP_ObjSetExtraCertsCB(IPSI_SCEP_OBJ_S *pstScepObj,
 * IPSI_SCEP_EXTRA_CERT_CB pfCAExtraCertCB,
 * SEC_VOID* pvUserData)
 * @endcode
 *
 * @par Purpose
 * This function is used to register the extra certiifcate callback function with the object.
 *
 * @par Description
 * IPSI_SCEP_ObjSetExtraCertsCB is used to register the Extra certifcate callback function with the object.
 * This callback function will be called when the server response  having RA and CA
 * certificates. CA certificates other than issuer of RA will be provided in this callback.
 *
 * @param[in] pstScepObj Pointer to object.[NA/NA]
 * @param[in] pfCAExtraCertCB Extra certificate Callback. [NA/NA]
 * @param[in] pvUserData Pointer to user specific data.
 * The same pointer will be returned when the callback is called [NA/NA]
 * @param[out] NA NA [NA/NA]
 *
 ...
 *
 */
PSELINKDLL SEC_INT IPSI_SCEP_ObjSetExtraCertsCB(IPSI_SCEP_OBJ_S *pstScepObj, IPSI_SCEP_EXTRA_CERT_CB pfCAExtraCertCB,
    SEC_VOID *pvUserData);

/**
 * @defgroup IPSI_SCEP_ObjSetMaxRACACerts
 * @ingroup Callback_Functions
 * @par Prototype
 * @code
 * SEC_INT IPSI_SCEP_ObjSetMaxRACACerts(IPSI_SCEP_OBJ_S *pstScepObj, SEC_UINT32 uiMaxRACA)
 *
 * @endcode
 *
 * @par Purpose
 * This function is used set max limit for RA CA List
 *
 * @par Description
 * IPSI_SCEP_ObjSetMaxRACACerts is used set Max RA CA List , Default value is 1000
 *
 * @param[in] pstScepObj Pointer to object.[NA/NA]
 * @param[in] uiMaxRACA  Maximum certificate allowed in RA CA list [NA/NA]
 * @param[out] NA NA [NA/NA]
 *
 * @retval SEC_INT If the set is successful. [IPSI_SCEP_SUCCESS|NA]
 * @retval SEC_INT If it fails to set. [IPSI_SCEP_ERROR|NA]
 */
PSELINKDLL SEC_INT IPSI_SCEP_ObjSetMaxRACACerts(IPSI_SCEP_OBJ_S *pstScepObj, SEC_UINT32 uiMaxRACA);
