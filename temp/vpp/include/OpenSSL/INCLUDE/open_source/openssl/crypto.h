...
# define CRYPTO_EX_INDEX_SM9_KEY         18
# define CRYPTO_EX_INDEX__COUNT          19          // 18->19,CRYPTO_EX_INDEX_SM9_KEY need less than CRYPTO_EX_INDEX__COUNT
...
int CRYPTO_set_mem_functions_alt(CRYPTO_malloc_fn malloc_fn,
