...
EVP_RAND *EVP_RAND_fetch(OSSL_LIB_CTX *libctx, const char *algorithm,
                         const char *properties);
int EVP_RAND_up_ref(EVP_RAND *erand);
void EVP_RAND_free(EVP_RAND *erand);
const char *EVP_RAND_get0_name(const EVP_RAND *erand);
const char *EVP_RAND_get0_description(const EVP_RAND *md);
int EVP_RAND_is_a(const EVP_RAND *erand, const char *name);
const OSSL_PROVIDER *EVP_RAND_get0_provider(const EVP_RAND *erand);
int EVP_RAND_get_params(EVP_RAND *erand, OSSL_PARAM params[]);

EVP_RAND_CTX *EVP_RAND_CTX_new(EVP_RAND *erand, EVP_RAND_CTX *parent);
void EVP_RAND_CTX_free(EVP_RAND_CTX *ctx);
EVP_RAND *EVP_RAND_CTX_get0_rand(EVP_RAND_CTX *ctx);
int EVP_RAND_CTX_get_params(EVP_RAND_CTX *ctx, OSSL_PARAM params[]);
int EVP_RAND_CTX_set_params(EVP_RAND_CTX *ctx, const OSSL_PARAM params[]);
const OSSL_PARAM *EVP_RAND_gettable_params(const EVP_RAND *erand);
const OSSL_PARAM *EVP_RAND_gettable_ctx_params(const EVP_RAND *erand);
const OSSL_PARAM *EVP_RAND_settable_ctx_params(const EVP_RAND *erand);
const OSSL_PARAM *EVP_RAND_CTX_gettable_params(EVP_RAND_CTX *ctx);
const OSSL_PARAM *EVP_RAND_CTX_settable_params(EVP_RAND_CTX *ctx);

void EVP_RAND_do_all_provided(OSSL_LIB_CTX *libctx,
                              void (*fn)(EVP_RAND *erand, void *arg),
                              void *arg);
int EVP_RAND_names_do_all(const EVP_RAND *erand,
                          void (*fn)(const char *name, void *data),
                          void *data);
...
int EVP_PKEY_CTX_set_sm2_param(EVP_PKEY_CTX *pctx, EVP_MD *md, int server,
                               ...
                               EVP_PKEY *peer_ecdhe_key, EVP_PKEY *self_ecdhe_key);
#endif
