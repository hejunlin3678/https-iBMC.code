...
/* flag 1: pubkey decode by provider,
 * flag 0: pubkey decode by ameth directly.
 * By default, the public key is parsed through the provider.
 * This feature is avaliable just when the engine is enable.
 */
void X509_pubkey_decode_prov_flag(int flag);
#endif
# ifdef  __cplusplus
}
# endif
