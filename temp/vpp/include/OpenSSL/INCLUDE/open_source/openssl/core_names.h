...
#define OSSL_CIPHER_PARAM_TTO_SET_IV_INV       "ttoivinv"     /* octet_string */
...
#define OSSL_PKEY_SM9_USER_ID          "user_id" /* octet string */
#define OSSL_PKEY_SM9_KEY_USAGE        "key_usage" /* int */
#define OSSL_PKEY_SM9_G1_POINT_UNCOMPRESSED          "ecc_point_uncompressed" /* octet string */
#define OSSL_PKEY_SM9_G2_POINT_UNCOMPRESSED          "point_t_uncompressed" /* octet string */
