...
# define ERR_LIB_SM9             62
# define ERR_LIB_PQC             63
# define ERR_LIB_PQC_HYBRID      64
...
# define ERR_R_SM9_LIB          (ERR_LIB_SM9/* 44 */ | ERR_RFLAG_COMMON)
...
# define ERR_R_PQC_HYBRID_LIB   (ERR_LIB_PQC_HYBRID/* 64 */ | ERR_RFLAG_COMMON)
...
# endif
#endif
#ifdef VPP_CRYPTO_COMPILE
void ERR_put_error(int lib, int func, int reason, const char *file, int line);
#define ERR_raise(lib, reason) ERR_put_error((lib),0,(reason),NULL,0)
#endif
