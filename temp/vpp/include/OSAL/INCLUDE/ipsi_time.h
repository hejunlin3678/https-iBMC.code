...
#ifndef __IPSI_TIME_H__
#define __IPSI_TIME_H__
...
/*
    ...
    @retval         pstTime   On Success
                    NULL   On Failure
*/
IPSILINKDLL struct tm *ipsi_gmtime(const ipsi_time_t lTime, struct tm *pstTime);
 ...
 *                                                                              *
 *******************************************************************************/
IPSILINKDLL DATE_COMPARE_E ipsi_comparedates(const DATETIME_S *pDateA, const DATETIME_S *pDateB,
                                             unsigned int *pDiffSeconds);
...
*/
IPSILINKDLL int ipsi_localtime(const ipsi_time_t *timer, struct tm *localTime);
...
*/
IPSILINKDLL int ipsi_asctime(const struct tm *pstTime, char *pcAscTime, size_t uiSize);
