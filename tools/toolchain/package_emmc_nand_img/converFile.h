...
#define FLASH_MAX_SIZE 0x1000000 * 192 /*128M*/
...
VOS_INT32 ConversionKernelRFFile(FILE *pifile, VOS_UINT32 ulFileSize, VOS_CHAR *pDataBuffer, VOS_UCHAR ucIndex);
VOS_INT32 ConversionUBootFile(FILE *pifile, VOS_UINT32 ulFileSize, VOS_CHAR *pDataBuffer, VOS_UCHAR ucIndex);
VOS_INT32 ConversionWBSABMCFile(FILE *pifile, VOS_UINT32 ulFileSize, VOS_CHAR *pDataBuffer, VOS_UCHAR ucIndex);
VOS_INT32 Conversion852TFile(FILE *pifile, VOS_UINT32 ulFileSize, VOS_CHAR *pDataBuffer, VOS_UCHAR ucIndex);
