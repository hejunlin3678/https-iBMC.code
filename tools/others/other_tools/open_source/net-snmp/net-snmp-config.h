...
#define NETSNMP_CONFIGURE_OPTIONS " '--with-sysroot=/opt/RTOS/208.5.0/arm32A9le_5.10_ek_preempt_pro/sdk' 'CFLAGS=-fstack-protector-strong -Wl,-z,relro,-z,now' 'CPPFLAGS=-I/opt/RTOS/208.5.0/arm32A9le_5.10_ek_preempt_pro/sdk/usr/include -fstack-protector-strong -Wl,-z,relro,-z,now' 'LDFLAGS=-L/opt/RTOS/208.5.0/arm32A9le_5.10_ek_preempt_pro/sdk/usr/lib -L/opt/RTOS/208.5.0/arm32A9le_5.10_ek_preempt_pro/sdk/lib -Wl,-z,relro,-z,now -ldl' '--host=arm-linux-gnueabi' '--with-endianness=little' '--disable-manuals' '--disable-mib-loading' '--with-transports=UDP' '--without-kmem-usage' '--disable-scripts' '--enable-ipv6' '--disable-embedded-perl' '--with-default-snmp-version=3' '--with-sys-contact=http://support.huawei.com' '--with-sys-location=server room' '--with-logfile=/dev/null' '--with-persistent-directory=/var/net-snmp' '--prefix=/home/3rd' '--disable-perl-cc-checks' '--without-perl-modules' '--disable-debugging' '--enable-blumenthal-aes' 'host_alias=arm-linux-gnueabi' 'CC=arm32-linux-gnueabi-gcc'"
...
#define NETSNMP_DEFAULT_MIBDIRS "$HOME/.snmp/mibs:/home/3rd/share/snmp/mibs"
...
#define SNMPLIBPATH "/home/3rd/lib/snmp"
#define SNMPSHAREPATH "/home/3rd/share/snmp"
#define SNMPCONFPATH "/home/3rd/etc/snmp"
#define SNMPDLMODPATH "/home/3rd/lib/snmp/dlmod"
...
#define NETSNMP_SYS_CONTACT "http://support.huawei.com"

/* system location */
#define NETSNMP_SYS_LOC "server room"
