...
/* asymmetic error */
#define WSEC_ERR_EVP_PKEY_CTX_NEW_ID_FAILED                    WSEC_ERROR_CODE(900)  /* Create evp pkey context failed. */
#define WSEC_ERR_EVP_PKEY_KEYGEN_INIT_FAILED                   WSEC_ERROR_CODE(901)  /* Evp pkey context init failed. */
#define WSEC_ERR_EVP_PKEY_KEYGEN_FAILED                        WSEC_ERROR_CODE(902)  /* Evp pkey keygen failed. */
#define WSEC_ERR_EVP_PKEY_GET_RAW_PUBPRI_KEY_FAILED            WSEC_ERROR_CODE(903)  /* Get evp pkey raw public or private failed. */
#define WSEC_ERR_RSA_PKEY_CTX_CTRL_FAILED                      WSEC_ERROR_CODE(904)  /* Set rsa key bits failed. */
#define WSEC_ERR_EVP_PKEY_PARAMGEN_INIT_FAILED                 WSEC_ERROR_CODE(905)  /* Evp pkey parameters init failed. */
#define WSEC_ERR_EVP_PKEY_CTX_NEW_FAILED                       WSEC_ERROR_CODE(906)  /* Create evp pkey ctx failed. */
#define WSEC_ERR_EVP_PKEY_CTX_CTRL_FAILED                      WSEC_ERROR_CODE(907)  /* Set pkey paramgen curve nid failed. */
#define WSEC_ERR_EC_POINT_GET_AFFINE_COORDINATES_FAILED        WSEC_ERROR_CODE(908)  /* Ecc get public key x and y failed. */
#define WSEC_ERR_ECC_KEYPARTS_MALLOC_FAILED                    WSEC_ERROR_CODE(909)  /* Ecc keyParts Malloc failed. */
#define WSEC_ERR_BN_BN2BINPAD_FAILED                           WSEC_ERROR_CODE(910)  /* Bignum to binary failed. */
#define WSEC_ERR_EVP_PKEY_ASSIGN_FAILED                        WSEC_ERROR_CODE(911)  /* Evp pkey assign failed. */
#define WSEC_ERR_EVP_MD_CTX_NEW_FAILED                         WSEC_ERROR_CODE(912)  /* Create evp md ctx failed. */
#define WSEC_ERR_EVP_DIGEST_SIGN_INIT_FAILED                   WSEC_ERROR_CODE(913)  /* Evp sign init failed. */
#define WSEC_ERR_EVP_DIGEST_UPDATE_FAILED                      WSEC_ERROR_CODE(914)  /* Evp digest sign update failed. */
#define WSEC_ERR_SIGN_FAILED                                   WSEC_ERROR_CODE(915)  /* Asym Key sign final failed */
#define WSEC_ERR_VERIFY_FAILED                                 WSEC_ERROR_CODE(916)  /* Asym Key verify final failed */
#define WSEC_ERR_GET_ECC_SIGN_MD_BY_ALGO_FAILED                WSEC_ERROR_CODE(917)  /* Get Ecc Sign MD by algo failed. */
#define WSEC_ERR_BN_BIN2BN_FAILED                              WSEC_ERROR_CODE(918)  /* Binary to bignum failed. */
#define WSEC_ERR_EXTRACT_BUFF_FAILED                           WSEC_ERROR_CODE(919)  /* Extract buff failed. */
#define WSEC_ERR_EC_KEY_SET_PUB_KEY_FAILED                     WSEC_ERROR_CODE(920)  /* Ecc key set public failed. */
#define WSEC_ERR_EC_KEY_SET_PRIVATE_KEY_FAILED                 WSEC_ERROR_CODE(921)  /* Ecc key set private failed. */
#define WSEC_ERR_EVP_PKEY_SET1_EC_KEY_FAILED                   WSEC_ERROR_CODE(922)  /* Evp pkey set ec key failed. */
#define WSEC_ERR_EVP_MD_METH_DUP_FAILED                        WSEC_ERROR_CODE(923)  /* Duplicate EVP_MD failed. */
#define WSEC_ERR_EVP_PKEY_CTX_SET_RSA_PADDING_FAILED           WSEC_ERROR_CODE(924)  /* Evp pkey sign set padding failed. */
#define WSEC_ERR_EVP_PKEY_CTX_SET_SIGNATURE_MD_FAILED          WSEC_ERROR_CODE(925)  /* Evp pkey set sign md failed. */
#define WSEC_ERR_EVP_PKEY_NEW_FAILED                           WSEC_ERROR_CODE(926)  /* Create new evp pkey failed. */
#define WSEC_ERR_RSA_NEW_FAILED                                WSEC_ERROR_CODE(927)  /* Rsa new failed. */
#define WSEC_ERR_RSA_SET0_KEY_FAILED                           WSEC_ERROR_CODE(928)  /* Rsa set parts failed. */
#define WSEC_ERR_GET_OP_PARAM_FAILED                           WSEC_ERROR_CODE(929)  /* Not support algo. */
#define WSEC_ERR_COMPUTE_DIGEST_FAILED                         WSEC_ERROR_CODE(930)  /* Sign Compute digest failed. */
#define WSEC_ERR_EVP_PKEY_SIGN_INIT_FAILED                     WSEC_ERROR_CODE(931)  /* Evp pkey sign init failed. */
#define WSEC_ERR_EVP_DIGEST_VERIFY_INIT_FAILED                 WSEC_ERROR_CODE(932)  /* Evp digest verify init failed. */
#define WSEC_ERR_EVP_PKEY_SET_ALIAS_TYPE_FAILED                WSEC_ERROR_CODE(933)  /* Evp pkey set alias type failed. */
#define WSEC_ERR_EVP_PKEY_ENCRYPT_INIT_FAILED                  WSEC_ERROR_CODE(934)  /* Evp pkey encrypt init failed. */
#define WSEC_ERR_EVP_PKEY_ENCRYPT_FAILED                       WSEC_ERROR_CODE(935)  /* Evp pkey encrypt failed. */
#define WSEC_ERR_EVP_PKEY_DECRYPT_INIT_FAILED                  WSEC_ERROR_CODE(936)  /* Evp pkey decrypt init failed. */
#define WSEC_ERR_EVP_PKEY_DECRYPT_FAILED                       WSEC_ERROR_CODE(937)  /* Evp pkey decrypt failed. */
#define WSEC_ERR_UNSUPPORTED_KEYTYPE                           WSEC_ERROR_CODE(938)  /* KeyType is not support. */
#define WSEC_ERR_EVP_PKEY_NEW_RAW_PRIVATE_KEY_FAILED           WSEC_ERROR_CODE(939)  /* New raw evp pkey private failed. */
#define WSEC_ERR_EVP_PKEY_NEW_RAW_PUBLIC_KEY_FAILED            WSEC_ERROR_CODE(940)  /* New raw evp pkey public failed. */
#define WSEC_ERR_EVP_PKEY_VERIFY_INIT_FAILED                   WSEC_ERROR_CODE(941)  /* Evp pkey verify init failed. */
#define WSEC_ERR_I2D_PUBKEY_FAILED                             WSEC_ERROR_CODE(942)  /* i2d publickey failed. */
#define WSEC_ERR_D2I_PUBKEY_FAILED                             WSEC_ERROR_CODE(943)  /* d2I publickey failed. */
#define WSEC_ERR_NEW_EC_BY_CURVE_FAILED                        WSEC_ERROR_CODE(945)  /* create new EC_KEY by curve failed. */
#define WSEC_ERR_ASN1_GET_OBJECT_FAILED                        WSEC_ERROR_CODE(946)  /* Asn1 get object failed. */
