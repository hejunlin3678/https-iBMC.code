...
export class Monitor {
    ...
    private getColor(): string {
        ...
        if (this.params.value < this.params.minorValue) {
            return '#86A6FC';
        }
        if (this.params.value >= this.params.minorValue && this.params.value < this.params.majorVal) {
            return '#F5A623';
        }
        return '#FF4C57';
    }
