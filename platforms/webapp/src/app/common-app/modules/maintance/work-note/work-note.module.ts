...
import { WorkNoteRoutingModule } from './work-note-routing.module';
...
import { NoteDetailComponent, AddNoteHalfModalComponent, BaseNoteHalfModalComponent, EditNoteHalfModalComponent, TextareaComponent } from './component';

@NgModule({
    declarations: [
        WorknoteComponent,
        NoteDetailComponent,
        AddNoteHalfModalComponent,
        BaseNoteHalfModalComponent,
        EditNoteHalfModalComponent,
        TextareaComponent
    ],
    imports: [
        CommonModule,
        WorkNoteRoutingModule,
        CommonsModule,
        HeaderModule,
        PipeModule,
        LeftMenuModule,
