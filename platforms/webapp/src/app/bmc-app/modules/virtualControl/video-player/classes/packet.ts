...
export const dataPacket = {
    ...
    KVM_VIDEO_CMD_SET_CIPHER_SUITE : 0x37,
    PACKHEAD1 : -2,
    PACKHEAD2 : -10,
    ...
    */
    ...
    // 构建设置加密套件命令
    setCipherAlgoSuite(algoType, paddingStyle) {
        const self = this;
        const bytes = new Uint8Array(18); // 命令长度为18
        self._MakePacketHeader(bytes, 0x0a, dataPacket.KVM_VIDEO_CMD_SET_CIPHER_SUITE);
