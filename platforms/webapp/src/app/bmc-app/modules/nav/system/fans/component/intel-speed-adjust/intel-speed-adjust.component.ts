...
export class IntelSpeedAdjustComponent implements OnInit {
    ...
    public bcuInletValidation: IValidationTip = {
        tip: '',
        tipPosition: 'right'
    };
    public bcuOutletValidation: IValidationTip = {
        tip: '',
        tipPosition: 'right'
    };
    ...
    public boardValidation: IValidationTip = {
        tip: '',
        tipPosition: 'right'
    };
    ...
    public memoryValidation: IValidationTip = {
        tip: '',
        tipPosition: 'right'
    };
    ...
    private getCustomModeParam() {
        ...
        if (this.customForm.root.get('npuBoardTargetTemperatureCelsius').value !==
            this.intelSpeedAdjust.getBoardTargetTemperatureCelsius()) {
            param['NPUBoardTargetTemperatureCelsius'] = parseInt(this.customForm.root.get('npuBoardTargetTemperatureCelsius').value, 10);
        }
        ...
        if (this.customForm.root.get('memoryTargetTemperatureCelsius').value !==
            this.intelSpeedAdjust.getMemoryTargetTemperatureCelsius()) {
            param['MemoryTargetTemperatureCelsius'] = parseInt(this.customForm.root.get('memoryTargetTemperatureCelsius').value, 10);
        }
        if (this.customForm.root.get('bcuInletTargetTemperatureCelsius').value !==
            this.intelSpeedAdjust.getBCUInletTargetTemperatureCelsius()) {
            param['SoCBoardInletTargetTemperatureCelsius'] =
                parseInt(this.customForm.root.get('bcuInletTargetTemperatureCelsius').value, 10);
        }
        if (this.customForm.root.get('bcuOutletTargetTemperatureCelsius').value !==
            this.intelSpeedAdjust.getBCUInletTargetTemperatureCelsius()) {
            param['SoCBoardOutletTargetTemperatureCelsius'] =
                parseInt(this.customForm.root.get('bcuOutletTargetTemperatureCelsius').value, 10);
        }
    ...
    private init() {
        ...
        const minBCUInlet = this.intelSpeedAdjust.getBCUInletMinTargetTemperatureCelsius();
        const maxBCUInlet = this.intelSpeedAdjust.getBCUInletMaxTargetTemperatureCelsius();
        const minBCUOutlet = this.intelSpeedAdjust.getBCUOutletMinTargetTemperatureCelsius();
        const maxBCUOutlet = this.intelSpeedAdjust.getBCUOutletMaxTargetTemperatureCelsius();
        ...
        const minBoard = this.intelSpeedAdjust.getMinBoardTargetTemperatureCelsius();
        const maxBoard = this.intelSpeedAdjust.getMaxBoardTargetTemperatureCelsius();
        ...
        const minMemory = this.intelSpeedAdjust.getMinMemoryTargetTemperatureCelsius();
        const maxMemory = this.intelSpeedAdjust.getMaxMemoryTargetTemperatureCelsius();
        ...
        this.customForm = this.fb.group({
            ...
            npuBoardTargetTemperatureCelsius: [this.intelSpeedAdjust.getBoardTargetTemperatureCelsius(),
                [TiValidators.digits, TiValidators.rangeValue(minBoard, maxBoard)]],
            ...
            memoryTargetTemperatureCelsius: [this.intelSpeedAdjust.getMemoryTargetTemperatureCelsius(),
                [TiValidators.digits, TiValidators.rangeValue(minMemory, maxMemory)]],
            bcuInletTargetTemperatureCelsius: [this.intelSpeedAdjust.getBCUInletTargetTemperatureCelsius(),
                [TiValidators.digits, TiValidators.rangeValue(minBCUInlet, maxBCUInlet)]],
            bcuOutletTargetTemperatureCelsius: [this.intelSpeedAdjust.getBCUOutletTargetTemperatureCelsius(),
                  [TiValidators.digits, TiValidators.rangeValue(minBCUOutlet, maxBCUOutlet)]],
        ...
        this.bcuInletValidation.tip = formatEntry(this.translate.instant('VALID_VALUE_RANGE_TIP'), [minBCUInlet, maxBCUInlet]);
        this.bcuOutletValidation.tip = formatEntry(this.translate.instant('VALID_VALUE_RANGE_TIP'), [minBCUOutlet, maxBCUOutlet]);
        ...
        this.boardValidation.tip = formatEntry(this.translate.instant('VALID_VALUE_RANGE_TIP'), [minBoard, maxBoard]);
        this.outletValidation.tip = formatEntry(this.translate.instant('VALID_VALUE_RANGE_TIP'), [minOutlet, maxOutlet]);
        this.memoryValidation.tip = formatEntry(this.translate.instant('VALID_VALUE_RANGE_TIP'), [minMemory, maxMemory]);
