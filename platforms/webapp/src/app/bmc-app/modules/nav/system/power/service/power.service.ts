...
export class PowerService {
    ...
    public getPowerCapping(data, utils?) {
        ...
        let limitExceptionState = 'NoAction';
        if (powerLimit && powerLimit.LimitException) {
            limitExceptionState = powerLimit.LimitException;
        }
        const targetData = {
    ...
    public getPowerControlInfo(data) {
        ...
        const targetData = {
            ...
            safePowerOffTimoutSeconds: powerOffAfterTimeout.TimeoutSeconds || (powerOffAfterTimeout.DefaultSeconds || 600),
