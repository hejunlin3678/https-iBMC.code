...
export class Accesses {
    ...
    constructor(
        ...
        const webStyle = GlobalData.getInstance().getWebStyle;
        this.accesses = [
            // 本地用户
            {
                show: hasLoginRight,
                ...
                imgUrl: `assets/bmc-assets/image/home/${webStyle}/dash-quick-access-user-icon.png`,
            ...
            // 网络配置
            {
                ...
                imgUrl: `assets/bmc-assets/image/home/${webStyle}/dash-quick-access-netw-icon.png`,
            ...
            // 电源控制
            {
                ...
                imgUrl: `assets/bmc-assets/image/home/${webStyle}/dash-quick-access-powe-icon.png`,
            ...
            // 固件升级
            {
                ...
                imgUrl: `assets/bmc-assets/image/home/${webStyle}/dash-quick-access-hotw-icon.png`,
            ...
            // 一键收集
            {
                ...
                imgUrl: `assets/bmc-assets/image/home/${webStyle}/dash-quick-access-conl-icon.png`,
                onKeySelect: true,
                lock: false
            },
            // 恢复配置
            {
                ...
                imgUrl: `assets/bmc-assets/image/home/${webStyle}/dash-quick-access-rest-icon.png`,
                restoreSet: true,
                lock: true
            },
            {
                show: hardShow && hasConfigureComponentsRight,
                title: 'HOME_HARD_PARTITION_SETTINGS',
                id: 'HardPart',
                icon: 'dash-quick-access-hardpart-icon',
                imgUrl: `assets/bmc-assets/image/home/${webStyle}/dash-quick-access-hardpart-icon.png`,
            ...
            },
            {
                ...
                imgUrl: `assets/bmc-assets/image/home/${webStyle}/dash-quick-access-nodejump-icon.png`,
                disable: !hasLoginRight,
                nodeChange: true,
