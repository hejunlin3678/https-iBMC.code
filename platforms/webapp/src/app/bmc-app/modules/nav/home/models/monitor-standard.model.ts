...
export class MonitorStandard {
        ...
        this.detailPieData = {
            ...
            label: {
                normal: {
                    ...
                    rich: {
                        div: {
                            fontSize: innerHeight > 1280 ? 18 : 14,
                        ...
                        span: {
                            fontSize: innerHeight > 1280 ? 12 : 10,
                            fontFamily: 'PingFang, "Hiragino Sans GB", "Microsoft YaHei", "Microsoft JhengHei", "Huawei sans", Arial',
                            lineHeight: 16,
                            color: '#B8BECC',
                        },
    ...
    private readonly firstPieXRadius = '49%';
    private readonly firstPieYRadius = '50%';
    private readonly secondPieXRadius = '39%';
    private readonly secondPieYRadius = '50%';
    private readonly thirdPieXRadius = '59%';
    private readonly thirdPieYRadius = '60%';
