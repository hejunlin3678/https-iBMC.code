...
@Component({
    selector: 'app-home-beautiful',
    templateUrl: './home-beautiful.component.html',
    styleUrls: ['./home-beautiful.component.scss']
})
export class HomeBeautifulComponent implements OnInit {
