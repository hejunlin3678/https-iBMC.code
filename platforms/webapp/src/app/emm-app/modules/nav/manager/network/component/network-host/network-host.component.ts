...
export class NetworkHostComponent implements OnChanges {
    ...
    public netHost = {
        ...
        confirm: () => {
            ...
            this.networkService.saveHost(this.HMMID, JSON.stringify(params)).subscribe((response) => {
    ...
    public hostInit = (networkPort) => {
        this.netHost['label'] = networkPort || '--';
    }
    ...
    ngOnChanges(changes: import('@angular/core').SimpleChanges): void {
        if (changes.HMMID && changes.HMMID.currentValue) {
            this.networkService.getHostName(changes.HMMID.currentValue).subscribe((res) => {
                this.hostInit(res?.body?.HostName);
            });
        }
    }
