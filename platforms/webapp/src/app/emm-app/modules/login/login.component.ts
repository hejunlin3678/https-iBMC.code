...
export class LoginComponent implements OnInit, OnDestroy {
    ...
    public getLoginImg(obj) {
        obj.imgLoginUrl = 'assets/emm-assets/image/home/default/login.jpg';
    }
    public getLoginTitleImg(obj) {
        obj.imgLoginTitleUrl = 'assets/emm-assets/image/home/default/login_logo.png';
    }
        ...
        this.loginService.login(loginParams).subscribe((res: any) => {
            ...
            switch (errorId) {
                ...
                case 'UserLoginRestricted':
                    ...
                    break;
                case 'NotAllowedOnStandbyMM':
                    this.errorMessage = this.translate.instant('LOGIN_STANDBY_BOARD_ERR');
                    break;
                default:
    ...
    private initState(): Promise<any> {
        return new Promise((resolve, reject) => {
            Promise.all([this.getPasswordComplexityCheck(), this.getCustomState()]).finally(() => {
                resolve(true);
            });
        });
    }
