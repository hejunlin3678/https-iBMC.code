...
#else /* !_WINDOWS */
#if TARGET_OS_MAC
#define DEFAULT_SECURE_PROFILE_PATH "/Library/Preferences/edu.mit.Kerberos:/etc/krb5.conf:/home/3rd/etc/krb5.conf"
...
#else
#define DEFAULT_SECURE_PROFILE_PATH     "/etc/krb5.conf:/home/3rd/etc/krb5.conf"
...
#else
#define DEFAULT_PLUGIN_BASE_DIR "/home/3rd/lib/krb5/plugins"
#endif
...
#define KDC_DIR                 "/home/3rd/var/krb5kdc"
...
#if TARGET_OS_MAC
#define DEFAULT_KDB_LIB_PATH    { KDB5_PLUGIN_BUNDLE_DIR, "/home/3rd/lib/krb5/plugins/kdb", NULL }
#else
#define DEFAULT_KDB_LIB_PATH    { "/home/3rd/lib/krb5/plugins/kdb", NULL }
#endif
...
#define KRB5_PATH_LOGIN "/home/3rd/sbin/login.krb5"
#define KRB5_PATH_RLOGIN "/home/3rd/bin/rlogin"
...
#define KPROPD_DEFAULT_KDB5_UTIL "/home/3rd/sbin/kdb5_util"
#define KPROPD_DEFAULT_KPROP "/home/3rd/sbin/kprop"
 ...
 * GSS mechglue
 */
#define MECH_CONF "/home/3rd/etc/gss/mech"
#define MECH_LIB_PREFIX "/home/3rd/lib/gss/"
