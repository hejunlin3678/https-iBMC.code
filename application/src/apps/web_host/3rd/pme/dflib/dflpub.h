...
typedef gulong OBJ_HANDLE;
typedef void *OBJECT_FILE;
typedef void *OBJECT_ITEM;

typedef void (*PropertyForeachFunc)(OBJ_HANDLE object_handle, const gchar *property_name, GVariant *value,
    gpointer user_data);
