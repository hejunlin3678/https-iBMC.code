...
add_admin_user()
{
    ...
    #ipmicmd -k "0f 00 30 93 db 07 00 35 34 00 01 00 00 00 01 00 79 01 02 0b 00 79 01 01" smi 0 : 0f 31 00 93 00 db 07 00
	run_cmd  "0f 00 30 93 db 07 00 35 34 00 01 00 00 00 01 00 79 01 11 0b 00 79 01 01" "0f 31 00 93 00 db 07 00"
	if [ $? != 0 ] ; then
		echo_fail "set user first login policy to prompt"
		echo "set user first login policy to prompt" >>$SAVEFILE
		error_quit
	fi
    echo_success "set user first login policy to prompt success!"
	sleep 2
}
