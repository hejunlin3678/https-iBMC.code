...
SAVEFILE=05023BMD_save.txt
FLAG_ADD_USER=0
EQUIPMENT_SEPARATION_SUPPORT_STATE=0
G_WORK_DIR=`pwd`
UID_2280_2U2P=0x0207A900
UID_1280_1U2P=0x0207A904
UID_1280Pro_1U2P=0x0207A905
UID_2180_2U1P=0x0207A902
UID_5280_4U2P=0x0207A901
UID_5280_4U1P=0x0207A903
UID_2280S_2U2P=0x0207A500
UID_5280S_4U2P=0x0207A501
UID_2180S_2U1P=0x0207A502
UID_5180S_4U1P=0x0207A503
UID_2280K_2U2P=0x0207A90A
UID_2180K_2U1P=0x0207A90C
UID_5280K_4U2P=0x0207A90B
UID_2280SK_2U2P=0x0207A50A
UID_5280SK_4U2P=0x0207A50B
...
judge_environment_type()
{
    ...
    do
        if [[ "${compare_uid}" == "$machine_uid" ]]; then
            ...
            echo "this machine is 1711 type" >>$SAVEFILE
            return 1
        fi
    done
...
if [ $? == 1 ]; then
    ...
    if [ $? == 1 ]; then
        ...
        ./upgrade_hpm.sh "image_verify.hpm" 0 0 2
        if [ $? -ne 0 ]; then
