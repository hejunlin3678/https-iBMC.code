...
insmod /opt/pme/lib/modules/ko/mii.ko
insmod /opt/pme/lib/modules/ko/usbnet.ko
insmod /opt/pme/lib/modules/ko/cdc_ether.ko
insmod /opt/pme/lib/modules/ko/rndis_host.ko

insmod /opt/pme/lib/modules/ko/u_ether.ko
insmod /opt/pme/lib/modules/ko/usb_f_ecm.ko
insmod /opt/pme/lib/modules/ko/usb_f_rndis.ko

#########insmode ipv6##################
insmod /lib/modules/${KERNEL_VERSION}/kernel/lib/crc-ccitt.ko
modprobe ipv6
chmod 777 /usr/bin/bmcdfx
chmod 777 /usr/bin/busybox1711
/usr/bin/busybox1711 telnetd &
