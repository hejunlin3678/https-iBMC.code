...
# 替换为全量编译的rtos
cp -rf ${root_dir}/../../share_path/RTOS/* ${agentpath}/platform/rtos

# 拷贝output和package到 Hi1711_chip_solution/build
src_path=${root_dir}/../../share_path/sdk_part1
cp -rf  ${src_path}/package ${agentpath}/build
cp -rf  ${src_path}/output ${agentpath}/build

# 拷贝SDK提供的执行脚本（SDK提供新版本后，该步骤删除）
cp ${cur_dir}/all_src_build_part2.sh ${agentpath}/.cloudbuild
