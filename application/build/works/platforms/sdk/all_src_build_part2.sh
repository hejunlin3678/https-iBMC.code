...
cd ../build/build_uboot 
source ../build_exports
prepare_build_env
prepare_build_toolchain
...
#build_module_str="compile_os compile_initrd compile_rootfs"

#for func in `echo "${build_module_str}"`
#do 
#{
#    $func
#} &
...
sh package_final.sh
cd ${BUILD_DIR}/../build/package/update_bin/pme
mv Hi1711_boot_4096.bin  pkcs_Hi1711_boot_4096.bin
mv Hi1711_boot_4096_debug.bin  pkcs_Hi1711_boot_4096_debug.bin
mv Hi1711_boot_4096_factory.bin  pkcs_Hi1711_boot_4096_factory.bin
mv Hi1711_boot_4096_pmode.bin  pkcs_Hi1711_boot_4096_pmode.bin
mv Hi1711_boot_4096_pmode_debug.bin  pkcs_Hi1711_boot_4096_pmode_debug.bin
mv Hi1711_boot_4096_pmode_factory.bin pkcs_Hi1711_boot_4096_pmode_factory.bin
sleep 3
printf "\r\n\r\n\r\n################################### Begin TO PSS CMS###################################\r\n"
cd ${BUILD_DIR}
sed -i 's/g1/g2/g' ../build/build_sign/u-boot_cms*cfg
sh 1711_sign_cms.sh
if [ $? == 0 ];then
    echo "sign PSS cms successful................."
else
    exit 1
fi
sleep 5
...
printf "\r\n\r\n\r\n################################### Begin PACKAGING###################################\r\n"
sh package_final.sh
cd ${BUILD_DIR}/../build/output/packet/update_bin/pme
mv Hi1711_boot_4096.bin  pss_Hi1711_boot_4096.bin
mv Hi1711_boot_4096_debug.bin  pss_Hi1711_boot_4096_debug.bin
mv Hi1711_boot_4096_factory.bin  pss_Hi1711_boot_4096_factory.bin
mv Hi1711_boot_4096_pmode.bin  pss_Hi1711_boot_4096_pmode.bin
mv Hi1711_boot_4096_pmode_debug.bin  pss_Hi1711_boot_4096_pmode_debug.bin
mv Hi1711_boot_4096_pmode_factory.bin pss_Hi1711_boot_4096_pmode_factory.bin
