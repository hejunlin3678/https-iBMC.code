...
cd ${src_dir}
python3 build.py --section=IBMC_SUSE_ARM -p IBMC -e SUSE12_SP5_ARM64LE_IBMC
...
./Configure --prefix=/usr --openssldir=/usr/lib64/ssl-3 --libdir=/usr/lib64 $TARGET no-afalgeng -fPIC -fstack-protector-strong -shared -Wl,-z,relro,-z,noexecstack,-z,now -rdynamic
make -j32
