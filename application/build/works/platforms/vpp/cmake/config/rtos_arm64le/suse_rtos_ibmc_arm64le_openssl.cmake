...
set(PDT_NAME "IBMC")
set(PLT_NAME "SUSE12_SP5_ARM64LE_IBMC")
...
set(ENV_OPT "enable-fips")
set(LIB_ALL "n")
set(OPTION_SHARED "y")
set(LIBTYPE_SHARED ${OPTION_SHARED})
set(CNF_ARFLAGS "crD" CACHE STRING "overwrite configure before" FORCE)
set(COMMON_OPT_HERDFILE "enable-ui-console " CACHE STRING "overwrite configure before" FORCE) # 归一头文件中的openssl功能配置
set(ENABLE_ASM "y" CACHE STRING "overwrite configure before" FORCE) # 控制编译汇编代码
...
# openssl开关配置
set(ENABLE_ASM "y")
set(ENV_OPT "--prefix=/usr --openssldir=/usr/lib64/ssl-3 --libdir=/usr/lib64 enable-ui-console enable-tls-sigalg-sha1")
...
set(COMPILE_TARGET "linux-aarch64") # 目标系统,在开源根目录下执行 perl Configure LIST 查看可选的目标系统
