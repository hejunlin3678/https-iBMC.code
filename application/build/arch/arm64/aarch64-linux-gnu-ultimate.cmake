...
SET(SSL "${CMAKE_FIND_ROOT_PATH}/usr/lib64/libssl.so.3")
SET(CRYPTO "${CMAKE_FIND_ROOT_PATH}/usr/lib64/libcrypto.so.3")
...
SET(SECURE "${SDK_LIB}/libsecurec.so")
...
SET(MODBUS "${SDK_LIB_PME}/libmodbus.so")
...
SET(ULTIMATE_ENABLED_FLAG 1)
SET(ARM64_HI1711_ENABLED 1)

ADD_DEFINITIONS(-DULTIMATE_ENABLED)
ADD_DEFINITIONS(-DARM64_HI1711_ENABLED)

# 2020/8/20 
# 对于有兼容性冲突的安全问题，通过该编译宏对未送检产品及未上网产品做控制
if(SECURITY_ENHANCED_COMPATIBLE_BOARD_V1)
    ADD_DEFINITIONS(-DSECURITY_ENHANCED_COMPATIBLE_BOARD_V1)
endif()

# 对于有兼容性冲突的安全问题，通过该编译宏对未上网产品做控制
if(SECURITY_ENHANCED_COMPATIBLE_BOARD_V2)
    ADD_DEFINITIONS(-DSECURITY_ENHANCED_COMPATIBLE_BOARD_V2)
endif()

#对于初始密码强制修改问题，通过该编译宏对产品做控制
if(SECURITY_ENHANCED_COMPATIBLE_BOARD_V3)
    ADD_DEFINITIONS(-DSECURITY_ENHANCED_COMPATIBLE_BOARD_V3)
endif()

#对于有兼容性冲突的安全问题，通过该编译宏对产品做控制
if(SECURITY_ENHANCED_COMPATIBLE_BOARD_V4)
    ADD_DEFINITIONS(-DSECURITY_ENHANCED_COMPATIBLE_BOARD_V4)
endif()

#对于安全红线3.0涉及的机型，通过该编译宏对产品做控制
if(SECURITY_ENHANCED_COMPATIBLE_BOARD_V5)
    ADD_DEFINITIONS(-DSECURITY_ENHANCED_COMPATIBLE_BOARD_V5)
endif()

#对于有IPMI命令冲突问题，通过该编译宏对产品做控制
if(BOARD_WITH_EBMC)
    ADD_DEFINITIONS(-DBOARD_WITH_EBMC)
endif()